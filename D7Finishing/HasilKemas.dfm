object HasilKemasFrm: THasilKemasFrm
  Left = 119
  Top = 97
  Width = 848
  Height = 591
  ...
  object PanelCenter: TPanel
    ...
    object wwDBGrid1: TwwDBGrid
      ...
      Selected.Strings = (
        'NIK'#9'8'#9'NIK'#9'F'
        'KETERANGAN'#9'15'#9'PETUGAS KEMAS'#9'F'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.bukti2_detail a'
      'where a.no_reg = :no_reg')
    Variables.Data = {
      0300000001000000070000003A4E4F5F52454704000000080000000000000000
      00004000000000}
    SequenceField.Field = 'NO_REG_DETAIL'
    SequenceField.Sequence = 'ipisma_db4.no_reg_kontrak'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      04000000110000000D0000004E4F5F5245475F44455441494C01000000000006
