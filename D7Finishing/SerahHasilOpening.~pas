...
type
  TSerahHasilOpeningFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
...
var
  SerahHasilOpeningFrm: TSerahHasilOpeningFrm;
...
procedure TSerahHasilOpeningFrm.FormClose(Sender: TObject;
...
procedure TSerahHasilOpeningFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahHasilOpeningFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilOpeningFrm.FormCreate(Sender: TObject);
begin
...
procedure TSerahHasilOpeningFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilOpeningFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilOpeningFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TSerahHasilOpeningFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahHasilOpeningFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahHasilOpeningFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahHasilOpeningFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
QDetailKD_SUB_LOKASI.AsString:='71-00000';
QDetailKD_SUB_LOKASI2.AsString:='72-00000';
...
procedure TSerahHasilOpeningFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahHasilOpeningFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahHasilOpeningFrm.FNo_UrutBeforeQuery(
...
procedure TSerahHasilOpeningFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahHasilOpeningFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahHasilOpeningFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahHasilOpeningFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahHasilOpeningFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahHasilOpeningFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahHasilOpeningFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahHasilOpeningFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TSerahHasilOpeningFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahHasilOpeningFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahHasilOpeningFrm.TabSheet2Show(Sender: TObject);
begin
{azmi}
if vTab='Bro' then
   vTab:='In'
...
procedure TSerahHasilOpeningFrm.TabSheet1Show(Sender: TObject);
begin
  if QBrowse.Active then
  begin
         QMaster.Close;
{azmi}
        vTab:='Bro';
        QMaster.SQL.Text:='select a.*, a.rowid from ipisma_db5.serah_hasil_all a where kd_transaksi=:kd_transaksi and no_nota=:no_nota'; 
{azmi}
...
procedure TSerahHasilOpeningFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahHasilOpeningFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahHasilOpeningFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahHasilOpeningFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilOpeningFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahHasilOpeningFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahHasilOpeningFrm.LookKonstruksiEnter(Sender: TObject);
begin
//DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilOpeningFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahHasilOpeningFrm.LookKonstruksiClick(Sender: TObject);
begin
   //DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilOpeningFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TSerahHasilOpeningFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TSerahHasilOpeningFrm.LookKonClick(Sender: TObject );
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilOpeningFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilOpeningFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
QDetailKD_KONSTRUKSI.AsString:=DMFrm.QKonstruksiKD_KONSTRUKSI.AsString;
QDetailKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TSerahHasilOpeningFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
...
procedure TSerahHasilOpeningFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahHasilOpeningFrm.LookAmbilClick(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahHasilOpeningFrm.LookAmbilCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
