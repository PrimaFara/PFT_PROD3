object RekapKirimFinishingFrm: TRekapKirimFinishingFrm
  Left = 246
  Top = 61
  Width = 1141
  Height = 637
  Caption = 'Rekap Pengiriman Dari Finishing'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid1xxxxx: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KD_PRODUKSI'#9'20'#9'KD_PRODUKSI'#9#9)
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.rekap_kirim_finishing a'
    ...
    Variables.Data = {
      ...
      0D0000003A4B445F5452414E53414B5349050000000400000039303500000000
    ...
    QBEDefinition.QBEFieldDefs = {
      040000000C000000060000004E4F5F5245470100000000000300000054474C01
      ...
      000600000054554A55414E010000000000060000005354415455530100000000
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.rekap_kirim_finishing_det a'
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      04000000070000000D0000004E4F5F5245475F44455441494C01000000000006
  ...
  object FNo_Urut: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000060000003A504B4F44450500000004000000393035000000
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * From (select * from ipisma_db5.vrekap_kirim_finishing'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam'
      '')
    Variables.Data = {
      ...
      00040000003930350000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000012000000070000004E4F5F4E4F54410100000000000A00000054474C
      ...
      000000000A0000005154595F504F544F4E470100000000000D0000004B445F4B
      4F4E535452554B53490100000000000B0000004B445F50524F44554B53490100
      000000000600000054554A55414E010000000000}
    QueryAllRecords = False
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'from (select * from ipisma_db5.vrekap_kirim_finishing'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(qty_gulung) as gulung, '
      'sum(qty_potong) as potong'
      'from ipisma_db5.rekap_kirim_finishing_det a'
      'where a.no_reg =:no_reg'
      '')
    Variables.Data = {
  ...
  object QPerKode_Prod: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(qty_potong)as potong,'
      'sum(qty_potong)/20 as KODI'
      'from ipisma_db5.vrekap_kirim_finishing'
      'where tgl>=:pawal and tgl<=:pakhir and kd_transaksi = 905'
      ':myparam'
      '')
    Variables.Data = {
      0300000003000000080000003A4D59504152414D010000002000000067726F75
      70206279206B645F70726F64756B73692C6B6F6E737472756B73690000000000
      060000003A504157414C0C0000000000000000000000070000003A50414B4849
      520C0000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000050000000600000047554C554E4701000000000006000000504F544F
      4E47010000000000040000004B4F44490100000000000B0000004B445F50524F
      44554B53490100000000000A0000004B4F4E535452554B5349010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 748
    ...
    object QPerKode_ProdKONSTRUKSI: TStringField
      FieldName = 'KONSTRUKSI'
      Size = 50
    end
