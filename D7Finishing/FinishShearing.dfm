object FinishShearingFrm: TFinishShearingFrm
  Left = 283
  Top = 125
  Width = 1031
  Height = 590
  ActiveControl = DBMemo1
  Caption = 'Finishing - Shearing'
  Color = clBtnFace
      ...
      object QuickRep1: TQuickRep
        ...
        object QRBand6: TQRBand
          ...
          object QRLabel6: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'HASIL PRODUKSI SHEARING'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
      ...
      object PanelCenter: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'KD_WARNA'#9'10'#9'KD_WARNA'#9'T'
            'WARNA'#9'20'#9'WARNA'#9'F'
            'KD_REKANAN'#9'10'#9'KD_REKANAN'#9'T'
        ...
        object LookAmbil: TwwDBLookupComboDlg
          ...
          Selected.Strings = (
            'NO_ORDER'#9'18'#9'NO_ORDER'#9'F'
            'NO_RESEP'#9'20'#9'NO_RESEP'#9'F'
            'KD_PRODUKSI'#9'10'#9'KD_PRODUKSI'#9'F'
            'KD_KONSTRUKSI'#9'3'#9'KD_KONSTRUKSI'#9'F'
      ...
      object QuickRep2: TQuickRep
        ...
        object QRBand1: TQRBand
          ...
          object QRLabel12: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'R E K A P  P R O D U K S I  S H E A R I N G'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.bukti_shearing a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_SHEARING'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.bukti_shearing_det a'
    ...
    SequenceField.Sequence = 'ipisma_db5.reg_shearing_det'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_potong) as potong from' +
        ' ipisma_db5.bukti_shearing_det a'
      'where a.no_reg = :no_reg')
  ...
  object QAmbil: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vlook_shearing WHERE :MYPARAM')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0000000000050000004E4F5F504F010000000000050000004A454E4953010000
      000000}
    Session = DMFrm.OS
    Left = 129
    Top = 392
  ...
  object QPerKonstruksi: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db5.vfinish_shearing'
  ...
  object QTransaksiAmbil: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vfinishopening')
    Variables.Data = {
      03000000010000000D0000003A4B445F5452414E53414B534905000000040000
      003839320000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object dsQTransaksiAmbil: TwwDataSource
    DataSet = QTransaksiAmbil
    Left = 816
    Top = 80
  end
  ...
  object QAmbilData: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db5.proc_dari_inspecting_shearing(:qno_reg,:qno_nota);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
