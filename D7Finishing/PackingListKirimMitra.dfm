object PackingListMitraFrm: TPackingListMitraFrm
  Left = 335
  Top = 172
  Width = 1096
  Height = 602
  Caption = 'Finishing - Packing List Mitra'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object PanelCenter: TPanel
        ...
        object WebBrowser3: TWebBrowser
          ...
          ControlData = {
            4C000000CB6E0000D71900000000000000000000000000000000000000000000
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            ...
            'NO_ORDER;CustomEdit;LookAmbilPacking;F'
            'KD_PRODUKSI;CustomEdit;Look_KP;F'
            'KD_WARNA;CustomEdit;DelokWarna;F'
            'KD_REKANAN;CustomEdit;LookSuplier;F')
          Selected.Strings = (
            'NO_ORDER'#9'20'#9'NO ORDER'#9'F'
            'NO_KIRIM'#9'15'#9'NO_KIRIM'#9'F'
            'NO_RESEP'#9'15'#9'NO RESEP'#9'T'
            'KD_PRODUKSI'#9'10'#9'KP'#9'T'
            'KONSTRUKSI'#9'20'#9'KONSTRUKSI'#9'T'
            'MESIN'#9'7'#9'MESIN'#9'T'
            'QTY'#9'10'#9'QTY'#9'F'
            'DESAIN_CW'#9'20'#9'DESAIN'#9'F'
            'KD_WARNA'#9'6'#9'KODE'#9'F'#9'WARNA'
            'WARNA'#9'15'#9'NAMA'#9'T'#9'WARNA')
        ...
        object LookSarung: TwwDBLookupCombo
          ...
          Selected.Strings = (
            'NAMA_MITRA'#9'20'#9'NAMA_MITRA'#9'F')
          DataField = 'MITRA'
          DataSource = dsQMaster
        ...
        object LookAmbilPacking: TwwDBLookupComboDlg
          Left = 81
          Top = 300
          Width = 48
          Height = 21
          ...
          Selected.Strings = (
            'NO_REG_DETAIL'#9'10'#9'NO_REG_DETAIL'#9'F'#9
            'NO_ORDER'#9'30'#9'NO_ORDER'#9'F'#9
          ...
          ShowButton = True
          AllowClearKey = False
          OnCloseUp = LookAmbilPackingCloseUp
          OnEnter = LookAmbilPackingEnter
        end
        object DelokWarna: TwwDBLookupComboDlg
          Left = 553
          Top = 356
          Width = 48
          Height = 21
          ...
          ShowButton = True
          AllowClearKey = False
          OnCloseUp = DelokWarnaCloseUp
          OnEnter = DelokWarnaEnter
        end
      end
    end
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid1xxxxx: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'TGL'#9'18'#9'TGL'#9'F'
          'NO_KIRIM'#9'15'#9'NO KIRIM'#9'F'
          'KD_PRODUKSI'#9'10'#9'KD_PRODUKSI'#9'F'#9'KONSTRUKSI'
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.KIRIM_MAKLON a'
      'where kd_transaksi=:kd_transaksi and no_reg=:no_reg'
      '')
    Variables.Data = {
      03000000020000000D0000003A4B445F5452414E53414B534905000000040000
      004D30360000000000070000003A4E4F5F524547030000000000000000000000}
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'IPISMA_DB5.REG_KIRIM_MAKLON'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      010000000000050000004D49545241010000000000}
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.KIRIM_MAKLON_DETAIL a'
      'where a.no_reg = :no_reg'
      'order by a.no_kirim asc')
    Variables.Data = {0300000001000000070000003A4E4F5F524547040000000000000000000000}
    SequenceField.Field = 'NO_REG_DETAIL'
    SequenceField.Sequence = 'IPISMA_DB5.REG_KIRIM_MAKLON_DET'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      
      00080000004B445F5741524E41010000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
    Session = DMFrm.OS
    ...
    object QDetailNO_KIRIM: TStringField
      FieldName = 'NO_KIRIM'
      Size = 30
    end
    ...
    object QDetailDESAIN_CW: TStringField
      FieldName = 'DESAIN_CW'
      Size = 50
    end
    object QDetailNO_REG_REFF: TFloatField
      FieldName = 'NO_REG_REFF'
    end
  ...
  object FNo_Urut: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000060000003A504B4F444505000000040000004D4F36000000
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vkirim_mitra'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      4E41010000000000}
    QueryAllRecords = False
    ...
    object QBrowseNO_KIRIM: TStringField
      FieldName = 'NO_KIRIM'
      Size = 30
    end
    ...
    object QBrowseDESAIN_CW: TStringField
      FieldName = 'DESAIN_CW'
      Size = 50
    end
    object QBrowseNO_REG_REFF: TFloatField
      FieldName = 'NO_REG_REFF'
    end
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(qty) as QTY from ipisma_db5.vkirim_mitra'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(qty) as QTY from ipisma_db5.KIRIM_MAKLON_DETAIL a'
      'where a.no_reg = :no_reg')
  ...
  object QAmbil_New: TOracleDataSet
    SQL.Strings = (
      'select b.* from ipisma_db5.VSISA_KIRIM_MAKLON b')
    QBEDefinition.QBEFieldDefs = {
      
      495341010000000000}
    Session = DMFrm.OS
    Left = 257
    Top = 360
    ...
    object QAmbil_NewSISA: TFloatField
      DisplayWidth = 10
      FieldName = 'SISA'
    end
  ...
  object QLookMitra: TOracleDataSet
    SQL.Strings = (
      'select t.*, t.rowid from ipisma_db5.NAMA_MITRA_CW t'
      'order by kd_mitra'
      ''
      '')
    QBEDefinition.QBEFieldDefs = {
