...
type
  TMainFrm = class(TForm)
   ...
   // procedure StockFinishing1Click(Sender: TObject);
    ...
    procedure LaporanBS1Click(Sender: TObject);
    procedure BSParahQAClick(Sender: TObject);
  private
...
procedure TMainFrm.LaporanBS1Click(Sender: TObject);
begin
...
begin
  InputBSFrm:=TInputBSFrm.Create(Self);
  InputBSFrm.Show;
end;
