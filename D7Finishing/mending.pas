...
type
  TMendingFrm = class(TForm)
    ...
    QDetailSONGKET_MKMBG: TFloatField;
    QDetailSONGKET_MJQ: TFloatField;
    QBrowseSONGKET_MKMBG: TFloatField;
    QBrowseSONGKET_MJQ: TFloatField;
    QBrowseTotalSONGKET_MKMBG: TFloatField;
    QBrowseTotalSONGKET_MJQ: TFloatField;
    QTotalSONGKET_MKMBG: TFloatField;
    QTotalSONGKET_MJQ: TFloatField;
...
QBrowse.Open;
  ...
  wwDBGrid1xxxxx.ColumnByName('SONGKET_MKMBG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QBrowseTotalSONGKET_MKMBG.AsFloat);
  wwDBGrid1xxxxx.ColumnByName('SONGKET_MJQ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QBrowseTotalSONGKET_MJQ.AsFloat);
end;
...
  wwDBGrid1.ColumnByName('SONGKET_MKMBG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSONGKET_MKMBG.AsFloat);
  wwDBGrid1.ColumnByName('SONGKET_MJQ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSONGKET_MJQ.AsFloat);
