...
type
  TBakarBuluGreyFrm = class(TForm)
    ...
    LookAmbilBatch: TwwDBLookupComboDlg;
    ...
    QAmbilBatchNO_REG: TFloatField;
    QAmbilBatchTGL: TDateTimeField;
    QAmbilBatchNO_NOTA: TStringField;
    QAmbilBatchGRUP: TStringField;
    QAmbilBatchSHIFT: TStringField;
    QAmbilBatchLOKASI_MAKLON: TStringField;
    QAmbilBatchKETERANGAN2: TStringField;
    QAmbilBatchKD_KONSTRUKSI: TStringField;
    QAmbilBatchKONSTRUKSI: TStringField;
    QAmbilBatchKET_KONSTRUKSI: TStringField;
    QAmbilBatchKD_CORAK: TStringField;
    QAmbilBatchCORAK: TStringField;
    QAmbilBatchMUTU: TStringField;
    QAmbilBatchNO_PART: TStringField;
    QAmbilBatchSUPLIER: TStringField;
    QAmbilBatchQTY_METER: TFloatField;
    QAmbilBatchQTY_GULUNG: TFloatField;
    QAmbilBatchJENIS: TStringField;
    QAmbilBatchNO_ORDER: TStringField;
    QAmbilBatchNO_ORDER2: TStringField;
    QAmbilBatchNO_DESAIN: TStringField;
    QAmbilBatchBK: TFloatField;
    QAmbilBatchBGRADE: TFloatField;
    QAmbilBatchBS_PARAH: TFloatField;
    QAmbilBatchTOTAL: TFloatField;
    QAmbilBatchAFFAL: TFloatField;
    QAmbilBatchKET_DETAIL: TStringField;
    QAmbilBatchKELOMPOK: TStringField;
    QAmbilBatchTGL_INSERT: TDateTimeField;
    QAmbilBatchOPR_INSERT: TStringField;
    QAmbilBatchPETUGAS: TStringField;
    QAmbilBatchISPOST: TStringField;
    QAmbilBatchTAHUN: TFloatField;
    QAmbilBatchNAMA_ITEM: TStringField;
    QAmbilBatchCORAK_PRINTING: TStringField;
    QAmbilBatchKP_FINISH: TStringField;
    QAmbilBatchKD_KONSTRUKSI_1: TStringField;
    QAmbilBatchKONSTRUKSI_1: TStringField;
    ...
    procedure QLookAmbilBatchEnter(Sender: TObject);
    procedure QLookAmbilBatchCloseUp(Sender: TObject; LookupTable,
      FillTable: TDataSet; modified: Boolean);
    procedure LookAmbilBatchEnter(Sender: TObject);
    procedure LookAmbilBatchCloseUp(Sender: TObject; LookupTable,
      FillTable: TDataSet; modified: Boolean);
...
var
  BakarBuluGreyFrm: TBakarBuluGreyFrm;
...
procedure TBakarBuluGreyFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  BakarBuluGreyFrm:=Nil;
end;

procedure TBakarBuluGreyFrm.FormResize(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TBakarBuluGreyFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','921');
 QTransaksi.Open;
 BakarBuluGreyFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TBakarBuluGreyFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TBakarBuluGreyFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TBakarBuluGreyFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TBakarBuluGreyFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TBakarBuluGreyFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TBakarBuluGreyFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TBakarBuluGreyFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
QDetailKD_SUB_LOKASI.AsString:='73-10000';
...
procedure TBakarBuluGreyFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.ColumnHeaderBand1BeforePrint(
...
procedure TBakarBuluGreyFrm.FNo_UrutBeforeQuery(
...
procedure TBakarBuluGreyFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TBakarBuluGreyFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TBakarBuluGreyFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TBakarBuluGreyFrm.vOperandClick(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  t1, t3 : real;
...
QBrowse.Open;
 ...
 while not QBrowse.Eof do
  begin
        t1:=t1+QBrowseQTY_GULUNG.AsFloat;
        t3:=t3+QBrowseQTY_COUNTER.AsFloat;
        QBrowse.Next;
  end;

  wwDBGrid1xxxxx.ColumnByName('QTY_GULUNG').FooterValue:=FormatFloat('0.0,0;(0.0,0); ',t1);
  wwDBGrid1xxxxx.ColumnByName('QTY_COUNTER').FooterValue:=FormatFloat('0.0,0;(0.0,0); ',t3);


end;

procedure TBakarBuluGreyFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TBakarBuluGreyFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TBakarBuluGreyFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TBakarBuluGreyFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TBakarBuluGreyFrm.FormShow(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
...
procedure TBakarBuluGreyFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TBakarBuluGreyFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TBakarBuluGreyFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TBakarBuluGreyFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TBakarBuluGreyFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TBakarBuluGreyFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TBakarBuluGreyFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TBakarBuluGreyFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TBakarBuluGreyFrm.BitBtn4Click(Sender: TObject);
begin
  //QMaster.Edit;
  //QMaster.Post;
  //QAmbilData.Close;
...
procedure TBakarBuluGreyFrm.LookMesinFinishingCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TBakarBuluGreyFrm.LookMesinFinishingEnter(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TBakarBuluGreyFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TBakarBuluGreyFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TBakarBuluGreyFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.BitBtn5Click(Sender: TObject);
var
  vjam : string;
  vjam1,vjam2 : Integer;
begin
...
QPerKonstruksi.DisableControls;
  ...
  wwDBGrid2.ColumnByName('KODI').FooterValue:=FormatFloat('#.#,##;#.#,#; ',QPerKonstruksi_TotKODI.AsFloat);
end;

procedure TBakarBuluGreyFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure TBakarBuluGreyFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
QRLabel26.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TBakarBuluGreyFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TBakarBuluGreyFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vfilter : String;
begin
...
procedure TBakarBuluGreyFrm.QLookAmbilBatchEnter(Sender: TObject);
begin
QAmbilBatch.Open;
end;

procedure TBakarBuluGreyFrm.QLookAmbilBatchCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
//QDetailNO_BATCH.AsString:=QAmbilBatchKETERANGAN2.AsString;
end;

procedure TBakarBuluGreyFrm.LookAmbilBatchEnter(Sender: TObject);
begin
QAmbilBatch.Open;
end;

procedure TBakarBuluGreyFrm.LookAmbilBatchCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  QDetailNO_BATCH.AsString:=QAmbilBatchKETERANGAN2.AsString;
  QDetailKD_KONSTRUKSI.AsString:=QAmbilBatchKD_KONSTRUKSI_1.AsString;
  QDetailKONSTRUKSI.AsString:=QAmbilBatchKONSTRUKSI_1.AsString;
  QDetailKETERANGAN.AsString:=QAmbilBatchKET_KONSTRUKSI.AsString;
  QDetailQTY_GULUNG.AsString:=QAmbilBatchQTY_GULUNG.AsString;
  QDetailQTY_COUNTER.AsString:=QAmbilBatchQTY_METER.AsString;
  QDetailKD_PRODUKSI.AsString:=QAmbilBatchKP_FINISH.AsString;
end;

procedure TBakarBuluGreyFrm.wwDBComboBox1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TBakarBuluGreyFrm.wwDBComboBox1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TBakarBuluGreyFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TBakarBuluGreyFrm.wwDBLookupComboDlg3CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR2.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TBakarBuluGreyFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TBakarBuluGreyFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TBakarBuluGreyFrm.LookSuplierClick(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TBakarBuluGreyFrm.LookSuplierEnter(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TBakarBuluGreyFrm.LookSuplierCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TBakarBuluGreyFrm.LookWarnaClick(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TBakarBuluGreyFrm.LookWarnaEnter(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TBakarBuluGreyFrm.LookWarnaCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TBakarBuluGreyFrm.LookJenisEnter(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TBakarBuluGreyFrm.LookJenisClick(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TBakarBuluGreyFrm.LookJenisCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TBakarBuluGreyFrm.Look_KPClick(Sender: TObject);
begin
  DMFrm.QKonstruksi_finish.Open;
end;

procedure TBakarBuluGreyFrm.Look_KPCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TBakarBuluGreyFrm.Look_KPEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi_finish.Open;
end;
