...
type
  TSerahKePrintingFrm = class(TForm)
    PanelCenter: TPanel;
    PanelHeader: TPanel;
    PanelFooter: TPanel;
    PanelTop: TPanel;
    ...
    QAmbilQTY: TFloatField;
    QAmbilQTY2: TFloatField;
    QAmbilQTY3: TFloatField;
    QAmbilPR: TFloatField;
    ...
    QAmbilMITRA: TStringField;
    QPerKonstruksi_MKD_PRODUKSI: TStringField;
    QPerKonstruksi_MKONSTRUKSI: TStringField;
    QPerKonstruksi_MQTY_POTONG: TFloatField;
    QPerKonstruksi_M_TotQTY_POTONG: TFloatField;
    Label24: TLabel;
    ...
    QBrowseMESIN_DET: TStringField;
    QBrowseMESIN_TENUN_DET: TStringField;
...
var
SerahKePrintingFrm: TSerahKePrintingFrm;

implementation

uses DM, Math, FinishOpening, HasilInspectKeFolding;

{$R *.dfm}

procedure TSerahKePrintingFrm.FormClose(Sender: TObject;
...
procedure TSerahKePrintingFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.wwDBGrid1Enter(Sender: TObject);
begin
 If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahKePrintingFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','993');
 QTransaksi.Open;
 SerahKePrintingFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TSerahKePrintingFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TSerahKePrintingFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TSerahKePrintingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
  if (QMasterISPOST.AsString='1') and (QMasterNO_NOTA.AsString='') then
  begin
      FNo_Urut.Close;
      FNo_Urut.SetVariable('pkode','993');
...
procedure TSerahKePrintingFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahKePrintingFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahKePrintingFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahKePrintingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TSerahKePrintingFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahKePrintingFrm.FNo_UrutBeforeQuery(
...
procedure TSerahKePrintingFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahKePrintingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahKePrintingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahKePrintingFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
QBrowse.Open;
  ...
  //    for i:=0 to QBrowse.FieldCount-1 do
    ...
    vfilter:=vfilter+')'; // and kd_transaksi = ''993''';
...
procedure TSerahKePrintingFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahKePrintingFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahKePrintingFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TSerahKePrintingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahKePrintingFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahKePrintingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahKePrintingFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahKePrintingFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahKePrintingFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahKePrintingFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahKePrintingFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahKePrintingFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi.Open;
end;

procedure TSerahKePrintingFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TSerahKePrintingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TSerahKePrintingFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahKePrintingFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahKePrintingFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahKePrintingFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.BitBtn4Click(Sender: TObject);
begin
   if QBrowse.Active then
      begin
        DMFrm.QUserTime.Close;
...
procedure TSerahKePrintingFrm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
...
abort;
  ...
  wwDBGrid2.ColumnByName('QTY_POTONG').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QPerKonstruksi_M_TotQTY_POTONG.AsFloat);
  wwDBGrid2.ColumnByName('QTY_METER').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QPerKonstruksi_M_TotQTY_METER.AsFloat);

end;

procedure TSerahKePrintingFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TSerahKePrintingFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TSerahKePrintingFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TSerahKePrintingFrm.DBText1Click(Sender: TObject);
begin
 InputBox (' Copy Nomer','Klik Kanan --> Copy : ',QMasterNO_NOTA.AsString);
end;

procedure TSerahKePrintingFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     QRLabel8.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TSerahKePrintingFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TSerahKePrintingFrm.QPer_HariAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QPerKonstruksi_M.RecNo)+' dari '+FormatFloat('#,#',QPerKonstruksi_M.RecordCount)+' Records';
end;

procedure TSerahKePrintingFrm.look_mesinEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahKePrintingFrm.Look_CorakEnter(Sender: TObject);
Begin
DMFrm.QCorak.Open;
end;

procedure TSerahKePrintingFrm.LookMsnTenunEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahKePrintingFrm.LookMsnTenunClick(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahKePrintingFrm.LookMsnTenunCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
    //QMasterCORAK.AsString:=DMFrm.QCorakNAMA_CORAK.AsString;
...
procedure TSerahKePrintingFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahKePrintingFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahKePrintingFrm.BitBtn7Click(Sender: TObject);
begin
  wwDBGrid1Enter(nil);
...
procedure TSerahKePrintingFrm.LookAmbilClick(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahKePrintingFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahKePrintingFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahKePrintingFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
Var
  vfilter : String;
begin
...
procedure TSerahKePrintingFrm.LookKdProdClick(Sender: TObject);
begin
DMFrm.QLookKdProduksi.Open;
end;

procedure TSerahKePrintingFrm.LookKdProdCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahKePrintingFrm.LookKdProdEnter(Sender: TObject);
begin
DMFrm.QLookKdProduksi.Open;
end;

procedure TSerahKePrintingFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TSerahKePrintingFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TSerahKePrintingFrm.Button1Click(Sender: TObject);
begin
