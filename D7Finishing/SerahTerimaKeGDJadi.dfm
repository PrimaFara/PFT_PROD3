object SerahTerimaKeGDJadiFrm: TSerahTerimaKeGDJadiFrm
      ...
      object PanelCenter: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'QTY'#9'7'#9'GRADE A'#9'F'#9'MUTU'
            'QTY2'#9'7'#9'GRADE B'#9'F'#9'MUTU'
  ...
  object QDetail: TOracleDataSet
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      040000002E0000000D0000004E4F5F5245475F44455441494C01000000000006
      ...
      0000090000005154595F414646414C0100000000000500000050414C45540100
      00000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
  ...
  object FNo_Urut: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000060000003A504B4F44450500000004000000393934000000
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vrekap_kirim_ke_jahit_kemas'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000018000000070000004E4F5F4E4F54410100000000000A00000054474C
      ...
      
      504F53540100000000000500000050414C4554010000000000}
    QueryAllRecords = False
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(bk) as bk, sum(bs) as bs, sum(parah) as parah from ip' +
        'isma_db5.vrekap_kirim_ke_jahit_kemas'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QPerKonstruksiKemas_Tot: TOracleDataSet
    SQL.Strings = (
      ...
      ''
      'from (select * from ipisma_db5.vkirim_ke_jahit_kemas'
  ...
  object QPerKonstruksiKemas: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00000B0000004C454C414E475F4B4F4449010000000000050000005348494654
      010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
  ...
  object QPerShift: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0100000000000300000054474C010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 756
    ...
    object QPerShiftLELANG: TFloatField
      FieldName = 'LELANG'
    end
    object QPerShiftLELANG_KODI: TFloatField
      FieldName = 'LELANG_KODI'
    end
  end
  ...
  object QPerKp: TOracleDataSet
    SQL.Strings = (
      ...
      'from '
      ''
      '(select * from ipisma_db5.vkirim_ke_jahit_kemas'
    ...
    Variables.Data = {
      ...
      0000000D0000003A4B445F5452414E53414B5349050000000400000039393400
      00000000}
    QBEDefinition.QBEFieldDefs = {
      
      00000B0000004B445F50524F44554B5349010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 556
