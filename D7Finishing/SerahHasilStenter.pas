...
type
  TSerahHasilStenterFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
...
var
  SerahHasilStenterFrm: TSerahHasilStenterFrm;
...
procedure TSerahHasilStenterFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  SerahHasilStenterFrm:=Nil;
end;

procedure TSerahHasilStenterFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahHasilStenterFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilStenterFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','907');
 QTransaksi.Open;
...
procedure TSerahHasilStenterFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilStenterFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilStenterFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TSerahHasilStenterFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahHasilStenterFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahHasilStenterFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahHasilStenterFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
QDetailKD_SUB_LOKASI2.AsString:='77-10000';
...
procedure TSerahHasilStenterFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahHasilStenterFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahHasilStenterFrm.FNo_UrutBeforeQuery(
...
procedure TSerahHasilStenterFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahHasilStenterFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahHasilStenterFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahHasilStenterFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahHasilStenterFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahHasilStenterFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahHasilStenterFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahHasilStenterFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
  ...
  QBrowse.Close;
  QBrowse.SetVariable('kd_transaksi','907');
  QBrowse.SetVariable('myparam',vfilter+vorder);
  QBrowse.Open;
  QBrowseTotal.Close;
  QBrowseTotal.SetVariable('kd_transaksi','907');
...
procedure TSerahHasilStenterFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahHasilStenterFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahHasilStenterFrm.TabSheet2Show(Sender: TObject);
begin
{azmi}
if vTab='Bro' then
   vTab:='In'
...
procedure TSerahHasilStenterFrm.TabSheet1Show(Sender: TObject);
begin
  if QBrowse.Active then
  begin
         QMaster.Close;
...
procedure TSerahHasilStenterFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahHasilStenterFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahHasilStenterFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahHasilStenterFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilStenterFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahHasilStenterFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahHasilStenterFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilStenterFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahHasilStenterFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilStenterFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TSerahHasilStenterFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TSerahHasilStenterFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilStenterFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilStenterFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
//QMasterKD_KONSTRUKSI.AsString:=DMFrm.QKonstruksiKD_KONSTRUKSI.AsString;
//QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TSerahHasilStenterFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
...
procedure TSerahHasilStenterFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahHasilStenterFrm.LookAmbilCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
