...
type
  TSerahHasilWashingFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
...
var
  SerahHasilWashingFrm: TSerahHasilWashingFrm;
...
procedure TSerahHasilWashingFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  SerahHasilWashingFrm:=Nil;
end;

procedure TSerahHasilWashingFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahHasilWashingFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilWashingFrm.FormCreate(Sender: TObject);
begin
...
procedure TSerahHasilWashingFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilWashingFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilWashingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TSerahHasilWashingFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahHasilWashingFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahHasilWashingFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahHasilWashingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TSerahHasilWashingFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahHasilWashingFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahHasilWashingFrm.FNo_UrutBeforeQuery(
...
procedure TSerahHasilWashingFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahHasilWashingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahHasilWashingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahHasilWashingFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahHasilWashingFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahHasilWashingFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahHasilWashingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahHasilWashingFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
  ...
  QBrowse.Close;
  QBrowse.SetVariable('kd_transaksi','906');
  QBrowse.SetVariable('myparam',vfilter+vorder);
  QBrowse.Open;
  QBrowseTotal.Close;
  QBrowseTotal.SetVariable('kd_transaksi','906');
...
procedure TSerahHasilWashingFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahHasilWashingFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahHasilWashingFrm.TabSheet2Show(Sender: TObject);
begin
{azmi}
if vTab='Bro' then
   vTab:='In'
...
procedure TSerahHasilWashingFrm.TabSheet1Show(Sender: TObject);
begin
  if QBrowse.Active then
  begin
         QMaster.Close;
...
procedure TSerahHasilWashingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahHasilWashingFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahHasilWashingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahHasilWashingFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilWashingFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahHasilWashingFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahHasilWashingFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilWashingFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahHasilWashingFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilWashingFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TSerahHasilWashingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TSerahHasilWashingFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilWashingFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilWashingFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
//QMasterKD_KONSTRUKSI.AsString:=DMFrm.QKonstruksiKD_KONSTRUKSI.AsString;
//QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TSerahHasilWashingFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
...
procedure TSerahHasilWashingFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahHasilWashingFrm.LookAmbilCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
