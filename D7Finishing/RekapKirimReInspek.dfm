object RekapKirimReInspekFrm: TRekapKirimReInspekFrm
  Left = 274
  Top = 127
  Width = 1002
  Height = 594
  Caption = 'Rekap Pengiriman Dari ReInspek'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object PanelCenter: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'KD_PRODUKSI'#9'10'#9'KODE PROD'#9'F'
            'KD_KONSTRUKSI'#9'6'#9'KODE'#9'T'#9'KONSTRUKSI'
            'KONSTRUKSI'#9'35'#9'NAMA'#9'T'#9'KONSTRUKSI'
            'BK'#9'10'#9'BK'#9'F'#9'JUMLAH'
    ...
    object TabSheet3: TTabSheet
      ...
      object wwDBGrid5: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KONSTRUKSI'#9'35'#9'KONSTRUKSI'#9'F'
          'BK'#9'10'#9'BK'#9'F'#9'JUMLAH PENGIRIMAN'
          'BGRADE'#9'10'#9'BGRADE'#9'F'#9'JUMLAH PENGIRIMAN'
    ...
    object TabSheet4: TTabSheet
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'BK'#9'10'#9'BK'#9'F'#9'JUMLAH PENGIRIMAN'
          'BS'#9'10'#9'B - GRADE'#9'F'#9'JUMLAH PENGIRIMAN'
          'PERSEN_BS'#9'10'#9'% BS'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Finishing'
        IniAttributes.Delimiter = ';;'
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.rekap_kirim_reinspek a'
    ...
    Variables.Data = {
      ...
      0D0000003A4B445F5452414E53414B5349050000000400000039303600000000
    ...
    QBEDefinition.QBEFieldDefs = {
      
      48494654010000000000}
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.rekap_kirim_reinspek_det a'
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      040000000F0000000D0000004E4F5F5245475F44455441494C01000000000006
      ...
      
      00000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
    ...
    object QDetailBS_PARAH: TFloatField
      FieldName = 'BS_PARAH'
    end
  ...
  object FNo_Urut: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000060000003A504B4F44450500000004000000393036000000
      0000050000003A5054474C0C000000070000007879020101010100000000}
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vrekap_kirim_reinspek'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000013000000070000004E4F5F4E4F54410100000000000A00000054474C
      ...
      
      000000}
    QueryAllRecords = False
    ...
    object QBrowseBGRADE: TFloatField
      FieldName = 'BGRADE'
    end
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(bs) as bs '
      'from ipisma_db5.vrekap_kirim_reinspek'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      06000000424752414445010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 12
    ...
    object QBrowseTotalBGRADE: TFloatField
      FieldName = 'BGRADE'
    end
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(bgrade) as bgrade, '
      'sum(bs) as bs,'
      '(sum(bk)+ sum (bgrade)+ sum (bs))as qty '
      'from ipisma_db5.rekap_kirim_reinspek_det a'
      'where a.no_reg = :no_reg')
    Variables.Data = {0300000001000000070000003A4E4F5F524547030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      040000000400000002000000424B010000000000020000004253010000000000
      0600000042475241444501000000000003000000515459010000000000}
    Session = DMFrm.OS
    Left = 17
    Top = 208
  ...
  object QPerKonstruksiKemas_Tot: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00000000000200000042530100000000000900000050455253454E5F42530100
      00000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    ...
    object QPerKonstruksiKemas_TotPERSEN_BS: TFloatField
      FieldName = 'PERSEN_BS'
    end
  end
  object QPerKonstruksiKemas: TOracleDataSet
    SQL.Strings = (
      'select '
      'distinct kd_produksi,(konstruksi) as konstruksi, '
      'sum(bk)as bk,'
      'sum(bgrade)as bgrade,'
      'sum(bs)as bs,'
      '(sum(bk)+ sum (bgrade)+ sum (bs))as total'
      'from ipisma_db5.vrekap_kirim_reinspek'
      'where tgl>=:pawal and tgl<=:pakhir'
      ':myparam'
      ''
    ...
    Variables.Data = {
      ...
      70206279206B645F70726F64756B73692C206B6F6E737472756B736900000000
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      424B0100000000000200000042530100000000000B0000004B445F50524F4455
      4B53490100000000000600000042475241444501000000000005000000544F54
      414C010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    ...
    object QPerKonstruksiKemasBGRADE: TFloatField
      FieldName = 'BGRADE'
    end
    object QPerKonstruksiKemasBS: TFloatField
      FieldName = 'BS'
    end
    object QPerKonstruksiKemasTOTAL: TFloatField
      FieldName = 'TOTAL'
    end
  end
  ...
  object QPerCorak: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00000000000200000042530100000000000900000050455253454E5F42530100
      0000000005000000434F52414B010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 708
  ...
  object QPerCorak_Tot: TOracleDataSet
    ...
    object QPerCorak_TotPERSEN_BS: TFloatField
      FieldName = 'PERSEN_BS'
    end
  end
