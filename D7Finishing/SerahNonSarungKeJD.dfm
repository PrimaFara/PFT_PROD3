object SerahNonSarungKeJDFrm: TSerahNonSarungKeJDFrm
  Left = 241
  Top = 133
  Width = 1123
  Height = 558
  ActiveControl = GroupBox1
  Caption = 'Serah Non Sarung'
  Color = clBtnFace
      ...
      object PanelCenter: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            ...
            'KETERANGAN;CustomEdit;LookKet;F'
        ...
        object LookKonstruksi: TwwDBLookupComboDlg
          ...
          DataSource = dsQMaster
          LookupTable = DMFrm.QKonstruksi_kelompok
    ...
    object TabSheet3: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'POTONG'#9'10'#9'METER'#9'F'#9'JUMLAH')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.serah_nonsarung_jetdyeing a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_NS_JETDYEING'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00050000004B4952494D010000000000}
    ...
    object QMasterKIRIM: TStringField
      FieldName = 'KIRIM'
    end
  end
  object QDetail: TOracleDataSet
    SQL.Strings = (
        ...
        'select a.*, a.rowid from ipisma_db5.serah_nonsarung_jetdyeing_de' +
        't a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_NS_JETDYEING_DET'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
  ...
  object FNo_Urut: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000060000003A504B4F44450500000004000000393137000000
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vserah_nonsarung_jetdyeing'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      504F010000000000090000004A454E49535F444554010000000000050000004B
      4952494D010000000000}
    QueryAllRecords = False
    ...
    object QBrowseKIRIM: TStringField
      FieldName = 'KIRIM'
    end
  end
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        ' ipisma_db5.vserah_nonsarung_jetdyeing'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_potong) as potong from' +
        ' ipisma_db5.serah_nonsarung_jetdyeing_det a'
      'where a.no_reg =:no_reg'
      '')
    Variables.Data = {
      0300000001000000070000003A4E4F5F52454703000000040000004200000000
      000000}
    QBEDefinition.QBEFieldDefs = {
      04000000020000000600000047554C554E4701000000000006000000504F544F
      4E47010000000000}
  ...
  object QPer_Hari: TOracleDataSet
    SQL.Strings = (
        ...
        'select konstruksi, sum (qty_gulung) as gulung, sum(qty_potong) a' +
        's potong from ipisma_db5.vserah_nonsarung_jetdyeing '
  ...
  object QAmbil: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vlook_serah_finish_ns')
    QBEDefinition.QBEFieldDefs = {
      
