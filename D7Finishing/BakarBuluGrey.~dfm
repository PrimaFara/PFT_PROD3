object BakarBuluGreyFrm: TBakarBuluGreyFrm
      ...
      object PanelCenter: TPanel
        ...
        object PanelFooter: TPanel
          ...
          object LookAmbilBatch: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              ...
              'KET_KONSTRUKSI'#9'10'#9'KETERANGAN'#9'F'
              'QTY_GULUNG'#9'10'#9'QTY_GULUNG'#9'F'
              'QTY_METER'#9'10'#9'QTY_METER'#9'F'
              'KP_FINISH'#9'10'#9'KP_FINISH'#9'F'
              'KD_KONSTRUKSI_1'#9'6'#9'KD_KONS_FINISH'#9'F'
              'KONSTRUKSI_1'#9'25'#9'KONS_FINISH'#9'F')
            DataField = 'NO_BATCH'
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'KETERANGAN'#9'15'#9'KETERANGAN'#9'F'#9'KONSTRUKSI'
  ...
  object QMaster: TOracleDataSet
    ...
    Variables.Data = {
      ...
      0D0000003A4B445F5452414E53414B5349050000000400000039323100000000
  ...
  object QDetail: TOracleDataSet
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      040000001F0000000D0000004E4F5F5245475F44455441494C01000000000006
  ...
  object FNo_Urut: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000060000003A504B4F44450500000004000000393231000000
  ...
  object QBrowse: TOracleDataSet
    ...
    object QBrowseNO_KON: TStringField
      FieldName = 'NO_KON'
      Size = 81
    end
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        ' ipisma_db5.bukti_bakarbulu_det a'
      'where a.no_reg = :no_reg')
  ...
  object QAmbil: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vlook_bakarbulu_non WHERE :MYPARAM'
      ''
      '')
    Variables.Data = {
  ...
  object QAmbilBatch: TOracleDataSet
    SQL.Strings = (
      '--select * from ipisma_db6.vrekap_hasil_pemart'
      
        'select t.*, r.kd_konstruksi, r.konstruksi from ipisma_db6.VREKAP' +
        '_HASIL_PEMART t'
      'left outer join'
      '(select distinct kp, kd_konstruksi, konstruksi from ('
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
    ...
    object QAmbilBatchKD_KONSTRUKSI_1: TStringField
      ...
      DisplayWidth = 6
      FieldName = 'KD_KONSTRUKSI_1'
      Size = 6
    end
    object QAmbilBatchKONSTRUKSI_1: TStringField
      DisplayLabel = 'KONS_FINISH'
      DisplayWidth = 25
      FieldName = 'KONSTRUKSI_1'
      Size = 255
    end
    object QAmbilBatchNO_REG: TFloatField
      FieldName = 'NO_REG'
      Required = True
      Visible = False
    end
    object QAmbilBatchTGL: TDateTimeField
      FieldName = 'TGL'
      Visible = False
    end
    object QAmbilBatchNO_NOTA: TStringField
      FieldName = 'NO_NOTA'
      Visible = False
    end
    object QAmbilBatchGRUP: TStringField
      FieldName = 'GRUP'
      Required = True
      Visible = False
      Size = 8
    end
    object QAmbilBatchSHIFT: TStringField
      FieldName = 'SHIFT'
      Required = True
      Visible = False
      Size = 3
    ...
    object QAmbilBatchMUTU: TStringField
      FieldName = 'MUTU'
      Visible = False
      Size = 30
    end
    object QAmbilBatchNO_PART: TStringField
      FieldName = 'NO_PART'
      Visible = False
      Size = 50
    end
    ...
    object QAmbilBatchBK: TFloatField
      FieldName = 'BK'
      Visible = False
    end
    object QAmbilBatchBGRADE: TFloatField
      FieldName = 'BGRADE'
      Visible = False
    end
    object QAmbilBatchBS_PARAH: TFloatField
      FieldName = 'BS_PARAH'
      Visible = False
    end
    object QAmbilBatchTOTAL: TFloatField
      FieldName = 'TOTAL'
      Visible = False
    end
    object QAmbilBatchAFFAL: TFloatField
      FieldName = 'AFFAL'
      Visible = False
    end
    ...
    object QAmbilBatchKELOMPOK: TStringField
      FieldName = 'KELOMPOK'
      Visible = False
      Size = 12
    end
    object QAmbilBatchTGL_INSERT: TDateTimeField
      FieldName = 'TGL_INSERT'
      Visible = False
    end
    object QAmbilBatchOPR_INSERT: TStringField
      FieldName = 'OPR_INSERT'
      Visible = False
      Size = 30
    end
    object QAmbilBatchPETUGAS: TStringField
      FieldName = 'PETUGAS'
      Visible = False
      Size = 278
    end
    ...
    object QAmbilBatchTAHUN: TFloatField
      FieldName = 'TAHUN'
      Visible = False
    end
    object QAmbilBatchNAMA_ITEM: TStringField
      FieldName = 'NAMA_ITEM'
      Visible = False
      Size = 108
    end
