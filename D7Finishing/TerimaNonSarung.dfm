object TerimaNonSarungFrm: TTerimaNonSarungFrm
  Left = 310
  Top = 79
  Width = 1174
  Height = 656
  ActiveControl = GroupBox1
  Caption = 'Terima Non Sarung'
  Color = clBtnFace
      ...
      object QuickRep2: TQuickRep
        ...
        object QRBand1: TQRBand
          ...
          object QRLabel12: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'R E K A P  T E R I M A  N O N  S A R U N G'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.Terima_Non_Sarung a'
    ...
    Variables.Data = {
      ...
      0D0000003A4B445F5452414E53414B5349050000000400000039313600000000
      00070000003A4E4F5F524547030000000000000000000000}
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'ipisma_db5.REG_TERIMA_NONSARUNG'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0000000000050000004A454E495301000000000006000000544552494D410100
      00000000}
    ...
    object QMasterTERIMA: TStringField
      FieldName = 'TERIMA'
    end
  end
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.Terima_Non_Sarung_Det a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_TERIMA_NONSARUNG_DET'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      ...
      
      47414E010000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
  ...
  object FNo_Urut: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000060000003A504B4F44450500000004000000393136000000
      0000050000003A5054474C0C0000000700000078720C0101010100000000}
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vterima_non_sarung'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      00000006000000544552494D41010000000000}
    QueryAllRecords = False
    ...
    object QBrowseTERIMA: TStringField
      FieldName = 'TERIMA'
    end
  end
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_potong) as qty from ip' +
        'isma_db5.vterima_non_sarung'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000020000000600000047554C554E470100000000000300000051545901
      0000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_potong) as qty from ip' +
        'isma_db5.Terima_Non_Sarung_Det a'
      'where a.no_reg = :no_reg')
    Variables.Data = {0300000001000000070000003A4E4F5F524547030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000020000000600000047554C554E470100000000000300000051545901
  ...
  object Qkon_opening: TOracleDataSet
    SQL.Strings = (
        ...
        'select no_desain,konstruksi, sum (qty_gulung) as gulung, sum (qt' +
        'y_potong) as qty from ipisma_db5.vterima_non_sarung'
      ...
      '')
    Variables.Data = {
      0300000003000000080000003A4D59504152414D010000001E00000067726F75
      70206279206E6F5F64657361696E2C6B6F6E737472756B736900000000000600
      00003A504157414C0C0000000000000000000000070000003A50414B4849520C
      0000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000040000000A0000004B4F4E535452554B534901000000000006000000
      47554C554E4701000000000003000000515459010000000000090000004E4F5F
      44455341494E010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    AfterScroll = QBrowseAfterScroll
    Left = 12
    Top = 483
    object Qkon_openingNO_DESAIN: TStringField
      FieldName = 'NO_DESAIN'
    end
    ...
    object Qkon_openingQTY: TFloatField
      FieldName = 'QTY'
      DisplayFormat = '0.0,0;(0.0,0);'
    end
  end
  object Qkon_opening_Tot: TOracleDataSet
    ...
    object Qkon_opening_TotQTY: TFloatField
      FieldName = 'QTY'
      DisplayFormat = '0.0,0;(0.0,0);'
    end
  end
  ...
  object QAmbilData: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db5.proc_ambil_non_sarung(:qno_reg,:qno_nota);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
