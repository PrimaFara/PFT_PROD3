object HasilPresetFrm: THasilPresetFrm
  Left = 217
  Top = 136
  Width = 1141
  Height = 503
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.serah_ke_qa a'
    ...
    Variables.Data = {
      ...
      0D0000003A4B445F5452414E53414B5349050000000400000039303200000000
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.serah_ke_qa_det a'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * From (select * from ipisma_db5.vserah_preset_qa'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'from (select * from ipisma_db5.vserah_preset_qa'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(qty_gulung) as gulung, '
      'sum(qty_potong) as potong'
      'from ipisma_db5.serah_ke_qa_det a'
      'where a.no_reg =:no_reg'
      '')
    Variables.Data = {
