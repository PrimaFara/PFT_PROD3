...
type
  TTerimaDariDyeingFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelCenter: TPanel;
    PanelHeader: TPanel;
...
var
  TerimaDariDyeingFrm: TTerimaDariDyeingFrm;
...
procedure TTerimaDariDyeingFrm.FormClose(Sender: TObject;
...
procedure TTerimaDariDyeingFrm.FormResize(Sender: TObject);
begin
...
procedure TTerimaDariDyeingFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TTerimaDariDyeingFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','914');
 QTransaksi.Open;
 TerimaDariDyeingFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TTerimaDariDyeingFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TTerimaDariDyeingFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TTerimaDariDyeingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TTerimaDariDyeingFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TTerimaDariDyeingFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TTerimaDariDyeingFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TTerimaDariDyeingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TTerimaDariDyeingFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TTerimaDariDyeingFrm.ColumnHeaderBand1BeforePrint(
...
procedure TTerimaDariDyeingFrm.FNo_UrutBeforeQuery(
...
procedure TTerimaDariDyeingFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TTerimaDariDyeingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TTerimaDariDyeingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TTerimaDariDyeingFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TTerimaDariDyeingFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TTerimaDariDyeingFrm.vOperandClick(Sender: TObject);
begin
...
procedure TTerimaDariDyeingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TTerimaDariDyeingFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TTerimaDariDyeingFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TTerimaDariDyeingFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TTerimaDariDyeingFrm.TabSheet2Show(Sender: TObject);
begin
{azmi}
if vTab='Bro' then
   vTab:='In'
...
procedure TTerimaDariDyeingFrm.TabSheet1Show(Sender: TObject);
begin
  if QBrowse.Active then
  begin
         QMaster.Close;
{azmi}
        vTab:='Bro';
        QMaster.SQL.Text:='select a.*, a.rowid from ipisma_db5.terima_dari_dyeing a where kd_transaksi=:kd_transaksi and no_nota like :no_nota';
{azmi}
...
procedure TTerimaDariDyeingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TTerimaDariDyeingFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TTerimaDariDyeingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TTerimaDariDyeingFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TTerimaDariDyeingFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TTerimaDariDyeingFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TTerimaDariDyeingFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TTerimaDariDyeingFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TTerimaDariDyeingFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TTerimaDariDyeingFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TTerimaDariDyeingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TTerimaDariDyeingFrm.BitBtn4Click(Sender: TObject);
begin
  QMaster.Edit;
  QMaster.Post;
...
procedure TTerimaDariDyeingFrm.wwDBComboBox1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TTerimaDariDyeingFrm.wwDBComboBox1Enter(Sender: TObject);
begin
