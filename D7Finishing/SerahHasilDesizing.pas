...
type
  TSerahHasilDesizingFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
...
var
  SerahHasilDesizingFrm: TSerahHasilDesizingFrm;
...
procedure TSerahHasilDesizingFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  SerahHasilDesizingFrm:=Nil;
end;

procedure TSerahHasilDesizingFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahHasilDesizingFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilDesizingFrm.FormCreate(Sender: TObject);
begin
...
procedure TSerahHasilDesizingFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilDesizingFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilDesizingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TSerahHasilDesizingFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahHasilDesizingFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahHasilDesizingFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahHasilDesizingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
QDetailKD_SUB_LOKASI.AsString:='74-00000';
QDetailKD_SUB_LOKASI2.AsString:='75-00000';
...
procedure TSerahHasilDesizingFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahHasilDesizingFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahHasilDesizingFrm.FNo_UrutBeforeQuery(
...
procedure TSerahHasilDesizingFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahHasilDesizingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahHasilDesizingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahHasilDesizingFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahHasilDesizingFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahHasilDesizingFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahHasilDesizingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahHasilDesizingFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TSerahHasilDesizingFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahHasilDesizingFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahHasilDesizingFrm.TabSheet2Show(Sender: TObject);
begin
{azmi}
if vTab='Bro' then
   vTab:='In'
...
procedure TSerahHasilDesizingFrm.TabSheet1Show(Sender: TObject);
begin
  if QBrowse.Active then
  begin
         QMaster.Close;
...
procedure TSerahHasilDesizingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahHasilDesizingFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahHasilDesizingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahHasilDesizingFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilDesizingFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahHasilDesizingFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahHasilDesizingFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilDesizingFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahHasilDesizingFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilDesizingFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TSerahHasilDesizingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TSerahHasilDesizingFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilDesizingFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilDesizingFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahHasilDesizingFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
...
procedure TSerahHasilDesizingFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahHasilDesizingFrm.LookAmbilCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
