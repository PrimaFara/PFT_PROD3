object CalenderGreyFrm: TCalenderGreyFrm
  Left = 287
  Top = 137
  Width = 1028
  Height = 625
  ActiveControl = GroupBox1
  Caption = 'Calender Kain Grey'
  Color = clBtnFace
      ...
      object PanelCenter: TPanel
        ...
        object QuickRep1: TQuickRep
          ...
          object QRBand6: TQRBand
            ...
            object QRLabel6: TQRLabel
              ...
              AutoSize = True
              AutoStretch = False
              Caption = 'HASIL PRODUKSI CALENDER'
              Color = clWhite
              Font.Charset = DEFAULT_CHARSET
              Font.Color = clWindowText
              Font.Height = -19
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          ControlType.Strings = (
            ...
            'NO_BATCH;CustomEdit;LookAmbilBatch;F'
            'MESIN_TENUN;CustomEdit;wwDBComboBox1;F'
            'KD_WARNA;CustomEdit;LookWarna;F'
            'KD_REKANAN;CustomEdit;LookSuplier;F')
          Selected.Strings = (
            'NO_BATCH'#9'10'#9'NO. BATCH'#9'F'
            'NO_DESAIN'#9'15'#9'NO. DESAIN'#9'T'
            'NO_ORDER'#9'20'#9'NO. ORDER'#9'T'
            'KD_KONSTRUKSI'#9'6'#9'KODE'#9'T'#9'KONSTRUKSI'
            'KONSTRUKSI'#9'25'#9'NAMA'#9'T'#9'KONSTRUKSI'
            'KD_PRODUKSI'#9'10'#9'KETERANGAN'#9'T'#9'KONSTRUKSI'
            'CORAK'#9'15'#9'CORAK'#9'T'#9'WARNA DASAR'
            'QTY_GULUNG'#9'10'#9'JML GULUNG'#9'T'#9'WARNA DASAR'
            'QTY_COUNTER'#9'10'#9'JML METER'#9'T'#9'WARNA DASAR'
            'JENIS'#9'10'#9'JENIS'#9'F'
            'KETERANGAN'#9'10'#9'KETERANGAN'#9'T'
            'QTY_COUNTER2'#9'10'#9'PENYUSUTAN'#9'T'
            'KD_WARNA'#9'6'#9'KD_WARNA'#9'F'
            'WARNA'#9'20'#9'WARNA'#9'T'#9'WARNA DASAR'
        ...
        object LookAmbil: TwwDBLookupComboDlg
          ...
          Selected.Strings = (
            ...
            'KET_DETAIL'#9'20'#9'KET_DETAIL'#9'F'
        ...
        object LookAmbilBatch: TwwDBLookupComboDlg
          Left = 129
          Top = 372
          Width = 48
          Height = 21
          ...
          UserButton2Caption = '&Filter'
          Selected.Strings = (
            'KETERANGAN2'#9'10'#9'NO_BATCH'#9'F'
            'NO_DESAIN'#9'15'#9'NO_DESAIN'#9'F'
            'NO_ORDER'#9'20'#9'NO_ORDER'#9'F'
            'KD_KONSTRUKSI'#9'6'#9'KD_KONSTRUKSI'#9'F'
            'KONSTRUKSI'#9'20'#9'KONSTRUKSI'#9'F'
            'KET_KONSTRUKSI'#9'20'#9'KET_KONSTRUKSI'#9'F'
            'CORAK'#9'10'#9'CORAK'#9'F'
            'CORAK_PRINTING'#9'10'#9'CORAK_PRINTING'#9'F'
            'QTY_GULUNG'#9'10'#9'GULUNG'#9'F'
            'QTY_METER'#9'10'#9'QTY_METER'#9'F'
            'KET_DETAIL'#9'15'#9'KETERANGAN'#9'F'
            'METER'#9'10'#9'PENYUSUTAN'#9'F')
          DataSource = dsQDetail
          LookupTable = QAmbilBatch
          LookupField = 'KETERANGAN2'
          TabOrder = 7
          AutoDropDown = False
          ShowButton = True
          AllowClearKey = False
          OnCloseUp = LookAmbilBatchCloseUp
          OnEnter = LookAmbilBatchEnter
        end
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid1xxxxx: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KET_DETAIL'#9'10'#9'KET_DETAIL'#9'F'
          'KETERANGAN'#9'10'#9'KETERANGAN'#9'F'
          'JENIS'#9'20'#9'JENIS'#9'F'
          'OPR_INSERT'#9'10'#9'OPR_INSERT'#9'F'
          'QTY_COUNTER'#9'10'#9'METER'#9'F'
          'QTY_COUNTER2'#9'10'#9'PENYUSUTAN'#9'F'
          'QTY_GULUNG'#9'10'#9'GULUNG'#9'F'
      ...
      object QuickRep2: TQuickRep
        ...
        object QRBand1: TQRBand
          ...
          object QRLabel12: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'R E K A P  P R O D U K S I  C A L E N D E R'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.bukti_calender a'
      
        'where kd_transaksi=:kd_transaksi and (no_nota like :no_nota or n' +
        'o_nota is null) and no_reg=:no_reg'
      '')
    Variables.Data = {
      0300000003000000080000003A4E4F5F4E4F5441050000000200000025000000
      00000D0000003A4B445F5452414E53414B534905000000040000003932320000
      000000070000003A4E4F5F524547030000000000000000000000}
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'ipisma_db5.REG_CALENDER'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.bukti_calender_det a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_CALENDER_DET'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      ...
      
      414E414E010000000000080000004B445F5741524E41010000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
    Session = DMFrm.OS
  ...
  object FNo_Urut: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000060000003A504B4F44450500000004000000393232000000
      0000050000003A5054474C0C000000070000007878060101010100000000}
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from '
        ...
        '(select * from ipisma_db5.vfinish_calender where kd_transaksi = ' +
        #39'922'#39')'
      ':myparam'
      ''
      '')
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      4E414E010000000000}
    QueryAllRecords = False
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_counter) as meter from' +
        ' ipisma_db5.vfinish_calender'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_counter) as meter from' +
        ' ipisma_db5.bukti_calender_det a'
      'where a.no_reg = :no_reg')
  ...
  object QAmbilData: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db5.proc_ambil_Opening(:pno_reg,:pno_order);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000080000003A504E4F5F524547030000000000000000000000
      0A0000003A504E4F5F4F52444552050000000000000000000000}
    Left = 13
    Top = 360
  end
  object QAmbil: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vlook_calender WHERE :MYPARAM'
      '')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000110000004E4F5F4F
      52444552204C494B452027270000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000023000000070000004E4F5F4E4F5441010000000000060000004E4F5F
  ...
  object QPerKonstruksi_Tot: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db5.vfinish_calender'
  ...
  object QAmbilBatch: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db6.vrekap_pengiriman_kefinish'
      '')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000110000004E4F5F4F
      52444552204C494B452027270000000000}
    QBEDefinition.QBEFieldDefs = {
      
      0000004E414D415F4954454D010000000000}
    Session = DMFrm.OS
    Left = 177
    Top = 432
    object QAmbilBatchKETERANGAN2: TStringField
      DisplayLabel = 'NO_BATCH'
      DisplayWidth = 10
      FieldName = 'KETERANGAN2'
      Size = 255
    end
    object QAmbilBatchNO_DESAIN: TStringField
      DisplayWidth = 15
      FieldName = 'NO_DESAIN'
      Size = 100
    end
    ...
    object QAmbilBatchKD_KONSTRUKSI: TStringField
      DisplayWidth = 6
      FieldName = 'KD_KONSTRUKSI'
      Required = True
      Size = 6
    end
    object QAmbilBatchKONSTRUKSI: TStringField
      DisplayWidth = 20
      FieldName = 'KONSTRUKSI'
      Size = 150
    end
    object QAmbilBatchKET_KONSTRUKSI: TStringField
      DisplayWidth = 20
      FieldName = 'KET_KONSTRUKSI'
      Size = 100
    end
    object QAmbilBatchCORAK: TStringField
      DisplayWidth = 10
      FieldName = 'CORAK'
      Size = 30
    end
    ...
    object QAmbilBatchKET_DETAIL: TStringField
      DisplayLabel = 'KETERANGAN'
      DisplayWidth = 15
      FieldName = 'KET_DETAIL'
      Size = 255
    end
    object QAmbilBatchMETER: TFloatField
      DisplayLabel = 'PENYUSUTAN'
      DisplayWidth = 10
      FieldName = 'METER'
    end
  end
