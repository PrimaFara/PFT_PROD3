object SerahHasilWashingFrm: TSerahHasilWashingFrm
  Left = 200
  Top = 142
  Width = 1197
  Height = 532
  Caption = 'Serah Hasil Washing'
  Color = clBtnFace
  ...
  object QDetail: TOracleDataSet
    ...
    SequenceField.Sequence = 'REG_SERAH_ALL_DET'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowse: TOracleDataSet
    ...
    Variables.Data = {
      ...
      534905000000040000003930360000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAmbil: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vfinish_washing'
      'order by no_order'
      '')
    QBEDefinition.QBEFieldDefs = {
