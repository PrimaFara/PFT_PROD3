...
type
  TRekapKirimInspekFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelCenter: TPanel;
    PanelHeader: TPanel;
...
var
RekapKirimInspekFrm: TRekapKirimInspekFrm;
...
procedure TRekapKirimInspekFrm.FormClose(Sender: TObject;
...
procedure TRekapKirimInspekFrm.FormResize(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.wwDBGrid1Enter(Sender: TObject);
begin
 If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TRekapKirimInspekFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','904');
 QTransaksi.Open;
 RekapKirimInspekFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TRekapKirimInspekFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TRekapKirimInspekFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TRekapKirimInspekFrm.QMasterBeforePost(DataSet: TDataSet);
begin
  if (QMasterISPOST.AsString='1') and (QMasterNO_NOTA.AsString='') then
  begin
      FNo_Urut.Close;
      FNo_Urut.SetVariable('pkode','904');
...
procedure TRekapKirimInspekFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TRekapKirimInspekFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TRekapKirimInspekFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TRekapKirimInspekFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TRekapKirimInspekFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.ColumnHeaderBand1BeforePrint(
...
procedure TRekapKirimInspekFrm.FNo_UrutBeforeQuery(
...
procedure TRekapKirimInspekFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TRekapKirimInspekFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TRekapKirimInspekFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TRekapKirimInspekFrm.vOperandClick(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
QBrowse.Open;
  ...
  //    for i:=0 to QBrowse.FieldCount-1 do
    ...
    vfilter:=vfilter+') and kd_transaksi = ''904''';
  ...
  wwDBGrid1xxxxx.ColumnByName('QTY_GULUNG').FooterValue:=FormatFloat('0.0,0;(0.0,0); ',QBrowseTotalMETER.AsFloat);
...
procedure TRekapKirimInspekFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TRekapKirimInspekFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TRekapKirimInspekFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TRekapKirimInspekFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  ...
  wwDBGrid1.ColumnByName('QTY_GULUNG').FooterValue:=FormatFloat('#.#,#',QTotalMETER.AsFloat);
  //wwDBGrid1.ColumnByName('QTY3').FooterValue:=FormatFloat('#.#,#',QTotalPARAH.AsFloat);

end;

procedure TRekapKirimInspekFrm.FormShow(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
...
procedure TRekapKirimInspekFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TRekapKirimInspekFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TRekapKirimInspekFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TRekapKirimInspekFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TRekapKirimInspekFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TRekapKirimInspekFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi.Open;
end;

procedure TRekapKirimInspekFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TRekapKirimInspekFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TRekapKirimInspekFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TRekapKirimInspekFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TRekapKirimInspekFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
  ...
  wwDBGrid1xxxxx.ColumnByName('QTY_GULUNG').FooterValue:=FormatFloat('#.#,#',QBrowseTotalMETER.AsFloat);
  //wwDBGrid1.ColumnByName('QTY3').FooterValue:=FormatFloat('#.#,#',QTotalPARAH.AsFloat);

end;

procedure TRekapKirimInspekFrm.BitBtn4Click(Sender: TObject);
begin
   if QBrowse.Active then
      begin
        DMFrm.QUserTime.Close;
...
procedure TRekapKirimInspekFrm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
...
procedure TRekapKirimInspekFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TRekapKirimInspekFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TRekapKirimInspekFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TRekapKirimInspekFrm.DBText1Click(Sender: TObject);
begin
 InputBox (' Copy Nomer','Klik Kanan --> Copy : ',QMasterNO_NOTA.AsString);
end;

procedure TRekapKirimInspekFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     QRLabel8.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TRekapKirimInspekFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TRekapKirimInspekFrm.QPer_HariAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QPerKonstruksi_M.RecNo)+' dari '+FormatFloat('#,#',QPerKonstruksi_M.RecordCount)+' Records';
end;

procedure TRekapKirimInspekFrm.look_mesinEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TRekapKirimInspekFrm.Look_CorakEnter(Sender: TObject);
Begin
DMFrm.QCorak.Open;
end;

procedure TRekapKirimInspekFrm.LookMsnTenunEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TRekapKirimInspekFrm.LookMsnTenunClick(Sender: TObject);
begin
QMesin.Open;
end;

procedure TRekapKirimInspekFrm.LookMsnTenunCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TRekapKirimInspekFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TRekapKirimInspekFrm.BitBtn7Click(Sender: TObject);
begin
  wwDBGrid1Enter(nil);
...
procedure TRekapKirimInspekFrm.LookAmbilClick(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TRekapKirimInspekFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TRekapKirimInspekFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
 If modified then

    //QDetailQTY_POTONG.AsString:=QAmbil.AsString;
...
procedure TRekapKirimInspekFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
Var
  vfilter : String;
begin
...
procedure TRekapKirimInspekFrm.LookKdProdClick(Sender: TObject);
begin
QKdProd.Open;
end;

procedure TRekapKirimInspekFrm.LookKdProdCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TRekapKirimInspekFrm.LookKdProdEnter(Sender: TObject);
begin
QKdProd.Open;
end;

procedure TRekapKirimInspekFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
