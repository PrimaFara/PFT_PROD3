...
var  FinishOpeningFrm: TFinishOpeningFrm;
...
procedure TFinishOpeningFrm.FormClose(Sender: TObject;
...
procedure TFinishOpeningFrm.FormResize(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TFinishOpeningFrm.FormCreate(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TFinishOpeningFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TFinishOpeningFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TFinishOpeningFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TFinishOpeningFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TFinishOpeningFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TFinishOpeningFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TFinishOpeningFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.ColumnHeaderBand1BeforePrint(
...
procedure TFinishOpeningFrm.FNo_UrutBeforeQuery(
...
procedure TFinishOpeningFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TFinishOpeningFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TFinishOpeningFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TFinishOpeningFrm.vOperandClick(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vjam : string;
...
//ShowMessage(DMFrm.QHak_jamJAM1.AsString);
QBrowse.Open;
  vpertama:=True;
  if cbTanggal.Checked then
...
procedure TFinishOpeningFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TFinishOpeningFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TFinishOpeningFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TFinishOpeningFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TFinishOpeningFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TFinishOpeningFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TFinishOpeningFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
 
end;

procedure TFinishOpeningFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TFinishOpeningFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TFinishOpeningFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TFinishOpeningFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TFinishOpeningFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TFinishOpeningFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TFinishOpeningFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TFinishOpeningFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TFinishOpeningFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.dbcField2Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TFinishOpeningFrm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
 vjam : string;
...
procedure TFinishOpeningFrm.BtnExport2Click(Sender: TObject);
begin
if Qkon_opening.Active then
          begin
             DMFrm.SaveDialog1.DefaultExt:='XLK';
...
procedure TFinishOpeningFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TFinishOpeningFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
QRLabel26.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TFinishOpeningFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
DMFrm.QCorak.Open;
end;

procedure TFinishOpeningFrm.wwDBLookupComboDlg1Click(Sender: TObject);
begin
DMFrm.QCorak.Open;
end;

procedure TFinishOpeningFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TFinishOpeningFrm.Look_KPCloseUp(Sender: TObject; 
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 if modified then
    QDetailKD_KONSTRUKSI.AsString:=DMFrm.QKonstruksi_finishKD_KONSTRUKSI.AsString;
...
procedure TFinishOpeningFrm.Look_KPClick(Sender: TObject);
begin
  DMFrm.QKonstruksi_finish.Open;
  DMFrm.QKonstruksi_Kp.Open;
end;

procedure TFinishOpeningFrm.Look_KPEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi_finish.Open;
  DMFrm.QKonstruksi_Kp.Open;
end;

procedure TFinishOpeningFrm.LookMesinFinishingCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TFinishOpeningFrm.LookMesinFinishingEnter(Sender: TObject);
begin
...
procedure TFinishOpeningFrm.wwDBComboBox1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TFinishOpeningFrm.wwDBComboBox1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TFinishOpeningFrm.LookSuplierClick(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TFinishOpeningFrm.LookWarnaClick(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TFinishOpeningFrm.LookSuplierCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TFinishOpeningFrm.LookWarnaCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TFinishOpeningFrm.LookSuplierEnter(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TFinishOpeningFrm.LookWarnaEnter(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TFinishOpeningFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TFinishOpeningFrm.wwDBLookupComboDlg3CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR2.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TFinishOpeningFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TFinishOpeningFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TFinishOpeningFrm.LookJenisClick(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TFinishOpeningFrm.LookJenisCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TFinishOpeningFrm.LookJenisEnter(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TFinishOpeningFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TFinishOpeningFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TFinishOpeningFrm.BitBtn4Click(Sender: TObject);
begin
