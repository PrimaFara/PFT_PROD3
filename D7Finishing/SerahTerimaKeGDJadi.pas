...
type
  TSerahTerimaKeGDJadiFrm = class(TForm)
...
var
  SerahTerimaKeGDJadiFrm: TSerahTerimaKeGDJadiFrm;
  LastKereta: string;
...
procedure TSerahTerimaKeGDJadiFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  SerahTerimaKeGDJadiFrm:=Nil;
end;

procedure TSerahTerimaKeGDJadiFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahTerimaKeGDJadiFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','994');
 QTransaksi.Open;
 SerahTerimaKeGDJadiFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QMasterGRUP.AsString:= '0';
  QMasterSHIFT.AsString:='E';
...
procedure TSerahTerimaKeGDJadiFrm.LookRekananEnter(Sender: TObject);
begin
 DMFrm.QRekanan.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.LookRekananClick(Sender: TObject);
begin
   DMFrm.QRekanan.Close;
   DMFrm.QRekanan.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TSerahTerimaKeGDJadiFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahTerimaKeGDJadiFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi_Kp.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahTerimaKeGDJadiFrm.LookCorakCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  If modified then
...
procedure TSerahTerimaKeGDJadiFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahTerimaKeGDJadiFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahTerimaKeGDJadiFrm.QDetailAfterScroll(DataSet: TDataSet);
begin
  if not QDetailKERETA.IsNull then
    LastKereta := QDetailKERETA.AsString;
end;

procedure TSerahTerimaKeGDJadiFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  ...
  // Set nilai KERETA berdasarkan record sebelumnya
  if LastKereta <> '' then
    QDetailKERETA.AsString := LastKereta;
end;

procedure TSerahTerimaKeGDJadiFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahTerimaKeGDJadiFrm.FNo_UrutBeforeQuery(
...
procedure TSerahTerimaKeGDJadiFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahTerimaKeGDJadiFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahTerimaKeGDJadiFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahTerimaKeGDJadiFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TSerahTerimaKeGDJadiFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahTerimaKeGDJadiFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahTerimaKeGDJadiFrm.TabSheet2Show(Sender: TObject);
begin
{azmi}
{if vTab='Bro' then
   vTab:='In'
...
procedure TSerahTerimaKeGDJadiFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TSerahTerimaKeGDJadiFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahTerimaKeGDJadiFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahTerimaKeGDJadiFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahTerimaKeGDJadiFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahTerimaKeGDJadiFrm.VTglAwal3Change(Sender: TObject);
begin
vTglAkhir3.Date:=(VTglAwal3.Date);
end;

procedure TSerahTerimaKeGDJadiFrm.vTglAkhir3Change(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.cbOtomatis3Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.dbcField3Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahTerimaKeGDJadiFrm.vOperand2Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.cbTanggal3Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.BtnExport3Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn7Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
...
procedure TSerahTerimaKeGDJadiFrm.TabSheet3Show(Sender: TObject);
begin
// QPerKonstruksiKemas.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.wwDBGrid5UpdateFooter(Sender: TObject);
begin
  QPerKonstruksiKemas_Tot.Close;
  QPerKonstruksiKemas_Tot.Open;
  wwDBGrid5.ColumnByName('QTY_TOT').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QPerKonstruksiKemas_TotQTY_TOT.AsFloat);
...
procedure TSerahTerimaKeGDJadiFrm.DBText1Click(Sender: TObject);
begin
  InputBox('Copy Nomer','Klik Kanan --> Copy : ',QMasterNO_NOTA.AsString);
end;

procedure TSerahTerimaKeGDJadiFrm.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLabel25.Caption:='(Per : '+VTglAwal3.Text+' s/d '+VTglAkhir3.Text+')';
end;

procedure TSerahTerimaKeGDJadiFrm.BitBtn4Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
DMFrm.QUserTime.Open;
   QuickRep2.Preview
...
procedure TSerahTerimaKeGDJadiFrm.VTglAwal4Change(Sender: TObject);
begin
VTglAkhir4.Date:=(VTglAwal4.Date);
end;

procedure TSerahTerimaKeGDJadiFrm.VTglAkhir4Change(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.cbOtomatis4Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.dbcField4Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahTerimaKeGDJadiFrm.vOperand4Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.cbTanggal4Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
...
procedure TSerahTerimaKeGDJadiFrm.wwDBComboBox1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.wwDBComboBox1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TSerahTerimaKeGDJadiFrm.LookKeretaEnter(Sender: TObject);
begin
  QBrowseKereta.Close;
  QBrowseKereta.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.QDetailQTYChange(Sender: TField);
begin
{riki}
...
procedure TSerahTerimaKeGDJadiFrm.QDetailQTY2Change(Sender: TField);
begin
{riki}
if Ceil(QDetailQTY.AsFloat)>0 then
//begin
...
procedure TSerahTerimaKeGDJadiFrm.QDetailQTY3Change(Sender: TField);
begin
{riki}
if Ceil(QDetailQTY.AsFloat)>0 then
//begin
...
procedure TSerahTerimaKeGDJadiFrm.VTglAwal9Change(Sender: TObject);
begin
  VTglAkhir9.Date:=(VTglAwal9.Date);
end;

procedure TSerahTerimaKeGDJadiFrm.VTglAkhir9Change(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.CbOtomatis9Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.dbcField9Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahTerimaKeGDJadiFrm.vOperand9Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.cbTanggal9Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn6Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn9Click(Sender: TObject);
begin
if QPerShift.Active then
          begin
             DMFrm.SaveDialog1.DefaultExt:='XLK';
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn10Click(Sender: TObject);
var
...
procedure TSerahTerimaKeGDJadiFrm.WebBrowser1DocumentComplete(
...
procedure TSerahTerimaKeGDJadiFrm.VTglAwal2Change(Sender: TObject);
begin
  VTglAkhir2.Date:=(VTglAwal2.Date);
end;

procedure TSerahTerimaKeGDJadiFrm.VTglAkhir2Change(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.CbOtomatis2Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.dbcField2Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahTerimaKeGDJadiFrm.vOperand3Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.cbTanggal2Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn12Click(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn13Click(Sender: TObject);
var
  HTMLContent: TStringList;
  i: Integer;
  FieldName: String;
...
procedure TSerahTerimaKeGDJadiFrm.BitBtn11Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
begin
  ...
  wwDBGrid3.ColumnByName('QTY_TOT').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QPerKonstruksiKemas_TotQTY_TOT.AsFloat);
  wwDBGrid3.ColumnByName('QTY_TOT_KODI').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QPerKonstruksiKemas_TotQTY_TOT_KODI.AsFloat);
...
procedure TSerahTerimaKeGDJadiFrm.WebBrowser2DocumentComplete(
  Sender: TObject; const pDisp: IDispatch; var URL: OleVariant);
var
  vaIn, vaOut: OleVariant;
begin
...
procedure TSerahTerimaKeGDJadiFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TSerahTerimaKeGDJadiFrm.BtnOk2Click(Sender: TObject);
var
...
procedure TSerahTerimaKeGDJadiFrm.LookWarnaClick(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TSerahTerimaKeGDJadiFrm.LookWarnaCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
