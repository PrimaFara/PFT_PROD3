...
type
  TPermintaanJualBarangFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelCenter: TPanel;
    PanelHeader: TPanel;
...
var
  PermintaanJualBarangFrm: TPermintaanJualBarangFrm;
...
procedure TPermintaanJualBarangFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  PermintaanJualBarangFrm:=Nil;
end;

procedure TPermintaanJualBarangFrm.FormResize(Sender: TObject);
begin
...
procedure TPermintaanJualBarangFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TPermintaanJualBarangFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','986');
 QTransaksi.Open;
...
procedure TPermintaanJualBarangFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TPermintaanJualBarangFrm.LookRekananEnter(Sender: TObject);
begin
 DMFrm.QRekanan.Open;
end;

procedure TPermintaanJualBarangFrm.LookRekananClick(Sender: TObject);
begin
   DMFrm.QRekanan.Close;
   DMFrm.QRekanan.Open;
end;

procedure TPermintaanJualBarangFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPermintaanJualBarangFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TPermintaanJualBarangFrm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TPermintaanJualBarangFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TPermintaanJualBarangFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TPermintaanJualBarangFrm.LookCorakCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  If modified then
...
procedure TPermintaanJualBarangFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TPermintaanJualBarangFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TPermintaanJualBarangFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPermintaanJualBarangFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TPermintaanJualBarangFrm.ColumnHeaderBand1BeforePrint(
...
procedure TPermintaanJualBarangFrm.FNo_UrutBeforeQuery(
...
procedure TPermintaanJualBarangFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
