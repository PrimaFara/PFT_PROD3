...
begin
  if RAmbil.ItemIndex = 0 then // SARUNG
    begin
        ...
        QAmbilData2.SQL.Add(' a.corak, a.tanggal, a.nik, a.opr_tenun, a.no_produksi, a.grup, b.kd_konstruksi, c.kd_corak, a.qty, a.no_desain, a.jenis_mesin, a.kp, c.jenis, a.tgl_ptg from ipisma_db4.vdesain_hasil_tenun_detail a, ipisma_db2.konstruksi@sales b, ipisma_db2.corak c');
        ...
        QAmbilData2.SQL.Add('and b.status LIKE ''1'' and c.jenis LIKE '+'''S'''+' and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        QAmbilData2.Execute;
        QDetail.Close;
    ...
    begin
        ...
        //QAmbilData2.SQL.Add(' and c.jenis LIKE '+'''S'''+' and (a.grup like '''+Edit4.Text+'%'') and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        //QAmbilData2.SQL.Add(' and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        QAmbilData2.SQL.Add('and b.status LIKE ''1'' and b.status LIKE '+'''1'''+' and c.jenis LIKE '+'''NS'''+' and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        QAmbilData2.Execute;
        QDetail.Close;
        QDetail.SetVariable('myorder',' order by proses, grup');
        QDetail.Open;
    ...
    begin
        ...
        //QAmbilData2.SQL.Add(' and c.jenis LIKE '+'''S'''+' and (a.grup like '''+Edit4.Text+'%'') and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        //QAmbilData2.SQL.Add(' and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        QAmbilData2.SQL.Add('and b.status LIKE ''1'' and b.status LIKE '+'''1'''+' and (a.no_reg like '''+Edit7.Text+'%'') and c.jenis LIKE '+'''S'''+' and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
    ...
    begin
        ...
        //QAmbilData2.SQL.Add(' and c.jenis LIKE '+'''S'''+' and (a.grup like '''+Edit4.Text+'%'') and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        //QAmbilData2.SQL.Add(' and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        QAmbilData2.SQL.Add('and b.status LIKE ''1'' and b.status LIKE '+'''1'''+' and (a.no_reg like '''+Edit7.Text+'%'') and c.jenis LIKE '+'''NS'''+' and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
    ...
    begin
        ...
        //QAmbilData2.SQL.Add(' and c.jenis LIKE '+'''S'''+' and (a.grup like '''+Edit4.Text+'%'') and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        //QAmbilData2.SQL.Add(' and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        QAmbilData2.SQL.Add('and b.status LIKE ''1'' and c.jenis is null and (a.lokasi like '''+Edit3.Text+'%'') and (a.proses like '''+Edit5.Text+'%'') and (a.no_seri_beam like '''+Edit2.Text+'%''))');
        QAmbilData2.Execute;
        QDetail.Close;
        QDetail.SetVariable('myorder',' order by proses, grup');
        QDetail.Open;
