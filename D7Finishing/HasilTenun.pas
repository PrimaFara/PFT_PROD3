...
type
  THasilTenunFrm = class(TForm)
    ...
    QDetailLL: TIntegerField;
    QDetailLP: TIntegerField;
    QDetailLR: TIntegerField;
    QDetailWL: TIntegerField;
    QDetailCB: TIntegerField;
    QDetailCK: TIntegerField;
    QDetailCRT: TIntegerField;
    QDetailPD: TIntegerField;
    QDetailPL: TIntegerField;
    QDetailPP: TIntegerField;
    QDetailPS: TIntegerField;
    QDetailNG: TIntegerField;
    QDetailWP: TIntegerField;
    QDetailSC: TIntegerField;
    QDetailKS: TIntegerField;
    QDetailKP: TIntegerField;
    QDetailBO: TIntegerField;
    QDetailLN: TIntegerField;
    ...
    BitBtn1: TBitBtn;
    QHapus: TOracleQuery;
    QDetailUTB: TIntegerField;
    QDetailUTK: TIntegerField;
    QDetailLBK: TIntegerField;
    QDetailSLL: TIntegerField;
    QDetailTG: TIntegerField;
    QDetailTCS: TIntegerField;
    Edit6: TEdit;
    Label15: TLabel;
    Label16: TLabel;
