...
begin
  ...
  try
    ...
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalAWAL_BK) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalAWAL_BS) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalDLM_BK) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalDLM_BS) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalLAIN_BK) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalLAIN_BS) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalKORIN_BK) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalKORIN_BS) + '</b></td>' +

    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalFINISH_BK) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalFINISH_BS) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalMTR_BK) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalMTR_BS) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalKOROUT_BK) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalKOROUT_BS) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalAKHIR_BK) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalAKHIR_BS) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalAKHIR_BK1) + '</b></td>' +
    '                    <td style="border: 1px solid black; text-align: right;"><b>' + FormatFloat('###,##0.##;(###,##0.##);-', TotalAKHIR_BS1) + '</b></td>' +
