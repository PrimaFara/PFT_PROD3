...
type
  TTerimaDariFinishing4Frm = class(TForm)
    PanelLeft: TPanel;
...
var
  ...
  TerimaDariFinishing4Frm: TTerimaDariFinishing4Frm;
...
procedure TTerimaDariFinishing4Frm.FormClose(Sender: TObject;
...
procedure TTerimaDariFinishing4Frm.baca_tab(SheetIndex:integer);
Var
...
//B2 start
procedure TTerimaDariFinishing4Frm.baca_tab2(SheetIndex:integer);
Var
  Xlapp1, Sheet:Variant ;
  i, MaxRow, MaxCol,X, Y:integer ;
  dtTmp,str:string;
...
//start lelang
procedure TTerimaDariFinishing4Frm.baca_tab3(SheetIndex:integer);
Var
  Xlapp1, Sheet:Variant ;
  i, MaxRow, MaxCol,X, Y:integer ;
  dtTmp,str:string;
...
procedure TTerimaDariFinishing4Frm.FormResize(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TTerimaDariFinishing4Frm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','R01');
 QTransaksi.Open;
...
procedure TTerimaDariFinishing4Frm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TTerimaDariFinishing4Frm.LookRekananEnter(Sender: TObject);
begin
 DMFrm.QRekanan.Open;
end;

procedure TTerimaDariFinishing4Frm.LookRekananClick(Sender: TObject);
begin
   DMFrm.QRekanan.Close;
   DMFrm.QRekanan.Open;
end;

procedure TTerimaDariFinishing4Frm.QMasterBeforePost(DataSet: TDataSet);
begin
  if (QMasterISPOST.AsString='1') and (QMasterNO_NOTA.AsString='') then
  begin
      FNo_Urut.Close;
      FNo_Urut.SetVariable('pkode','R01');
...
procedure TTerimaDariFinishing4Frm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TTerimaDariFinishing4Frm.LookKonstruksiEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi.Open;
end;

procedure TTerimaDariFinishing4Frm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TTerimaDariFinishing4Frm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TTerimaDariFinishing4Frm.LookCorakCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  If modified then
...
procedure TTerimaDariFinishing4Frm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TTerimaDariFinishing4Frm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TTerimaDariFinishing4Frm.QDetailNewRecord(DataSet: TDataSet);
begin
  DMFrm.QUserTime.Open;
...
procedure TTerimaDariFinishing4Frm.BitBtn2Click(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.ColumnHeaderBand1BeforePrint(
...
procedure TTerimaDariFinishing4Frm.FNo_UrutBeforeQuery(
...
procedure TTerimaDariFinishing4Frm.QMasterBeforeQuery(
  Sender: TOracleDataSet);
begin
...
procedure TTerimaDariFinishing4Frm.QTotalBeforeOpen(DataSet: TDataSet);
begin
  QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
end;

procedure TTerimaDariFinishing4Frm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TTerimaDariFinishing4Frm.BitBtn4Click(Sender: TObject);
begin
  wwDBGrid1Enter(nil);
...
procedure TTerimaDariFinishing4Frm.BitBtn3Click(Sender: TObject);
begin
  if QMasterISPOST.AsString='1' then
...
procedure TTerimaDariFinishing4Frm.look_opEnter(Sender: TObject);
begin
DMFrm.QOp_Inspect.Open;
end;

procedure TTerimaDariFinishing4Frm.FormShow(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
...
procedure TTerimaDariFinishing4Frm.BtnExportClick(Sender: TObject);
begin
 if QBrowse.Active then
          begin
...
procedure TTerimaDariFinishing4Frm.vOperandClick(Sender: TObject);
begin
  if vOperand.Caption='LIKE' then
    vOperand.Caption:='='
    else
...
procedure TTerimaDariFinishing4Frm.cbTanggalClick(Sender: TObject);
begin
  if cbTanggal.Checked then
  begin
...
procedure TTerimaDariFinishing4Frm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.VTglAwalChange(Sender: TObject);
begin
vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TTerimaDariFinishing4Frm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TTerimaDariFinishing4Frm.QBrowseAfterScroll(DataSet: TDataSet);
begin
 LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TTerimaDariFinishing4Frm.TabSheet2Show(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.TabSheet1Show(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.VTglAwal3Change(Sender: TObject);
begin
vTglAkhir3.Date:=(VTglAwal3.Date);
end;

procedure TTerimaDariFinishing4Frm.vTglAkhir3Change(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.BitBtn7Click(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.BtnExport3Click(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.VTglAwal5Change(Sender: TObject);
begin
VTglAkhir5.Date:=(VTglAwal5.Date);
end;

procedure TTerimaDariFinishing4Frm.VTglAkhir5Change(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.BitBtn9Click(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.BitBtn10Click(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.wwDBComboBox1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TTerimaDariFinishing4Frm.wwDBComboBox1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TTerimaDariFinishing4Frm.wwDBNavigator2ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TTerimaDariFinishing4Frm.wwDBNavigator2DeleteClick(
  Sender: TObject);
Var
Reg:String;
begin
...
procedure TTerimaDariFinishing4Frm.wwDBNavigator2InsertClick(
  Sender: TObject);
begin
ListView1.Clear;
ListView2.Clear;
...
procedure TTerimaDariFinishing4Frm.Look_KPClick(Sender: TObject);
begin
...
procedure TTerimaDariFinishing4Frm.Look_KPCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 if modified then
...
procedure TTerimaDariFinishing4Frm.Look_KPEnter(Sender: TObject);
begin
  DMFrm.QKP_Hasil_Inspect.Open;
  DMFrm.QKonstruksi_finish.Open;
  DMFrm.QKonstruksi_Kp.Open;
...
procedure TTerimaDariFinishing4Frm.Button1Click(Sender: TObject);
var i : integer;
begin
...
procedure TTerimaDariFinishing4Frm.Button3Click(Sender: TObject);
var i : integer;
begin
...
procedure TTerimaDariFinishing4Frm.Button6Click(Sender: TObject);
var i : integer;
begin
...
//TEMPLATE B1 START
procedure TTerimaDariFinishing4Frm.Button2Click(Sender: TObject);
var
...
begin
  ...
  try
    ...
    SaveDialog.FileName := 'TEMPLATE_RE-INSPECTING_PRINTING_B1.xls';
    ...
    begin
      ...
      try
        ...
        ExcelTemplateURL := 'http:\\192.168.1.226\Template\TEMPLATE_RE-INSPECTING_PRINTING_B1.xls';
...
// TEMPLATE B2 START
procedure TTerimaDariFinishing4Frm.Button4Click(Sender: TObject);
var
  ExcelTemplateURL: string;
  LocalFilePath: string;
  FileStream: TFileStream;
...
begin
  ...
  try
    ...
    SaveDialog.DefaultExt := 'xls';
    SaveDialog.Filter := 'File Excel (*.xls)|*.xls|Semua File (*.*)|*.*';
    SaveDialog.FileName := 'TEMPLATE_RE-INSPECTING_PRINTING_B2.xls';
    ...
    begin
      ...
      try
        // URL tempat file template Excel disimpan
        ExcelTemplateURL := 'http:\\192.168.1.226\Template\TEMPLATE_RE-INSPECTING_PRINTING_B2.xls';
...
procedure TTerimaDariFinishing4Frm.Button5Click(Sender: TObject);
var
  ExcelTemplateURL: string;
  LocalFilePath: string;
  FileStream: TFileStream;
...
begin
  ...
  try
    ...
    SaveDialog.DefaultExt := 'xls';
    SaveDialog.Filter := 'File Excel (*.xls)|*.xls|Semua File (*.*)|*.*';
    SaveDialog.FileName := 'TEMPLATE_RE-INSPECTING_PRINTING_LELANG.xls';
    ...
    begin
      ...
      try
        // URL tempat file template Excel disimpan
        ExcelTemplateURL := 'http:\\192.168.1.226\Template\TEMPLATE_RE-INSPECTING_PRINTING_LELANG.xls';
...
procedure TTerimaDariFinishing4Frm.wwDBNavigator2CancelClick(
  Sender: TObject);
Var
Reg:String;
begin
...
procedure TTerimaDariFinishing4Frm.TabSheet5Show(Sender: TObject);
begin
  //QMaster.Close;
  //QMaster.SetVariable('no_reg',QBrowseNO_REG.AsInteger);
...
procedure TTerimaDariFinishing4Frm.wwDBNavigator2PostClick(
  Sender: TObject);
var
  i: Integer;
  Reg: Integer;
  Item1, Item2, Item3: TListItem;
  KPROD, CORAK, KONS, WEAVING, RUANG, KODE, PROSES, REKANAN: string;
  PROD, BK, P_BK, B1, P_B1, LD, LT, LPT, LRG, WL, FLO, NEPS, PP, WP, OJ, CRT, BTS, BTB, SC, SLL,TK,KTR,PDK,KP,MC,BOSK,KS,BO,FC,HK,WM,WK,M_SAMAR,M_RUSAK,M_BELANG,M_OUIT,E_STEAMER,E_PRINT,E_STAMPING:Real;
  B2, P_B2, LD2, LT2, LPT2, LRG2, WL2, FLO2, NEPS2, PP2, WP2, OJ2, CRT2, BTS2, BTB2, SC2, SLL2,TK2,KTR2,PDK2,KP2,MC2,BOSK2,KS2,BO2,FC2,HK2,WM2,WK2,M_SAMAR2,M_RUSAK2,M_BELANG2,M_OUIT2,E_STEAMER2,E_PRINT2,E_STAMPING2:Real;
  LELANG, P_LELANG, BSPARAH, P_BSPARAH, SBK,KTS,KNB, LELANG2: Real;
...
begin
  ...
  begin
    ...
    TK := StrToFloatDef(Item1.SubItems[28], 0);
    KTR := StrToFloatDef(Item1.SubItems[29], 0);
    PDK := StrToFloatDef(Item1.SubItems[30], 0);
    KP := StrToFloatDef(Item1.SubItems[31], 0);
    MC := StrToFloatDef(Item1.SubItems[32], 0);
    BOSK := StrToFloatDef(Item1.SubItems[33], 0);
    KS := StrToFloatDef(Item1.SubItems[34], 0);
    BO := StrToFloatDef(Item1.SubItems[35], 0);
    FC := StrToFloatDef(Item1.SubItems[36], 0);
    HK := StrToFloatDef(Item1.SubItems[37], 0);
    WM := StrToFloatDef(Item1.SubItems[38], 0);
    WK := StrToFloatDef(Item1.SubItems[39], 0);
    M_SAMAR := StrToFloatDef(Item1.SubItems[40], 0);
    M_RUSAK := StrToFloatDef(Item1.SubItems[41], 0);
    M_BELANG := StrToFloatDef(Item1.SubItems[42], 0);
    M_OUIT := StrToFloatDef(Item1.SubItems[43], 0);
    E_STEAMER := StrToFloatDef(Item1.SubItems[44], 0);
    E_PRINT := StrToFloatDef(Item1.SubItems[45], 0);
    E_STAMPING := StrToFloatDef(Item1.SubItems[46], 0);
    ...
    TK2 := StrToFloatDef(Item2.SubItems[23], 0);
    KTR2 := StrToFloatDef(Item2.SubItems[24], 0);
    PDK2 := StrToFloatDef(Item2.SubItems[25], 0);
    KP2 := StrToFloatDef(Item2.SubItems[26], 0);
    MC2 := StrToFloatDef(Item2.SubItems[27], 0);
    BOSK2 := StrToFloatDef(Item2.SubItems[28], 0);
    KS2 := StrToFloatDef(Item2.SubItems[29], 0);
    BO2 := StrToFloatDef(Item2.SubItems[30], 0);
    FC2 := StrToFloatDef(Item2.SubItems[31], 0);
    HK2 := StrToFloatDef(Item2.SubItems[32], 0);
    WM2 := StrToFloatDef(Item2.SubItems[33], 0);
    WK2 := StrToFloatDef(Item2.SubItems[34], 0);
    M_SAMAR2 := StrToFloatDef(Item2.SubItems[35], 0);
    M_RUSAK2 := StrToFloatDef(Item2.SubItems[36], 0);
    M_BELANG2 := StrToFloatDef(Item2.SubItems[37], 0);
    M_OUIT2 := StrToFloatDef(Item2.SubItems[38], 0);
    E_STEAMER2 := StrToFloatDef(Item2.SubItems[39], 0);
    E_PRINT2 := StrToFloatDef(Item2.SubItems[40], 0);
    E_STAMPING2 := StrToFloatDef(Item2.SubItems[41], 0);
    ...
    KTS := StrToFloatDef(Item3.SubItems[11], 0);
    ...
    QInsertDetail.SetVariable('E_STEAMER',E_STEAMER);
    QInsertDetail.SetVariable('E_PRINT',E_PRINT);
    QInsertDetail.SetVariable('E_STAMPING',E_STAMPING);
    ...
    QInsertDetail.SetVariable('TK2', TK2);
    ...
    QInsertDetail.SetVariable('WK2', WK2);
    QInsertDetail.SetVariable('M_SAMAR2', M_SAMAR2);
    QInsertDetail.SetVariable('M_RUSAK2', M_RUSAK2);
    QInsertDetail.SetVariable('M_BELANG2', M_BELANG2);
    QInsertDetail.SetVariable('M_OUIT2', M_OUIT2);
    QInsertDetail.SetVariable('E_STEAMER2', E_STEAMER2);
    QInsertDetail.SetVariable('E_PRINT2', E_PRINT2);
    QInsertDetail.SetVariable('E_STAMPING2', E_STAMPING2);
    ...
    QInsertDetail.SetVariable('KTS',KTS);
...
procedure TTerimaDariFinishing4Frm.wwCheckBox2Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;
