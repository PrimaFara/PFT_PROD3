...
QBrowse4.Open;
 ...
 // wwDBGrid1xxxxx.ColumnByName('GULUNG').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowse4TotalGULUNG.AsFloat);
  ...
  wwDBGrid4.ColumnByName('M_BELANG2').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowseTotalM_BELANG2.AsFloat);
  wwDBGrid4.ColumnByName('M_RUSAK2').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowseTotalM_RUSAK2.AsFloat);
