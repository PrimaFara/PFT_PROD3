...
type
  TDefectReinspectFrm = class(TForm)
    ...
    QTotalHARGA: TFloatField;
    QTotalQTY_LALU: TFloatField;
    QTotalQTY_ORG: TFloatField;
    QTotalQTY3: TFloatField;
    QTotalBGRADE: TFloatField;
    QTotalLD: TFloatField;
    QTotalLT: TFloatField;
    QTotalLPT: TFloatField;
    QTotalLRG: TFloatField;
    QTotalWL: TFloatField;
    QTotalFLO: TFloatField;
    QTotalNEPS: TFloatField;
    QTotalPP: TFloatField;
    QTotalWP: TFloatField;
    QTotalOJ: TFloatField;
    QTotalCRT: TFloatField;
    QTotalBTS: TFloatField;
    QTotalBTB: TFloatField;
    QTotalSC: TFloatField;
    QTotalSLL: TFloatField;
    QTotalCK: TFloatField;
    QTotalCAJ: TFloatField;
    QTotalKTR: TFloatField;
    QTotalPDK: TFloatField;
    QTotalKP: TFloatField;
    QTotalMC: TFloatField;
    QTotalBOSK: TFloatField;
    QTotalKS: TFloatField;
    QTotalBO: TFloatField;
    QTotalFC: TFloatField;
    QTotalHK: TFloatField;
    QTotalWM: TFloatField;
    QTotalSBK: TFloatField;
    QTotalUTS: TFloatField;
    QTotalKNB: TFloatField;
    QTotalPROD: TFloatField;
    QTotalBK: TFloatField;
    QTotalB1: TFloatField;
    QTotalB2: TFloatField;
    QTotalLELANG: TFloatField;
    QTotalBSPARAH: TFloatField;
    QTotalP_BK: TFloatField;
    QTotalP_B1: TFloatField;
    QTotalP_B2: TFloatField;
    QTotalP_LELANG: TFloatField;
    QTotalP_BSPARAH: TFloatField;
    QTotalTK: TFloatField;
    QTotalWK: TFloatField;
    QTotalM_SAMAR: TFloatField;
    QTotalM_RUSAK: TFloatField;
    QTotalM_BELANG: TFloatField;
    QTotalM_OUIT: TFloatField;
    QTotalE_STEAMER: TFloatField;
    QTotalE_PRINT: TFloatField;
    QTotalE_STAMPING: TFloatField;
    QTotalKTS: TFloatField;
    QTotalLD2: TFloatField;
    QTotalLT2: TFloatField;
    QTotalLPT2: TFloatField;
    QTotalLRG2: TFloatField;
    QTotalWL2: TFloatField;
    QTotalFLO2: TFloatField;
    QTotalNEPS2: TFloatField;
    QTotalPP2: TFloatField;
    QTotalWP2: TFloatField;
    QTotalOJ2: TFloatField;
    QTotalCRT2: TFloatField;
    QTotalBTS2: TFloatField;
    QTotalBTB2: TFloatField;
    QTotalSC2: TFloatField;
    QTotalSLL2: TFloatField;
    QTotalCK2: TFloatField;
    QTotalCAJ2: TFloatField;
    QTotalKTR2: TFloatField;
    QTotalPDK2: TFloatField;
    QTotalKP2: TFloatField;
    QTotalMC2: TFloatField;
    QTotalBOSK2: TFloatField;
    QTotalKS2: TFloatField;
    QTotalBO2: TFloatField;
    QTotalFC2: TFloatField;
    QTotalHK2: TFloatField;
    QTotalWM2: TFloatField;
    QTotalTK2: TFloatField;
    QTotalWK2: TFloatField;
    QTotalM_SAMAR2: TFloatField;
    QTotalM_RUSAK2: TFloatField;
    QTotalM_BELANG2: TFloatField;
    QTotalM_OUIT2: TFloatField;
    QTotalE_STEAMER2: TFloatField;
    QTotalE_PRINT2: TFloatField;
    QTotalE_STAMPING2: TFloatField;
    QTotalKTS2: TFloatField;
    QTotalLELANG2: TFloatField;
    QTotalAFL1: TFloatField;
    QTotalAFL2: TFloatField;
...
QBrowse.Open;
 ...
 // wwDBGrid1xxxxx.ColumnByName('GULUNG').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowseTotalGULUNG.AsFloat);
  ...
  wwDBGrid1xxxxx.ColumnByName('AFL_PJI').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowseTotalAFL_PJI.AsFloat);
end
else
begin
...
QBrowse4.Open;
 ...
 // wwDBGrid1xxxxx.ColumnByName('GULUNG').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowse4TotalGULUNG.AsFloat);
  ...
  wwDBGrid4.ColumnByName('AFL_PJI').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowse4TotalAFL_PJI.AsFloat);
...
begin
  ...
  QTotal.Open;
    ...
    wwDBGrid1.ColumnByName('HARGA').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHARGA.AsFloat);
    wwDBGrid1.ColumnByName('QTY_TERIMA').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_TERIMA.AsFloat);
    wwDBGrid1.ColumnByName('QTY_LALU').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_LALU.AsFloat);
    wwDBGrid1.ColumnByName('QTY_ORG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_ORG.AsFloat);
    ...
    wwDBGrid1.ColumnByName('LD').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLD.AsFloat);
    wwDBGrid1.ColumnByName('LT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLT.AsFloat);
    wwDBGrid1.ColumnByName('LPT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLPT.AsFloat);
    wwDBGrid1.ColumnByName('LRG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLRG.AsFloat);
    wwDBGrid1.ColumnByName('WL').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWL.AsFloat);
    wwDBGrid1.ColumnByName('FLO').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFLO.AsFloat);
    wwDBGrid1.ColumnByName('NEPS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalNEPS.AsFloat);
    wwDBGrid1.ColumnByName('PP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPP.AsFloat);
    wwDBGrid1.ColumnByName('WP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWP.AsFloat);
    wwDBGrid1.ColumnByName('OJ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalOJ.AsFloat);
    wwDBGrid1.ColumnByName('CRT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCRT.AsFloat);
    wwDBGrid1.ColumnByName('BTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTS.AsFloat);
    wwDBGrid1.ColumnByName('BTB').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTB.AsFloat);
    wwDBGrid1.ColumnByName('SC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSC.AsFloat);
    wwDBGrid1.ColumnByName('SLL').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSLL.AsFloat);
    wwDBGrid1.ColumnByName('CK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCK.AsFloat);
    wwDBGrid1.ColumnByName('CAJ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCAJ.AsFloat);
    wwDBGrid1.ColumnByName('KTR').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTR.AsFloat);
    wwDBGrid1.ColumnByName('PDK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPDK.AsFloat);
    wwDBGrid1.ColumnByName('KP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKP.AsFloat);
    wwDBGrid1.ColumnByName('MC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalMC.AsFloat);
    wwDBGrid1.ColumnByName('BOSK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBOSK.AsFloat);
    wwDBGrid1.ColumnByName('KS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKS.AsFloat);
    wwDBGrid1.ColumnByName('BO').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBO.AsFloat);
    wwDBGrid1.ColumnByName('FC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFC.AsFloat);
    wwDBGrid1.ColumnByName('HK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHK.AsFloat);
    wwDBGrid1.ColumnByName('WM').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWM.AsFloat);
    wwDBGrid1.ColumnByName('SBK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSBK.AsFloat);
    wwDBGrid1.ColumnByName('UTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalUTS.AsFloat);
    wwDBGrid1.ColumnByName('KNB').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKNB.AsFloat);
    wwDBGrid1.ColumnByName('PROD').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPROD.AsFloat);
    ...
    wwDBGrid1.ColumnByName('B2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalB2.AsFloat);
    wwDBGrid1.ColumnByName('LELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLELANG.AsFloat);
    wwDBGrid1.ColumnByName('BSPARAH').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBSPARAH.AsFloat);
    wwDBGrid1.ColumnByName('P_BK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_BK.AsFloat);
    wwDBGrid1.ColumnByName('P_B1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_B1.AsFloat);
    wwDBGrid1.ColumnByName('P_B2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_B2.AsFloat);
    wwDBGrid1.ColumnByName('P_LELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_LELANG.AsFloat);
    wwDBGrid1.ColumnByName('P_BSPARAH').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_BSPARAH.AsFloat);
    wwDBGrid1.ColumnByName('TK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalTK.AsFloat);
    wwDBGrid1.ColumnByName('WK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWK.AsFloat);
    ...
    wwDBGrid1.ColumnByName('M_OUIT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_OUIT.AsFloat);
    wwDBGrid1.ColumnByName('E_STEAMER').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STEAMER.AsFloat);
    wwDBGrid1.ColumnByName('E_PRINT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_PRINT.AsFloat);
    wwDBGrid1.ColumnByName('E_STAMPING').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STAMPING.AsFloat);
    wwDBGrid1.ColumnByName('KTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTS.AsFloat);
    wwDBGrid1.ColumnByName('LD2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLD2.AsFloat);
    wwDBGrid1.ColumnByName('LT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLT2.AsFloat);
    wwDBGrid1.ColumnByName('LPT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLPT2.AsFloat);
    wwDBGrid1.ColumnByName('LRG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLRG2.AsFloat);
    wwDBGrid1.ColumnByName('WL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWL2.AsFloat);
    wwDBGrid1.ColumnByName('FLO2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFLO2.AsFloat);
    wwDBGrid1.ColumnByName('NEPS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalNEPS2.AsFloat);
    wwDBGrid1.ColumnByName('PP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPP2.AsFloat);
    wwDBGrid1.ColumnByName('WP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWP2.AsFloat);
    wwDBGrid1.ColumnByName('OJ2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalOJ2.AsFloat);
    wwDBGrid1.ColumnByName('CRT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCRT2.AsFloat);
    wwDBGrid1.ColumnByName('BTS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTS2.AsFloat);
    wwDBGrid1.ColumnByName('BTB2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTB2.AsFloat);
    wwDBGrid1.ColumnByName('SC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSC2.AsFloat);
    wwDBGrid1.ColumnByName('SLL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSLL2.AsFloat);
    wwDBGrid1.ColumnByName('CK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCK2.AsFloat);
    wwDBGrid1.ColumnByName('CAJ2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCAJ2.AsFloat);
    wwDBGrid1.ColumnByName('KTR2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTR2.AsFloat);
    wwDBGrid1.ColumnByName('PDK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPDK2.AsFloat);
    wwDBGrid1.ColumnByName('KP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKP2.AsFloat);
    wwDBGrid1.ColumnByName('MC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalMC2.AsFloat);
    wwDBGrid1.ColumnByName('BOSK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBOSK2.AsFloat);
    wwDBGrid1.ColumnByName('KS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKS2.AsFloat);
    wwDBGrid1.ColumnByName('BO2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBO2.AsFloat);
    wwDBGrid1.ColumnByName('FC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFC2.AsFloat);
    wwDBGrid1.ColumnByName('HK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHK2.AsFloat);
    wwDBGrid1.ColumnByName('WM2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWM2.AsFloat);
    wwDBGrid1.ColumnByName('TK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalTK2.AsFloat);
    wwDBGrid1.ColumnByName('WK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWK2.AsFloat);
    wwDBGrid1.ColumnByName('M_SAMAR2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_SAMAR2.AsFloat);
    wwDBGrid1.ColumnByName('M_RUSAK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_RUSAK2.AsFloat);
    wwDBGrid1.ColumnByName('M_BELANG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_BELANG2.AsFloat);
    wwDBGrid1.ColumnByName('M_OUIT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_OUIT2.AsFloat);
    wwDBGrid1.ColumnByName('E_STEAMER2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STEAMER2.AsFloat);
    wwDBGrid1.ColumnByName('E_PRINT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_PRINT2.AsFloat);
    wwDBGrid1.ColumnByName('E_STAMPING2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STAMPING2.AsFloat);
    wwDBGrid1.ColumnByName('KTS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTS2.AsFloat);
    wwDBGrid1.ColumnByName('LELANG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLELANG2.AsFloat);
    wwDBGrid1.ColumnByName('AFL1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL1.AsFloat);
    wwDBGrid1.ColumnByName('AFL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL2.AsFloat);
...
begin
  ...
  QTotal.Open;
    ...
    wwDBGrid3.ColumnByName('QTY').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY.AsFloat);
    wwDBGrid3.ColumnByName('HARGA').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHARGA.AsFloat);
    wwDBGrid3.ColumnByName('QTY_TERIMA').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_TERIMA.AsFloat);
    wwDBGrid3.ColumnByName('QTY_LALU').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_LALU.AsFloat);
    wwDBGrid3.ColumnByName('QTY_ORG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_ORG.AsFloat);
    wwDBGrid3.ColumnByName('QTY2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY2.AsFloat);
    wwDBGrid3.ColumnByName('QTY3').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY3.AsFloat);
    wwDBGrid3.ColumnByName('BGRADE').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBGRADE.AsFloat);
    wwDBGrid3.ColumnByName('LD').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLD.AsFloat);
    wwDBGrid3.ColumnByName('LT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLT.AsFloat);
    wwDBGrid3.ColumnByName('LPT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLPT.AsFloat);
    wwDBGrid3.ColumnByName('LRG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLRG.AsFloat);
    wwDBGrid3.ColumnByName('WL').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWL.AsFloat);
    wwDBGrid3.ColumnByName('FLO').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFLO.AsFloat);
    wwDBGrid3.ColumnByName('NEPS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalNEPS.AsFloat);
    wwDBGrid3.ColumnByName('PP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPP.AsFloat);
    wwDBGrid3.ColumnByName('WP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWP.AsFloat);
    wwDBGrid3.ColumnByName('OJ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalOJ.AsFloat);
    wwDBGrid3.ColumnByName('CRT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCRT.AsFloat);
    wwDBGrid3.ColumnByName('BTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTS.AsFloat);
    wwDBGrid3.ColumnByName('BTB').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTB.AsFloat);
    wwDBGrid3.ColumnByName('SC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSC.AsFloat);
    wwDBGrid3.ColumnByName('SLL').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSLL.AsFloat);
    wwDBGrid3.ColumnByName('CK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCK.AsFloat);
    wwDBGrid3.ColumnByName('CAJ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCAJ.AsFloat);
    wwDBGrid3.ColumnByName('KTR').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTR.AsFloat);
    wwDBGrid3.ColumnByName('PDK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPDK.AsFloat);
    wwDBGrid3.ColumnByName('KP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKP.AsFloat);
    wwDBGrid3.ColumnByName('MC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalMC.AsFloat);
    wwDBGrid3.ColumnByName('BOSK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBOSK.AsFloat);
    wwDBGrid3.ColumnByName('KS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKS.AsFloat);
    wwDBGrid3.ColumnByName('BO').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBO.AsFloat);
    wwDBGrid3.ColumnByName('FC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFC.AsFloat);
    wwDBGrid3.ColumnByName('HK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHK.AsFloat);
    wwDBGrid3.ColumnByName('WM').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWM.AsFloat);
    wwDBGrid3.ColumnByName('SBK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSBK.AsFloat);
    wwDBGrid3.ColumnByName('UTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalUTS.AsFloat);
    wwDBGrid3.ColumnByName('KNB').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKNB.AsFloat);
    wwDBGrid3.ColumnByName('PROD').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPROD.AsFloat);
    wwDBGrid3.ColumnByName('BK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBK.AsFloat);
    wwDBGrid3.ColumnByName('B1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalB1.AsFloat);
    wwDBGrid3.ColumnByName('B2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalB2.AsFloat);
    wwDBGrid3.ColumnByName('LELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLELANG.AsFloat);
    wwDBGrid3.ColumnByName('BSPARAH').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBSPARAH.AsFloat);
    wwDBGrid3.ColumnByName('P_BK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_BK.AsFloat);
    wwDBGrid3.ColumnByName('P_B1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_B1.AsFloat);
    wwDBGrid3.ColumnByName('P_B2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_B2.AsFloat);
    wwDBGrid3.ColumnByName('P_LELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_LELANG.AsFloat);
    wwDBGrid3.ColumnByName('P_BSPARAH').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_BSPARAH.AsFloat);
    wwDBGrid3.ColumnByName('TK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalTK.AsFloat);
    wwDBGrid3.ColumnByName('WK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWK.AsFloat);
    wwDBGrid3.ColumnByName('M_SAMAR').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_SAMAR.AsFloat);
    wwDBGrid3.ColumnByName('M_RUSAK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_RUSAK.AsFloat);
    wwDBGrid3.ColumnByName('M_BELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_BELANG.AsFloat);
    wwDBGrid3.ColumnByName('M_OUIT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_OUIT.AsFloat);
    wwDBGrid3.ColumnByName('E_STEAMER').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STEAMER.AsFloat);
    wwDBGrid3.ColumnByName('E_PRINT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_PRINT.AsFloat);
    wwDBGrid3.ColumnByName('E_STAMPING').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STAMPING.AsFloat);
    wwDBGrid3.ColumnByName('KTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTS.AsFloat);
    wwDBGrid3.ColumnByName('LD2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLD2.AsFloat);
    wwDBGrid3.ColumnByName('LT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLT2.AsFloat);
    wwDBGrid3.ColumnByName('LPT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLPT2.AsFloat);
    wwDBGrid3.ColumnByName('LRG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLRG2.AsFloat);
    wwDBGrid3.ColumnByName('WL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWL2.AsFloat);
    wwDBGrid3.ColumnByName('FLO2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFLO2.AsFloat);
    wwDBGrid3.ColumnByName('NEPS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalNEPS2.AsFloat);
    wwDBGrid3.ColumnByName('PP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPP2.AsFloat);
    wwDBGrid3.ColumnByName('WP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWP2.AsFloat);
    wwDBGrid3.ColumnByName('OJ2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalOJ2.AsFloat);
    wwDBGrid3.ColumnByName('CRT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCRT2.AsFloat);
    wwDBGrid3.ColumnByName('BTS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTS2.AsFloat);
    wwDBGrid3.ColumnByName('BTB2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTB2.AsFloat);
    wwDBGrid3.ColumnByName('SC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSC2.AsFloat);
    wwDBGrid3.ColumnByName('SLL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSLL2.AsFloat);
    wwDBGrid3.ColumnByName('CK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCK2.AsFloat);
    wwDBGrid3.ColumnByName('CAJ2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCAJ2.AsFloat);
    wwDBGrid3.ColumnByName('KTR2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTR2.AsFloat);
    wwDBGrid3.ColumnByName('PDK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPDK2.AsFloat);
    wwDBGrid3.ColumnByName('KP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKP2.AsFloat);
    wwDBGrid3.ColumnByName('MC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalMC2.AsFloat);
    wwDBGrid3.ColumnByName('BOSK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBOSK2.AsFloat);
    wwDBGrid3.ColumnByName('KS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKS2.AsFloat);
    wwDBGrid3.ColumnByName('BO2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBO2.AsFloat);
    wwDBGrid3.ColumnByName('FC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFC2.AsFloat);
    wwDBGrid3.ColumnByName('HK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHK2.AsFloat);
    wwDBGrid3.ColumnByName('WM2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWM2.AsFloat);
    wwDBGrid3.ColumnByName('TK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalTK2.AsFloat);
    wwDBGrid3.ColumnByName('WK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWK2.AsFloat);
    wwDBGrid3.ColumnByName('M_SAMAR2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_SAMAR2.AsFloat);
    wwDBGrid3.ColumnByName('M_RUSAK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_RUSAK2.AsFloat);
    wwDBGrid3.ColumnByName('M_BELANG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_BELANG2.AsFloat);
    wwDBGrid3.ColumnByName('M_OUIT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_OUIT2.AsFloat);
    wwDBGrid3.ColumnByName('E_STEAMER2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STEAMER2.AsFloat);
    wwDBGrid3.ColumnByName('E_PRINT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_PRINT2.AsFloat);
    wwDBGrid3.ColumnByName('E_STAMPING2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STAMPING2.AsFloat);
    wwDBGrid3.ColumnByName('KTS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTS2.AsFloat);
    wwDBGrid3.ColumnByName('LELANG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLELANG2.AsFloat);
    wwDBGrid3.ColumnByName('AFL1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL1.AsFloat);
    wwDBGrid3.ColumnByName('AFL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL2.AsFloat);
    wwDBGrid3.ColumnByName('AFL_PJI').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL_PJI.AsFloat);
...
procedure TDefectReinspectFrm.wwDBGrid6UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
  QTotal.Open;

    wwDBGrid6.ColumnByName('QTY').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY.AsFloat);
    wwDBGrid6.ColumnByName('HARGA').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHARGA.AsFloat);
    wwDBGrid6.ColumnByName('QTY_TERIMA').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_TERIMA.AsFloat);
    wwDBGrid6.ColumnByName('QTY_LALU').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_LALU.AsFloat);
    wwDBGrid6.ColumnByName('QTY_ORG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_ORG.AsFloat);
    wwDBGrid6.ColumnByName('QTY2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY2.AsFloat);
    wwDBGrid6.ColumnByName('QTY3').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY3.AsFloat);
    wwDBGrid6.ColumnByName('BGRADE').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBGRADE.AsFloat);
    wwDBGrid6.ColumnByName('LD').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLD.AsFloat);
    wwDBGrid6.ColumnByName('LT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLT.AsFloat);
    wwDBGrid6.ColumnByName('LPT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLPT.AsFloat);
    wwDBGrid6.ColumnByName('LRG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLRG.AsFloat);
    wwDBGrid6.ColumnByName('WL').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWL.AsFloat);
    wwDBGrid6.ColumnByName('FLO').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFLO.AsFloat);
    wwDBGrid6.ColumnByName('NEPS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalNEPS.AsFloat);
    wwDBGrid6.ColumnByName('PP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPP.AsFloat);
    wwDBGrid6.ColumnByName('WP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWP.AsFloat);
    wwDBGrid6.ColumnByName('OJ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalOJ.AsFloat);
    wwDBGrid6.ColumnByName('CRT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCRT.AsFloat);
    wwDBGrid6.ColumnByName('BTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTS.AsFloat);
    wwDBGrid6.ColumnByName('BTB').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTB.AsFloat);
    wwDBGrid6.ColumnByName('SC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSC.AsFloat);
    wwDBGrid6.ColumnByName('SLL').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSLL.AsFloat);
    wwDBGrid6.ColumnByName('CK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCK.AsFloat);
    wwDBGrid6.ColumnByName('CAJ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCAJ.AsFloat);
    wwDBGrid6.ColumnByName('KTR').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTR.AsFloat);
    wwDBGrid6.ColumnByName('PDK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPDK.AsFloat);
    wwDBGrid6.ColumnByName('KP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKP.AsFloat);
    wwDBGrid6.ColumnByName('MC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalMC.AsFloat);
    wwDBGrid6.ColumnByName('BOSK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBOSK.AsFloat);
    wwDBGrid6.ColumnByName('KS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKS.AsFloat);
    wwDBGrid6.ColumnByName('BO').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBO.AsFloat);
    wwDBGrid6.ColumnByName('FC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFC.AsFloat);
    wwDBGrid6.ColumnByName('HK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHK.AsFloat);
    wwDBGrid6.ColumnByName('WM').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWM.AsFloat);
    wwDBGrid6.ColumnByName('SBK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSBK.AsFloat);
    wwDBGrid6.ColumnByName('UTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalUTS.AsFloat);
    wwDBGrid6.ColumnByName('KNB').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKNB.AsFloat);
    wwDBGrid6.ColumnByName('PROD').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPROD.AsFloat);
    wwDBGrid6.ColumnByName('BK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBK.AsFloat);
    wwDBGrid6.ColumnByName('B1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalB1.AsFloat);
    wwDBGrid6.ColumnByName('B2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalB2.AsFloat);
    wwDBGrid6.ColumnByName('LELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLELANG.AsFloat);
    wwDBGrid6.ColumnByName('BSPARAH').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBSPARAH.AsFloat);
    wwDBGrid6.ColumnByName('P_BK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_BK.AsFloat);
    wwDBGrid6.ColumnByName('P_B1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_B1.AsFloat);
    wwDBGrid6.ColumnByName('P_B2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_B2.AsFloat);
    wwDBGrid6.ColumnByName('P_LELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_LELANG.AsFloat);
    wwDBGrid6.ColumnByName('P_BSPARAH').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_BSPARAH.AsFloat);
    wwDBGrid6.ColumnByName('TK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalTK.AsFloat);
    wwDBGrid6.ColumnByName('WK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWK.AsFloat);
    wwDBGrid6.ColumnByName('M_SAMAR').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_SAMAR.AsFloat);
    wwDBGrid6.ColumnByName('M_RUSAK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_RUSAK.AsFloat);
    wwDBGrid6.ColumnByName('M_BELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_BELANG.AsFloat);
    wwDBGrid6.ColumnByName('M_OUIT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_OUIT.AsFloat);
    wwDBGrid6.ColumnByName('E_STEAMER').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STEAMER.AsFloat);
    wwDBGrid6.ColumnByName('E_PRINT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_PRINT.AsFloat);
    wwDBGrid6.ColumnByName('E_STAMPING').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STAMPING.AsFloat);
    wwDBGrid6.ColumnByName('KTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTS.AsFloat);
    wwDBGrid6.ColumnByName('LD2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLD2.AsFloat);
    wwDBGrid6.ColumnByName('LT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLT2.AsFloat);
    wwDBGrid6.ColumnByName('LPT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLPT2.AsFloat);
    wwDBGrid6.ColumnByName('LRG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLRG2.AsFloat);
    wwDBGrid6.ColumnByName('WL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWL2.AsFloat);
    wwDBGrid6.ColumnByName('FLO2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFLO2.AsFloat);
    wwDBGrid6.ColumnByName('NEPS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalNEPS2.AsFloat);
    wwDBGrid6.ColumnByName('PP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPP2.AsFloat);
    wwDBGrid6.ColumnByName('WP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWP2.AsFloat);
    wwDBGrid6.ColumnByName('OJ2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalOJ2.AsFloat);
    wwDBGrid6.ColumnByName('CRT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCRT2.AsFloat);
    wwDBGrid6.ColumnByName('BTS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTS2.AsFloat);
    wwDBGrid6.ColumnByName('BTB2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTB2.AsFloat);
    wwDBGrid6.ColumnByName('SC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSC2.AsFloat);
    wwDBGrid6.ColumnByName('SLL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSLL2.AsFloat);
    wwDBGrid6.ColumnByName('CK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCK2.AsFloat);
    wwDBGrid6.ColumnByName('CAJ2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCAJ2.AsFloat);
    wwDBGrid6.ColumnByName('KTR2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTR2.AsFloat);
    wwDBGrid6.ColumnByName('PDK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPDK2.AsFloat);
    wwDBGrid6.ColumnByName('KP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKP2.AsFloat);
    wwDBGrid6.ColumnByName('MC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalMC2.AsFloat);
    wwDBGrid6.ColumnByName('BOSK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBOSK2.AsFloat);
    wwDBGrid6.ColumnByName('KS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKS2.AsFloat);
    wwDBGrid6.ColumnByName('BO2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBO2.AsFloat);
    wwDBGrid6.ColumnByName('FC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFC2.AsFloat);
    wwDBGrid6.ColumnByName('HK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHK2.AsFloat);
    wwDBGrid6.ColumnByName('WM2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWM2.AsFloat);
    wwDBGrid6.ColumnByName('TK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalTK2.AsFloat);
    wwDBGrid6.ColumnByName('WK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWK2.AsFloat);
    wwDBGrid6.ColumnByName('M_SAMAR2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_SAMAR2.AsFloat);
    wwDBGrid6.ColumnByName('M_RUSAK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_RUSAK2.AsFloat);
    wwDBGrid6.ColumnByName('M_BELANG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_BELANG2.AsFloat);
    wwDBGrid6.ColumnByName('M_OUIT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_OUIT2.AsFloat);
    wwDBGrid6.ColumnByName('E_STEAMER2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STEAMER2.AsFloat);
    wwDBGrid6.ColumnByName('E_PRINT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_PRINT2.AsFloat);
    wwDBGrid6.ColumnByName('E_STAMPING2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STAMPING2.AsFloat);
    wwDBGrid6.ColumnByName('KTS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTS2.AsFloat);
    wwDBGrid6.ColumnByName('LELANG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLELANG2.AsFloat);
    wwDBGrid6.ColumnByName('AFL1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL1.AsFloat);
    wwDBGrid6.ColumnByName('AFL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL2.AsFloat);
    wwDBGrid6.ColumnByName('AFL_PJI').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL_PJI.AsFloat);

end;

procedure TDefectReinspectFrm.wwDBGrid7UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
  QTotal.Open;

    wwDBGrid7.ColumnByName('QTY').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY.AsFloat);
    wwDBGrid7.ColumnByName('HARGA').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHARGA.AsFloat);
    wwDBGrid7.ColumnByName('QTY_TERIMA').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_TERIMA.AsFloat);
    wwDBGrid7.ColumnByName('QTY_LALU').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_LALU.AsFloat);
    wwDBGrid7.ColumnByName('QTY_ORG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY_ORG.AsFloat);
    wwDBGrid7.ColumnByName('QTY2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY2.AsFloat);
    wwDBGrid7.ColumnByName('QTY3').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalQTY3.AsFloat);
    wwDBGrid7.ColumnByName('BGRADE').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBGRADE.AsFloat);
    wwDBGrid7.ColumnByName('LD').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLD.AsFloat);
    wwDBGrid7.ColumnByName('LT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLT.AsFloat);
    wwDBGrid7.ColumnByName('LPT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLPT.AsFloat);
    wwDBGrid7.ColumnByName('LRG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLRG.AsFloat);
    wwDBGrid7.ColumnByName('WL').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWL.AsFloat);
    wwDBGrid7.ColumnByName('FLO').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFLO.AsFloat);
    wwDBGrid7.ColumnByName('NEPS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalNEPS.AsFloat);
    wwDBGrid7.ColumnByName('PP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPP.AsFloat);
    wwDBGrid7.ColumnByName('WP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWP.AsFloat);
    wwDBGrid7.ColumnByName('OJ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalOJ.AsFloat);
    wwDBGrid7.ColumnByName('CRT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCRT.AsFloat);
    wwDBGrid7.ColumnByName('BTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTS.AsFloat);
    wwDBGrid7.ColumnByName('BTB').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTB.AsFloat);
    wwDBGrid7.ColumnByName('SC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSC.AsFloat);
    wwDBGrid7.ColumnByName('SLL').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSLL.AsFloat);
    wwDBGrid7.ColumnByName('CK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCK.AsFloat);
    wwDBGrid7.ColumnByName('CAJ').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCAJ.AsFloat);
    wwDBGrid7.ColumnByName('KTR').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTR.AsFloat);
    wwDBGrid7.ColumnByName('PDK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPDK.AsFloat);
    wwDBGrid7.ColumnByName('KP').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKP.AsFloat);
    wwDBGrid7.ColumnByName('MC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalMC.AsFloat);
    wwDBGrid7.ColumnByName('BOSK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBOSK.AsFloat);
    wwDBGrid7.ColumnByName('KS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKS.AsFloat);
    wwDBGrid7.ColumnByName('BO').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBO.AsFloat);
    wwDBGrid7.ColumnByName('FC').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFC.AsFloat);
    wwDBGrid7.ColumnByName('HK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHK.AsFloat);
    wwDBGrid7.ColumnByName('WM').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWM.AsFloat);
    wwDBGrid7.ColumnByName('SBK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSBK.AsFloat);
    wwDBGrid7.ColumnByName('UTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalUTS.AsFloat);
    wwDBGrid7.ColumnByName('KNB').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKNB.AsFloat);
    wwDBGrid7.ColumnByName('PROD').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPROD.AsFloat);
    wwDBGrid7.ColumnByName('BK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBK.AsFloat);
    wwDBGrid7.ColumnByName('B1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalB1.AsFloat);
    wwDBGrid7.ColumnByName('B2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalB2.AsFloat);
    wwDBGrid7.ColumnByName('LELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLELANG.AsFloat);
    wwDBGrid7.ColumnByName('BSPARAH').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBSPARAH.AsFloat);
    wwDBGrid7.ColumnByName('P_BK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_BK.AsFloat);
    wwDBGrid7.ColumnByName('P_B1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_B1.AsFloat);
    wwDBGrid7.ColumnByName('P_B2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_B2.AsFloat);
    wwDBGrid7.ColumnByName('P_LELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_LELANG.AsFloat);
    wwDBGrid7.ColumnByName('P_BSPARAH').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalP_BSPARAH.AsFloat);
    wwDBGrid7.ColumnByName('TK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalTK.AsFloat);
    wwDBGrid7.ColumnByName('WK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWK.AsFloat);
    wwDBGrid7.ColumnByName('M_SAMAR').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_SAMAR.AsFloat);
    wwDBGrid7.ColumnByName('M_RUSAK').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_RUSAK.AsFloat);
    wwDBGrid7.ColumnByName('M_BELANG').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_BELANG.AsFloat);
    wwDBGrid7.ColumnByName('M_OUIT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_OUIT.AsFloat);
    wwDBGrid7.ColumnByName('E_STEAMER').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STEAMER.AsFloat);
    wwDBGrid7.ColumnByName('E_PRINT').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_PRINT.AsFloat);
    wwDBGrid7.ColumnByName('E_STAMPING').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STAMPING.AsFloat);
    wwDBGrid7.ColumnByName('KTS').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTS.AsFloat);
    wwDBGrid7.ColumnByName('LD2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLD2.AsFloat);
    wwDBGrid7.ColumnByName('LT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLT2.AsFloat);
    wwDBGrid7.ColumnByName('LPT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLPT2.AsFloat);
    wwDBGrid7.ColumnByName('LRG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLRG2.AsFloat);
    wwDBGrid7.ColumnByName('WL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWL2.AsFloat);
    wwDBGrid7.ColumnByName('FLO2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFLO2.AsFloat);
    wwDBGrid7.ColumnByName('NEPS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalNEPS2.AsFloat);
    wwDBGrid7.ColumnByName('PP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPP2.AsFloat);
    wwDBGrid7.ColumnByName('WP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWP2.AsFloat);
    wwDBGrid7.ColumnByName('OJ2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalOJ2.AsFloat);
    wwDBGrid7.ColumnByName('CRT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCRT2.AsFloat);
    wwDBGrid7.ColumnByName('BTS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTS2.AsFloat);
    wwDBGrid7.ColumnByName('BTB2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBTB2.AsFloat);
    wwDBGrid7.ColumnByName('SC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSC2.AsFloat);
    wwDBGrid7.ColumnByName('SLL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalSLL2.AsFloat);
    wwDBGrid7.ColumnByName('CK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCK2.AsFloat);
    wwDBGrid7.ColumnByName('CAJ2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalCAJ2.AsFloat);
    wwDBGrid7.ColumnByName('KTR2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTR2.AsFloat);
    wwDBGrid7.ColumnByName('PDK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalPDK2.AsFloat);
    wwDBGrid7.ColumnByName('KP2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKP2.AsFloat);
    wwDBGrid7.ColumnByName('MC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalMC2.AsFloat);
    wwDBGrid7.ColumnByName('BOSK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBOSK2.AsFloat);
    wwDBGrid7.ColumnByName('KS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKS2.AsFloat);
    wwDBGrid7.ColumnByName('BO2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalBO2.AsFloat);
    wwDBGrid7.ColumnByName('FC2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalFC2.AsFloat);
    wwDBGrid7.ColumnByName('HK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalHK2.AsFloat);
    wwDBGrid7.ColumnByName('WM2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWM2.AsFloat);
    wwDBGrid7.ColumnByName('TK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalTK2.AsFloat);
    wwDBGrid7.ColumnByName('WK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalWK2.AsFloat);
    wwDBGrid7.ColumnByName('M_SAMAR2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_SAMAR2.AsFloat);
    wwDBGrid7.ColumnByName('M_RUSAK2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_RUSAK2.AsFloat);
    wwDBGrid7.ColumnByName('M_BELANG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_BELANG2.AsFloat);
    wwDBGrid7.ColumnByName('M_OUIT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalM_OUIT2.AsFloat);
    wwDBGrid7.ColumnByName('E_STEAMER2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STEAMER2.AsFloat);
    wwDBGrid7.ColumnByName('E_PRINT2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_PRINT2.AsFloat);
    wwDBGrid7.ColumnByName('E_STAMPING2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalE_STAMPING2.AsFloat);
    wwDBGrid7.ColumnByName('KTS2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalKTS2.AsFloat);
    wwDBGrid7.ColumnByName('LELANG2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalLELANG2.AsFloat);
    wwDBGrid7.ColumnByName('AFL1').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL1.AsFloat);
    wwDBGrid7.ColumnByName('AFL2').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL2.AsFloat);
    wwDBGrid7.ColumnByName('AFL_PJI').FooterValue := FormatFloat('0.0,0;(0.0,0);-', QTotalAFL_PJI.AsFloat);
end;
