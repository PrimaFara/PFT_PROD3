...
type
  TSerahExCWKeFinishingFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelCenter: TPanel;
    PanelHeader: TPanel;
...
var
SerahExCWKeFinishingFrm: TSerahExCWKeFinishingFrm;
...
procedure TSerahExCWKeFinishingFrm.FormClose(Sender: TObject;
...
procedure TSerahExCWKeFinishingFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.wwDBGrid1Enter(Sender: TObject);
begin
 If QMaster.State<> dsBrowse then QMaster.Post;
 QDetail.Open;
end;

procedure TSerahExCWKeFinishingFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','996');
 QTransaksi.Open;
...
procedure TSerahExCWKeFinishingFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TSerahExCWKeFinishingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TSerahExCWKeFinishingFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahExCWKeFinishingFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahExCWKeFinishingFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahExCWKeFinishingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TSerahExCWKeFinishingFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahExCWKeFinishingFrm.FNo_UrutBeforeQuery(
...
procedure TSerahExCWKeFinishingFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahExCWKeFinishingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahExCWKeFinishingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahExCWKeFinishingFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
QBrowse.Open;
  ...
  //    for i:=0 to QBrowse.FieldCount-1 do
    ...
    vfilter:=vfilter+') and kd_transaksi = ''996''';
...
procedure TSerahExCWKeFinishingFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahExCWKeFinishingFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahExCWKeFinishingFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TSerahExCWKeFinishingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahExCWKeFinishingFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahExCWKeFinishingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahExCWKeFinishingFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahExCWKeFinishingFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahExCWKeFinishingFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahExCWKeFinishingFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TSerahExCWKeFinishingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TSerahExCWKeFinishingFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahExCWKeFinishingFrm.BitBtn4Click(Sender: TObject);
begin
   if QBrowse.Active then
      begin
        DMFrm.QUserTime.Close;
...
procedure TSerahExCWKeFinishingFrm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
...
procedure TSerahExCWKeFinishingFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TSerahExCWKeFinishingFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QPerKonstruksi_M.Close;
  QPerKonstruksi_M.SetVariable('pawal',VTglAwal2.DateTime);
  QPerKonstruksi_M.SetVariable('pakhir',VTglakhir2.DateTime);
...
procedure TSerahExCWKeFinishingFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TSerahExCWKeFinishingFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.DBText1Click(Sender: TObject);
begin
 InputBox (' Copy Nomer','Klik Kanan --> Copy : ',QMasterNO_NOTA.AsString);
end;

procedure TSerahExCWKeFinishingFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     QRLabel8.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TSerahExCWKeFinishingFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TSerahExCWKeFinishingFrm.QPer_HariAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QPerKonstruksi_M.RecNo)+' dari '+FormatFloat('#,#',QPerKonstruksi_M.RecordCount)+' Records';
end;

procedure TSerahExCWKeFinishingFrm.look_mesinEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahExCWKeFinishingFrm.Look_CorakEnter(Sender: TObject);
Begin
DMFrm.QCorak.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookMsnTenunEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookMsnTenunClick(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookMsnTenunCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
    //QMasterCORAK.AsString:=DMFrm.QCorakNAMA_CORAK.AsString;
...
procedure TSerahExCWKeFinishingFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahExCWKeFinishingFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahExCWKeFinishingFrm.BitBtn7Click(Sender: TObject);
begin
  wwDBGrid1Enter(nil);
...
procedure TSerahExCWKeFinishingFrm.LookAmbilClick(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahExCWKeFinishingFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
Var
  vfilter : String;
begin
...
procedure TSerahExCWKeFinishingFrm.LookKdProdClick(Sender: TObject);
begin
//QKdProd.Open;
end;

procedure TSerahExCWKeFinishingFrm.LookKdProdCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahExCWKeFinishingFrm.LookKdProdEnter(Sender: TObject);
begin
QKdProd.Open;
end;

procedure TSerahExCWKeFinishingFrm.wwDBGrid1xxxxxUpdateFooter(
  Sender: TObject);
begin
...
procedure TSerahExCWKeFinishingFrm.wwDBLookupComboDlg2CloseUp(
  Sender: TObject; LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TSerahExCWKeFinishingFrm.wwDBLookupComboDlg2Enter(
  Sender: TObject);
begin
