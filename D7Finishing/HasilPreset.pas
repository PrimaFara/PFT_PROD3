...
var
  HasilPresetFrm: THasilPresetFrm;
...
procedure THasilPresetFrm.FormClose(Sender: TObject;
...
procedure THasilPresetFrm.FormResize(Sender: TObject);
begin
...
procedure THasilPresetFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure THasilPresetFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','902');
 QTransaksi.Open;
...
procedure THasilPresetFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure THasilPresetFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure THasilPresetFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure THasilPresetFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure THasilPresetFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure THasilPresetFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure THasilPresetFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure THasilPresetFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure THasilPresetFrm.ColumnHeaderBand1BeforePrint(
...
procedure THasilPresetFrm.FNo_UrutBeforeQuery(
...
procedure THasilPresetFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure THasilPresetFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure THasilPresetFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure THasilPresetFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure THasilPresetFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure THasilPresetFrm.vOperandClick(Sender: TObject);
begin
...
procedure THasilPresetFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure THasilPresetFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
QBrowse.Open;
  ...
  QBrowse.Close;
  QBrowse.SetVariable('kd_transaksi','902');
  QBrowse.SetVariable('myparam',vfilter+vorder);
  QBrowse.Open;
  QBrowseTotal.Close;
  QBrowseTotal.SetVariable('kd_transaksi','902');
...
procedure THasilPresetFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure THasilPresetFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure THasilPresetFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure THasilPresetFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure THasilPresetFrm.FormShow(Sender: TObject);
begin
...
procedure THasilPresetFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure THasilPresetFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure THasilPresetFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure THasilPresetFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure THasilPresetFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure THasilPresetFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure THasilPresetFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure THasilPresetFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure THasilPresetFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure THasilPresetFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure THasilPresetFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure THasilPresetFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
//QMasterKD_KONSTRUKSI.AsString:=DMFrm.QKonstruksiKD_KONSTRUKSI.AsString;
//QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure THasilPresetFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
...
procedure THasilPresetFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure THasilPresetFrm.LookAmbilCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure THasilPresetFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure THasilPresetFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure THasilPresetFrm.BitBtn5Click(Sender: TObject);
var
  vjam : string;
  vjam1,vjam2 : Integer;
begin
...
procedure THasilPresetFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure THasilPresetFrm.BitBtn6Click(Sender: TObject);
begin
 DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
 //if cbPreview.Checked then
...
procedure THasilPresetFrm.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
// QRLabel9.Caption:='(Per : '+VTglAwal2.Text+' s/d '+VTglakhir2.Text+')';
end;

procedure THasilPresetFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
QRLabel26.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure THasilPresetFrm.QDetailQTY_REChange(Sender: TField);
begin
  //QDetailQTY_SELISIH.AsFloat:=QDetailQTY_POTONG.AsFloat-QDetailQTY_RE.AsFloat;
end;

procedure THasilPresetFrm.VTglAwal3Change(Sender: TObject);
begin
VTglakhir3.Date:=(VTglAwal3.Date);
end;

procedure THasilPresetFrm.VTglakhir3Change(Sender: TObject);
begin
...
procedure THasilPresetFrm.BitBtn7Click(Sender: TObject);
var
  vjam : string;
  vjam1,vjam2 : Integer;
begin
...
procedure THasilPresetFrm.BtnExport3Click(Sender: TObject);
begin
...
procedure THasilPresetFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure THasilPresetFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
