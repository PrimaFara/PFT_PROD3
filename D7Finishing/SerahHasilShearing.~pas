...
type
  TSerahHasilShearingFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
...
var
  SerahHasilShearingFrm: TSerahHasilShearingFrm;
...
procedure TSerahHasilShearingFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  SerahHasilShearingFrm:=Nil;
end;

procedure TSerahHasilShearingFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahHasilShearingFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilShearingFrm.FormCreate(Sender: TObject);
begin
...
procedure TSerahHasilShearingFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilShearingFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TSerahHasilShearingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TSerahHasilShearingFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahHasilShearingFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahHasilShearingFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahHasilShearingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
QDetailKD_SUB_LOKASI.AsString:='72-00000';
QDetailKD_SUB_LOKASI2.AsString:='73-00000';
...
procedure TSerahHasilShearingFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahHasilShearingFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahHasilShearingFrm.FNo_UrutBeforeQuery(
...
procedure TSerahHasilShearingFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahHasilShearingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahHasilShearingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahHasilShearingFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahHasilShearingFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahHasilShearingFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahHasilShearingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahHasilShearingFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TSerahHasilShearingFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahHasilShearingFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahHasilShearingFrm.TabSheet2Show(Sender: TObject);
begin
{azmi}
if vTab='Bro' then
   vTab:='In'
...
procedure TSerahHasilShearingFrm.TabSheet1Show(Sender: TObject);
begin
  if QBrowse.Active then
  begin
         QMaster.Close;
...
procedure TSerahHasilShearingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahHasilShearingFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahHasilShearingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahHasilShearingFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahHasilShearingFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahHasilShearingFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahHasilShearingFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilShearingFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahHasilShearingFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahHasilShearingFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TSerahHasilShearingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TSerahHasilShearingFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilShearingFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahHasilShearingFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahHasilShearingFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
...
procedure TSerahHasilShearingFrm.LookAmbilCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TSerahHasilShearingFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;
