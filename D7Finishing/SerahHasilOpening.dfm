object SerahHasilOpeningFrm: TSerahHasilOpeningFrm
  Left = 670
  Top = 154
  Width = 1138
  Height = 573
  Caption = 'Serah Hasil Opening'
  Color = clBtnFace
  ...
  object QBrowse: TOracleDataSet
    ...
    Variables.Data = {
      ...
      534905000000040000003930320000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_potong) as potong from' +
        ' ipisma_db5.serah_hasil_all_det a'
      'where a.no_reg =:no_reg'
      '')
    Variables.Data = {
