object FinishDesizingFrm: TFinishDesizingFrm
  Left = 211
  Top = 123
  Width = 1130
  Height = 558
  Caption = 'Finishing - Desizing'
  Color = clBtnFace
      ...
      object QuickRep1: TQuickRep
        ...
        object QRBand6: TQRBand
          ...
          object QRLabel6: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'HASIL PRODUKSI DESIZING'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid1xxxxx: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'JENIS'#9'10'#9'JENIS'#9'F'
          'MESIN'#9'30'#9'MESIN'#9'F'
          'OPERATOR'#9'10'#9'OPERATOR 1'#9'F'
      ...
      object QuickRep2: TQuickRep
        ...
        object QRBand1: TQRBand
          ...
          object QRLabel12: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'R E K A P  P R O D U K S I  D E S I Z I N G'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.bukti_desizing a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_DEZISING'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00080000004B445F4D4553494E0100000000000700000050454D4553414E0100
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.bukti_desizing_det a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_DEZISING_DET'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      ...
      
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000029000000070000004E4F5F4E4F54410100000000000A00000054474C
      ...
      
      414D415F52454B414E414E010000000000}
    QueryAllRecords = False
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        '(qty_COUNTER) as METER from ipisma_db5.vfinish_desizing'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_potong) as potong, sum' +
        '(qty_counter) as meter from ipisma_db5.bukti_desizing_det a'
      'where a.no_reg = :no_reg')
  ...
  object QAmbil: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vlook_desizing WHERE :MYPARAM'
      '')
    Variables.Data = {
  ...
  object QPerKonstruksi_Tot: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db5.vfinish_desizing'
