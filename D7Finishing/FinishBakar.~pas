...
type
  TFinishBakarFrm = class(TForm)
    ...
    procedure Look_KPUserButton2Click(Sender: TObject;
      LookupTable: TDataSet);
...
var
  FinishBakarFrm: TFinishBakarFrm;
...
procedure TFinishBakarFrm.FormClose(Sender: TObject;
...
procedure TFinishBakarFrm.FormResize(Sender: TObject);
begin
...
procedure TFinishBakarFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TFinishBakarFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','893');
 QTransaksi.Open;
 FinishBakarFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TFinishBakarFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TFinishBakarFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TFinishBakarFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TFinishBakarFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TFinishBakarFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TFinishBakarFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TFinishBakarFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TFinishBakarFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TFinishBakarFrm.ColumnHeaderBand1BeforePrint(
...
procedure TFinishBakarFrm.FNo_UrutBeforeQuery(
...
procedure TFinishBakarFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TFinishBakarFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TFinishBakarFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TFinishBakarFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TFinishBakarFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TFinishBakarFrm.vOperandClick(Sender: TObject);
begin
...
procedure TFinishBakarFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TFinishBakarFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  t1, t2, t3 : real;
...
procedure TFinishBakarFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TFinishBakarFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TFinishBakarFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TFinishBakarFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TFinishBakarFrm.FormShow(Sender: TObject);
begin
...
procedure TFinishBakarFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
...
procedure TFinishBakarFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TFinishBakarFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TFinishBakarFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TFinishBakarFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TFinishBakarFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TFinishBakarFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TFinishBakarFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TFinishBakarFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TFinishBakarFrm.BitBtn4Click(Sender: TObject);
begin
...
procedure TFinishBakarFrm.LookMesinFinishingCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TFinishBakarFrm.LookMesinFinishingEnter(Sender: TObject);
begin
...
procedure TFinishBakarFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil_New.Open;
end;

procedure TFinishBakarFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TFinishBakarFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TFinishBakarFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TFinishBakarFrm.BitBtn5Click(Sender: TObject);
var
  vjam : string;
  vjam1,vjam2 : Integer;
begin
...
procedure TFinishBakarFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure TFinishBakarFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
QRLabel26.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TFinishBakarFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TFinishBakarFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vfilter : String;
begin
...
procedure TFinishBakarFrm.QLookAmbilBatchEnter(Sender: TObject);
begin
QAmbilBatch.Open;
end;

procedure TFinishBakarFrm.QLookAmbilBatchCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
//QDetailNO_BATCH.AsString:=QAmbilBatchKETERANGAN2.AsString;
end;

procedure TFinishBakarFrm.Look_KPCloseUp(Sender: TObject;
 LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 if modified then
    QDetailKD_KONSTRUKSI.AsString:=DMFrm.QKonstruksi_finishKD_KONSTRUKSI.AsString;
...
procedure TFinishBakarFrm.Look_KPClick(Sender: TObject);
begin
  DMFrm.QKonstruksi_finish.Open;
end;

procedure TFinishBakarFrm.Look_KPEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi_finish.Open;
end;

procedure TFinishBakarFrm.Look_KPUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vfilter : String;
begin
...
procedure TFinishBakarFrm.wwDBComboBox1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TFinishBakarFrm.wwDBComboBox1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TFinishBakarFrm.LookSuplierClick(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TFinishBakarFrm.LookSuplierEnter(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TFinishBakarFrm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TFinishBakarFrm.LookWarnaClick(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TFinishBakarFrm.LookWarnaEnter(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TFinishBakarFrm.LookWarnaCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TFinishBakarFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TFinishBakarFrm.wwDBLookupComboDlg3CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR2.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TFinishBakarFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TFinishBakarFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TFinishBakarFrm.LookJenisCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TFinishBakarFrm.LookJenisClick(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TFinishBakarFrm.LookJenisEnter(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;
