...
type
  TSerahKeOpeningFrm = class(TForm)
    PanelCenter: TPanel;
    PanelHeader: TPanel;
    PanelFooter: TPanel;
    PanelTop: TPanel;
...
var
SerahKeOpeningFrm: TSerahKeOpeningFrm;
...
procedure TSerahKeOpeningFrm.FormClose(Sender: TObject;
...
procedure TSerahKeOpeningFrm.FormResize(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.wwDBGrid1Enter(Sender: TObject);
begin
 If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahKeOpeningFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','900');
 QTransaksi.Open;
...
procedure TSerahKeOpeningFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TSerahKeOpeningFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TSerahKeOpeningFrm.QMasterBeforePost(DataSet: TDataSet);
begin
  if (QMasterISPOST.AsString='1') and (QMasterNO_NOTA.AsString='') then
  begin
      FNo_Urut.Close;
      FNo_Urut.SetVariable('pkode','900');
...
procedure TSerahKeOpeningFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TSerahKeOpeningFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TSerahKeOpeningFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TSerahKeOpeningFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TSerahKeOpeningFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.ColumnHeaderBand1BeforePrint(
...
procedure TSerahKeOpeningFrm.FNo_UrutBeforeQuery(
...
procedure TSerahKeOpeningFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TSerahKeOpeningFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TSerahKeOpeningFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TSerahKeOpeningFrm.vOperandClick(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
QBrowse.Open;
  ...
  //    for i:=0 to QBrowse.FieldCount-1 do
    ...
    vfilter:=vfilter+') and kd_transaksi = ''900''';
...
procedure TSerahKeOpeningFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TSerahKeOpeningFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TSerahKeOpeningFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TSerahKeOpeningFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TSerahKeOpeningFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TSerahKeOpeningFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TSerahKeOpeningFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TSerahKeOpeningFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TSerahKeOpeningFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TSerahKeOpeningFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure TSerahKeOpeningFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TSerahKeOpeningFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi.Open;
end;

procedure TSerahKeOpeningFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TSerahKeOpeningFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TSerahKeOpeningFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahKeOpeningFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TSerahKeOpeningFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahKeOpeningFrm.wwDBGrid1xxxxxUpdateFooter(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.BitBtn4Click(Sender: TObject);
begin
   if QBrowse.Active then
      begin
        DMFrm.QUserTime.Close;
...
procedure TSerahKeOpeningFrm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
...
procedure TSerahKeOpeningFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TSerahKeOpeningFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TSerahKeOpeningFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.DBText1Click(Sender: TObject);
begin
 InputBox (' Copy Nomer','Klik Kanan --> Copy : ',QMasterNO_NOTA.AsString);
end;

procedure TSerahKeOpeningFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     QRLabel8.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TSerahKeOpeningFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure TSerahKeOpeningFrm.QPer_HariAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QPerKonstruksi_M.RecNo)+' dari '+FormatFloat('#,#',QPerKonstruksi_M.RecordCount)+' Records';
end;

procedure TSerahKeOpeningFrm.look_mesinEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahKeOpeningFrm.Look_CorakEnter(Sender: TObject);
Begin
DMFrm.QCorak.Open;
end;

procedure TSerahKeOpeningFrm.LookMsnTenunEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahKeOpeningFrm.LookMsnTenunClick(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahKeOpeningFrm.LookMsnTenunCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
    //QMasterCORAK.AsString:=DMFrm.QCorakNAMA_CORAK.AsString;
...
procedure TSerahKeOpeningFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
QMesin.Open;
end;

procedure TSerahKeOpeningFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahKeOpeningFrm.BitBtn7Click(Sender: TObject);
begin
  wwDBGrid1Enter(nil);
...
procedure TSerahKeOpeningFrm.LookAmbilClick(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahKeOpeningFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TSerahKeOpeningFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
 If modified then
    ...
    QDetailMITRA.AsString:=QAmbilMITRA.AsString;
...
procedure TSerahKeOpeningFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
Var
  vfilter : String;
begin
...
procedure TSerahKeOpeningFrm.LookKdProdClick(Sender: TObject);
begin
DMFrm.QLookKdProduksi.Open;
end;

procedure TSerahKeOpeningFrm.LookKdProdCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TSerahKeOpeningFrm.LookKdProdEnter(Sender: TObject);
begin
DMFrm.QLookKdProduksi.Open;
end;

procedure TSerahKeOpeningFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TSerahKeOpeningFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TSerahKeOpeningFrm.Button1Click(Sender: TObject);
begin
...
procedure TSerahKeOpeningFrm.LookBeamEnter(Sender: TObject);
begin
  QBrowseMitra.Close;
  QBrowseMitra.Open;
end;

procedure TSerahKeOpeningFrm.LookBeamCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  begin
    QDetailMITRA.AsString:=QBrowseMitraNAMA_MITRA.AsString;
  end;
end;
