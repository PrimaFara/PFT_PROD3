object SJJualFrm: TSJJualFrm
  ...
  object QMaster: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00000D0000003A4B445F5452414E53414B534905000000040000003938310000
      000000}
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      5F4E4F5441010000000000080000004E4F5F42554B5449010000000000040000
      0047525550010000000000050000005348494654010000000000080000004E4F
  ...
  object QDetail: TOracleDataSet
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      04000000140000000D0000004E4F5F5245475F44455441494C01000000000006
      ...
      0000005154595F4C414C55010000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
    Session = DMFrm.OS
  ...
  object QKontrak: TOracleDataSet
    SQL.Strings = (
        ...
        'select a.rekanan, a.kd_rekanan, a.no_nota, a.no_kontrak, a.no_bu' +
        'kti, a.tgl, a.status'
      'from ipisma_db5.bukti2_order a'
      'where a.kd_transaksi='#39'987'#39' and a.status='#39'OPEN'#39
      'order by a.rekanan')
    QBEDefinition.QBEFieldDefs = {
      04000000070000000700000052454B414E414E0100000000000A0000004E4F5F
      4B4F4E5452414B0100000000000300000054474C010000000000060000005354
      415455530100000000000A0000004B445F52454B414E414E0100000000000700
    ...
    object QKontrakNO_NOTA: TStringField
      DisplayLabel = 'NO NOTA'
      DisplayWidth = 16
      FieldName = 'NO_NOTA'
    end
    ...
    object QKontrakNO_BUKTI: TStringField
