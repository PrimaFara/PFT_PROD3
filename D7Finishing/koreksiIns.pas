...
uses
  ...
  ComCtrls,DateUtils, jpeg, Oracle;

type
  TKoreksiInsFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelCenter: TPanel;
    PanelHeader: TPanel;
...
var  KoreksiInsFrm: TKoreksiInsFrm;
...
procedure TKoreksiInsFrm.FormClose(Sender: TObject;
...
procedure TKoreksiInsFrm.FormResize(Sender: TObject);
begin
...
procedure TKoreksiInsFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TKoreksiInsFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','919');
 QTransaksi.Open;
 KoreksiInsFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TKoreksiInsFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TKoreksiInsFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TKoreksiInsFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiInsFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TKoreksiInsFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiInsFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TKoreksiInsFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
if wwDBComboBox3.Text = 'BS' then
  begin
    // Aksi ketika item 'BS' dipilih
    //ShowMessage('BS dipilih');
    QDetailJENIS.AsString:='BS';
    LookMutu.Enabled := False; // Aktifkan ReadOnly
  end
else if wwDBComboBox3.Text = 'BS TEXINDO' then
  begin
    // Aksi ketika item 'BS TEXINDO' dipilih
    //ShowMessage('BS TEXINDO dipilih');
    QDetailJENIS.AsString:='BS';
    LookMutu.Enabled := False; // Aktifkan ReadOnly
  end
else
  begin
    // Aksi jika tidak ada item yang cocok
    //ShowMessage('Tidak ada item yang sesuai');
    LookMutu.Enabled := True; // Aktifkan ReadOnly
  end;

end;

procedure TKoreksiInsFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TKoreksiInsFrm.ColumnHeaderBand1BeforePrint(
...
procedure TKoreksiInsFrm.FNo_UrutBeforeQuery(
...
procedure TKoreksiInsFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TKoreksiInsFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TKoreksiInsFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TKoreksiInsFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TKoreksiInsFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TKoreksiInsFrm.vOperandClick(Sender: TObject);
begin
...
procedure TKoreksiInsFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TKoreksiInsFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKoreksiInsFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TKoreksiInsFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TKoreksiInsFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TKoreksiInsFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TKoreksiInsFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure TKoreksiInsFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TKoreksiInsFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
 
end;

procedure TKoreksiInsFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TKoreksiInsFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TKoreksiInsFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QLookKdProduksi.Open;
end;

procedure TKoreksiInsFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TKoreksiInsFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QLookKdProduksi.Open;
end;

procedure TKoreksiInsFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TKoreksiInsFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TKoreksiInsFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TKoreksiInsFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TKoreksiInsFrm.dbcField2Enter(Sender: TObject);
var
  i : Word;
begin
...
procedure TKoreksiInsFrm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TKoreksiInsFrm.BtnExport2Click(Sender: TObject);
begin
if Qkon_opening.Active then
          begin
             DMFrm.SaveDialog1.DefaultExt:='XLK';
...
procedure TKoreksiInsFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TKoreksiInsFrm.TabSheet3Show(Sender: TObject);
begin
QBrowse.Open;
Qkon_opening.Open;
end;

procedure TKoreksiInsFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
QRLabel26.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TKoreksiInsFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
DMFrm.QCorak.Open;
end;

procedure TKoreksiInsFrm.wwDBLookupComboDlg1Click(Sender: TObject);
begin
DMFrm.QCorak.Open;
end;

procedure TKoreksiInsFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TKoreksiInsFrm.wwDBComboBox1CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TKoreksiInsFrm.wwDBComboBox1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TKoreksiInsFrm.Button1Click(Sender: TObject);
begin
