object KoreksiFrm: TKoreksiFrm
  Left = 220
  Top = 115
  Width = 1074
  Height = 617
  Caption = 'Koreksi Finishing'
  Color = clBtnFace
      ...
      object PanelCenter: TPanel
        ...
        object LookKonstruksi: TwwDBLookupComboDlg
          ...
          Selected.Strings = (
            ...
            'KONSTRUKSI'#9'60'#9'KONSTRUKSI'#9'F'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid1xxxxx: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'JNS_KOREKSI'#9'20'#9'JENIS KOREKSI'#9'F'
  ...
  object QMaster: TOracleDataSet
    ...
    Variables.Data = {
      ...
      003931380000000000070000003A4E4F5F524547030000000000000000000000}
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00000000000B0000004A4E535F4B4F52454B5349010000000000030000004345
      4B010000000000}
    ...
    object QMasterCEK: TStringField
      FieldName = 'CEK'
      Size = 1
    end
  end
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        ' (select * from ipisma_db5.vkoreksi'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam'
      '')
    Variables.Data = {
      ...
      534905000000040000003931380000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object Qkon_opening: TOracleDataSet
    SQL.Strings = (
        ...
        'as potong, sum(qty_potong)/20 as kodi from ipisma_db5.vkoreksi'
    ...
    Variables.Data = {
      ...
      000D0000003A4B445F5452414E53414B5349050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object Qkon_opening_Tot: TOracleDataSet
    SQL.Strings = (
        ...
        '(qty_potong)/20 as kodi from ipisma_db5.vkoreksi'
      
        'where tgl>=:pawal and tgl<=:pakhir and kd_transaksi =:kd_transak' +
        'si'
      ':myparam')
    Variables.Data = {
  ...
  object QLookKP: TOracleDataSet
    SQL.Strings = (
      'select * from ('
      'select  distinct '
      'a.kd_produksi, kd_konstruksi, '
      'a.sub_kelompok as konstruksi,'
      'sum(nvl(o.qty,0)) + '
      '(sum(nvl(g.qty_terima,0))) +'
      '(sum(nvl(z.qtyterima,0))) +'
      '(sum(nvl(m.rmkoreksi,0))) +'
      '(sum(nvl(u.llmkoreksi,0))) +'
      '(sum(nvl(i.mkoreksi,0))) +'
      '(sum(nvl(ii.mkoreksi,0))) -'
      'sum(nvl(h.qty_keluar,0)) -'
      'sum(nvl(n.nkoreksi,0)) -'
      'sum(nvl(w.llkkoreksi,0)) - '
      'sum(nvl(j.kkoreksi,0)) -'
      'sum(nvl(jj.kkoreksi,0)) as stok'
      'from'
      
        ' /*(select distinct t.kd_produksi, t.sub_kelompok from kd_produk' +
        'si_mitra t) a*/'
      
        '   (select distinct kp as kd_produksi,kd_konstruksi, konstruksi ' +
        'as sub_kelompok from ('
      
        'select distinct y.kp, y.KD_KONSTRUKSI, substr(y.NAMA_KONSTRUKSI,' +
        '0,LENGTH(y.NAMA_KONSTRUKSI) - 3) as konstruksi'
      'from ipisma_db4.vkode_prod_kons2 y'
      'where mutu='#39'BK'#39')) a'
      '       '
      '  left outer join --stok awal'
      
        '      (select distinct (t.kd_produksi), (t.konstruksi), /*rtrim(' +
        't.konstruksi,'#39' BK'#39') as konstruksi,*/'
      '      sum(nvl(t.qty,0))as qty '
      '      from ipisma_db5.Stok_Awal_Finishing_global t'
      
        '      where trunc(t.tgl) >= to_date('#39'31/12/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(t.tgl) <= :tgl'
      
        '      group by t.kd_produksi, t.konstruksi) o on o.kd_produksi =' +
        ' a.kd_produksi and  o.konstruksi = a.sub_kelompok'
      '  '
      '  left outer join --masuk awal'
      
        '      (select distinct b.kd_produksi, (b.konstruksi), sum(b.qty_' +
        'potong) as qty_terima from ipisma_db5.vrekap_kirim_inspek b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and kd_transaksi = '#39'904'#39' and ispost='#39'1'#39
      
        '      group by b.kd_produksi, b.konstruksi) g on g.kd_produksi =' +
        ' a.kd_produksi and  g.konstruksi = a.sub_kelompok'
      '          '
      '  left outer join --masuk awal'
      
        '      (select distinct (b.kd_produksi), (b.konstruksi), sum(b.qt' +
        'y_potong) as qtyterima from ipisma_db5.VTERIMA_DARI_INSPECTING b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and kd_transaksi = '#39'901'#39' and ispost='#39'1'#39
      
        '      group by b.kd_produksi, b.konstruksi) z on z.kd_produksi =' +
        ' a.kd_produksi and z.konstruksi = a.sub_kelompok'
      '  '
      '  ---Retur Masuk'
      '  left outer join'
      
        '      (select distinct b.kd_produksi, (b.konstruksi), sum(b.qty_' +
        'potong) as rmkoreksi from ipisma_db5.vkoreksi b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and kd_transaksi = '#39'918'#39' and b.jns_korek' +
        'si = '#39'RETUR MASUK'#39' and ispost='#39'1'#39
      
        '      group by b.kd_produksi, b.konstruksi) m on m.kd_produksi =' +
        ' a.kd_produksi and  m.konstruksi = a.sub_kelompok '
      '   '
      '  ---Lain-lain Masuk'
      '  left outer join'
      
        '      (select distinct b.kd_produksi, (b.konstruksi), sum(b.qty_' +
        'potong) as llmkoreksi from ipisma_db5.vkoreksi b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and kd_transaksi = '#39'918'#39' and b.jns_korek' +
        'si = '#39'LAIN-LAIN MASUK'#39' and ispost='#39'1'#39
      
        '      group by b.kd_produksi, b.konstruksi) u on u.kd_produksi =' +
        ' a.kd_produksi and  u.konstruksi = a.sub_kelompok '
      '                '
      '  ---Koreksi Masuk awal'
      '  left outer join'
      
        '      (select distinct b.kd_produksi, (b.konstruksi), sum(b.qty_' +
        'potong) as mkoreksi from ipisma_db5.vkoreksi b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and kd_transaksi = '#39'918'#39' and b.jns_korek' +
        'si = '#39'KOREKSI MASUK'#39
      '      and ispost='#39'1'#39' '
      
        '      group by b.kd_produksi, b.konstruksi) i on i.kd_produksi =' +
        ' a.kd_produksi and  i.konstruksi = a.sub_kelompok'
      '      '
      '  -- penyesuaian masuk'
      '  left outer join'
        ...
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and kd_transaksi = '#39'918'#39' and b.jns_korek' +
        'si = '#39'PENYESUAIAN MASUK'#39
      '      and ispost='#39'1'#39' '
      
        '      group by b.kd_produksi, b.konstruksi) ii on ii.kd_produksi' +
        ' = a.kd_produksi and  ii.konstruksi = a.sub_kelompok    '
      '                                '
      '  left outer join --keluar awal'
      
        '      (select distinct b.kd_produksi, (b.konstruksi), sum(b.qty_' +
        'potong) as qty_keluar from ipisma_db5.vserah_hasil_all b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and b.kd_transaksi = '#39'908'#39' and ispost='#39'1' +
        #39
      
        '      group by b.kd_produksi, b.konstruksi) h on h.kd_produksi =' +
        ' a.kd_produksi and  h.konstruksi = a.sub_kelompok           '
      '    '
      '  --Retur Keluar        '
      '  left outer join'
      
        '      (select distinct b.kd_produksi, (b.konstruksi), sum(b.qty_' +
        'potong) as nkoreksi from ipisma_db5.vkoreksi b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and b.kd_transaksi = '#39'918'#39' and b.jns_kor' +
        'eksi = '#39'RETUR KELUAR'#39' and ispost='#39'1'#39' '
      
        '      group by b.kd_produksi,b.konstruksi) n on n.kd_produksi = ' +
        'a.kd_produksi and  n.konstruksi = a.sub_kelompok      '
      '      '
      '  --Lain-lain Keluar        '
      '  left outer join'
      
        '      (select distinct b.kd_produksi, (b.konstruksi), sum(b.qty_' +
        'potong) as llkkoreksi from ipisma_db5.vkoreksi b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and b.kd_transaksi = '#39'918'#39' and b.jns_kor' +
        'eksi = '#39'LAIN-LAIN KELUAR'#39' and ispost='#39'1'#39' '
      
        '      group by b.kd_produksi,b.konstruksi) w on w.kd_produksi = ' +
        'a.kd_produksi and  w.konstruksi = a.sub_kelompok       '
      '     '
      '  --Koreksi Keluar awal        '
      '  left outer join'
      
        '      (select distinct b.kd_produksi, (b.konstruksi), sum(b.qty_' +
        'potong) as kkoreksi from ipisma_db5.vkoreksi b'
      
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and b.kd_transaksi = '#39'918'#39' and b.jns_kor' +
        'eksi = '#39'KOREKSI KELUAR'#39
      '      and ispost='#39'1'#39' '
      
        '      group by b.kd_produksi,b.konstruksi) j on j.kd_produksi = ' +
        'a.kd_produksi and  j.konstruksi = a.sub_kelompok  '
      '      '
      '  -- penyesuaian keluar'
      '  left outer join'
        ...
        '      where trunc(b.tgl) >= to_date('#39'31/05/2020'#39','#39'dd-mm-yyyy'#39') a' +
        'nd trunc(b.tgl) <= :tgl and b.kd_transaksi = '#39'918'#39' and b.jns_kor' +
        'eksi = '#39'PENYESUAIAN KELUAR'#39
      '      and ispost='#39'1'#39' '
      
        '      group by b.kd_produksi,b.konstruksi) jj on jj.kd_produksi ' +
        '= a.kd_produksi and  jj.konstruksi = a.sub_kelompok             ' +
        '         '
      ' group by a.kd_produksi, a.sub_kelompok, a.kd_konstruksi)'
      ' -- where stok <> 0 '
      ' order by kd_produksi')
    Variables.Data = {0300000001000000040000003A54474C0C0000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000040000000B0000004B445F50524F44554B5349010000000000040000
      0053544F4B0100000000000D0000004B445F4B4F4E535452554B534901000000
      00000A0000004B4F4E535452554B5349010000000000}
    Session = DMFrm.OS
    Left = 145
    Top = 376
    object QLookKPKD_PRODUKSI: TStringField
      DisplayWidth = 10
      FieldName = 'KD_PRODUKSI'
      Required = True
    end
    object QLookKPKD_KONSTRUKSI: TStringField
      DisplayLabel = 'KODE'
      DisplayWidth = 6
      FieldName = 'KD_KONSTRUKSI'
      Size = 6
    end
    object QLookKPKONSTRUKSI: TStringField
      DisplayWidth = 60
      FieldName = 'KONSTRUKSI'
      Size = 255
    end
    object QLookKPSTOK: TFloatField
      DisplayWidth = 10
      FieldName = 'STOK'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      'BEGIN'
      '  -- Delete existing records for this registration number'
      '  DELETE FROM ipisma_db5.koreksi_detail WHERE no_reg = :no_reg;'
      '  '
      
        '  -- Insert records with deduplication logic and default '#39'POTONG' +
        #39' for satuan'
      '  INSERT INTO ipisma_db5.koreksi_detail'
      
        '  (no_reg, no_reg_detail, kd_produksi, kd_konstruksi, konstruksi' +
        ', qty_POTONG, satuan, jenis, kd_sub_lokasi, no_order, no_mesin)'
      '  ('
      '    SELECT '
      '      :no_reg, '
      '      IPISMA_DB5.REG_KOREKSI_DET.nextval, '
      '      kd_produksi,'
      '      kd_konstruksi,'
      '      konstruksi,'
      '      qty,'
      '      '#39'POTONG'#39' AS satuan,  -- Default value set here'
      '      jenis, '
      '      '#39'-'#39','
      '      keterangan,'
      '      mesin'
      '    FROM ('
        ...
        '      -- Combined data from both sources with priority to the fi' +
        'rst view'
      '      SELECT '
      '        kd_produksi,'
      '        kd_konstruksi,'
      ...
      '      FROM ipisma_db5.vkoreksi_reinspec'
      '      WHERE no_nota = :nota'
      '      '
      '      UNION ALL'
      '      '
      ...
      '        '#39'POTONG'#39' AS satuan,  -- Default value set here'
      '        jenis,'
      '        keterangan2 AS keterangan,'
      '        '#39'-'#39' AS mesin,'
      '        2 AS source_priority'
      '      FROM ipisma_db6.vkoreksi_handprint'
      '      WHERE no_nota = :nota'
      '    ) combined_data'
      
        '    WHERE (kd_produksi, kd_konstruksi, konstruksi, '#39'POTONG'#39', jen' +
        'is, NVL(keterangan, '#39' '#39')) IN ('
      
        '      -- This subquery identifies the first occurrence of each u' +
        'nique combination'
      '      SELECT '
      '        kd_produksi,'
      '        kd_konstruksi,'
      '        konstruksi,'
      '        '#39'POTONG'#39',  -- Default value set here'
      '        jenis,'
      '        NVL(keterangan, '#39' '#39')'
      '      FROM ('
      '        SELECT '
      '          kd_produksi,'
      '          kd_konstruksi,'
      ...
      '          ROW_NUMBER() OVER ('
        ...
        '            PARTITION BY kd_produksi, kd_konstruksi, konstruksi,' +
        ' '#39'POTONG'#39', jenis, NVL(keterangan, '#39' '#39')'
      ...
      '      ) ranked'
        ...
        '      WHERE rn = 1  -- Only take the first occurrence of each un' +
        'ique combination'
      '    )'
      '  );'
      ''
    ...
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000070000003A4E4F5F52454705000000000000000000000005
      0000003A4E4F5441050000000000000000000000}
    Left = 364
    Top = 153
  end
  object QHandprint1: TOracleQuery
    SQL.Strings = (
      'DECLARE'
      '    CURSOR cur_kp IS'
      '        SELECT kp, kd_corak, nama_corak'
      '        FROM ipisma_db5.VCORAK_HANDPRINT'
      
        '        WHERE kp IN (SELECT kp FROM ipisma_db5.koreksi_detail WH' +
        'ERE no_reg = :no_reg and kd_produksi = :kp);'
      'BEGIN'
      '    -- Update cek='#39'CEK'#39' untuk no_nota tertentu'
      '    UPDATE ipisma_db5.koreksi'
      '    SET cek = '#39'CEK'#39
      '    WHERE no_nota = :no_nota;'
      ''
      
        '    -- Update kd_corak dan corak untuk semua kp yang terkait den' +
        'gan no_reg'
      '    FOR rec IN cur_kp LOOP'
      '        UPDATE ipisma_db5.koreksi_detail k'
      '        SET '
      '            k.kd_corak = rec.kd_corak,'
      '            k.corak = rec.nama_corak'
      '        WHERE k.no_reg = :no_reg AND k.kd_produksi = rec.kp;'
      '    END LOOP;'
      ''
      '    -- Commit perubahan setelah semua update selesai'
      '    COMMIT;'
      'END;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000003000000080000003A4E4F5F4E4F5441050000000000000000000000
      070000003A4E4F5F524547030000000000000000000000030000003A4B500500
      00000000000000000000}
    Left = 492
    Top = 257
  end
  object QHandprint2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  update ipisma_db5.koreksi set cek='#39#39' where no_nota=:no_nota;'
      '  UPDATE ipisma_db5.koreksi_detail k'
      #9'SET '
      #9#9'k.kd_corak = '#39#39','
      '    '#9#9'k.corak = '#39#39
  ...
  object QCekHandprint: TOracleDataSet
    SQL.Strings = (
      
        'select count(cek) as cek from ipisma_db5.koreksi where no_nota=:' +
        'no_nota'
      ''
      ''
      ''
    ...
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000300000043454B010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 420
  ...
  object QCorakHandprint: TOracleDataSet
    SQL.Strings = (
      'select a.*,c.kd_corak, c.nama_corak from ('
      ...
      'select distinct y.kp, y.KD_KONSTRUKSI, '
        ...
        'from ipisma_db4.vkode_prod_kons2 y where mutu='#39'BK'#39')) a, ipisma_d' +
        'b1.item_saldo_handprint b, ipisma_db2.corak@sales c'
      'where a.kp=b.kp and b.kd_corak=c.kd_corak'
      'order by a.kp')
    QBEDefinition.QBEFieldDefs = {04000000010000000300000043454B010000000000}
    QueryAllRecords = False
    CountAllRecords = True
