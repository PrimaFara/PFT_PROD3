object KoreksiFrm: TKoreksiFrm
  ...
  object QAmbilNota: TOracleQuery
    SQL.Strings = (
      'begin'
      '  delete ipisma_db5.koreksi_detail where no_reg=:no_reg;'
      '  insert into ipisma_db5.koreksi_detail'
      
        '  (no_reg, no_reg_detail,kd_produksi,kd_konstruksi,konstruksi,qt' +
        'y_potong,satuan,jenis,kd_sub_lokasi,no_order,no_mesin)'
      
        '  (select :no_reg, IPISMA_DB5.REG_KOREKSI_DET.nextval, kd_produk' +
        'si,kd_konstruksi,konstruksi,qty_potong,satuan,'
      
        '   jenis, '#39'-'#39',keterangan,no_mesin from ipisma_db5.vkoreksi_reins' +
        'pec'
      '   where no_nota=:nota);'
      '  commit;'
      'end;')
