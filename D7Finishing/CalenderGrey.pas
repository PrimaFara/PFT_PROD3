...
var
  CalenderGreyFrm: TCalenderGreyFrm;
...
procedure TCalenderGreyFrm.FormClose(Sender: TObject;
...
procedure TCalenderGreyFrm.FormResize(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TCalenderGreyFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','922');
 QTransaksi.Open;
 CalenderGreyFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TCalenderGreyFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TCalenderGreyFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TCalenderGreyFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TCalenderGreyFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TCalenderGreyFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TCalenderGreyFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TCalenderGreyFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TCalenderGreyFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.ColumnHeaderBand1BeforePrint(
...
procedure TCalenderGreyFrm.FNo_UrutBeforeQuery(
...
procedure TCalenderGreyFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TCalenderGreyFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TCalenderGreyFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TCalenderGreyFrm.vOperandClick(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TCalenderGreyFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TCalenderGreyFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TCalenderGreyFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TCalenderGreyFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TCalenderGreyFrm.FormShow(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
...
procedure TCalenderGreyFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TCalenderGreyFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TCalenderGreyFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TCalenderGreyFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TCalenderGreyFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TCalenderGreyFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TCalenderGreyFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TCalenderGreyFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TCalenderGreyFrm.BitBtn4Click(Sender: TObject);
begin
  //QMaster.Edit;
  //QMaster.Post;
//  QAmbilData.Close;
...
procedure TCalenderGreyFrm.LookMesinFinishingEnter(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.LookMesinFinishingCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TCalenderGreyFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure TCalenderGreyFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil.Open;
end;

procedure TCalenderGreyFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TCalenderGreyFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.BitBtn5Click(Sender: TObject);
var
  vjam : string;
  vjam1,vjam2 : Integer;
begin
...
procedure TCalenderGreyFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure TCalenderGreyFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TCalenderGreyFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
QRLabel26.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TCalenderGreyFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vfilter : String;
begin
...
procedure TCalenderGreyFrm.LookAmbilBatchCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  QDetailNO_BATCH.AsString:=QAmbilBatchKETERANGAN2.AsString;
  QDetailNO_DESAIN.AsString:=QAmbilBatchNO_DESAIN.AsString;
  QDetailNO_ORDER.AsString:=QAmbilBatchNO_ORDER.AsString;
  QDetailKD_KONSTRUKSI.AsString:=QAmbilBatchKD_KONSTRUKSI.AsString;
  QDetailKONSTRUKSI.AsString:=QAmbilBatchKONSTRUKSI.AsString;
  QDetailKD_PRODUKSI.AsString:=QAmbilBatchKET_KONSTRUKSI.AsString;
  QDetailWARNA.AsString:=QAmbilBatchCORAK.AsString;
  QDetailCORAK.AsString:=QAmbilBatchCORAK_PRINTING.AsString;
  QDetailQTY_GULUNG.AsString:=QAmbilBatchQTY_GULUNG.AsString;
  QDetailQTY_COUNTER.AsString:=QAmbilBatchQTY_METER.AsString;
  QDetailKETERANGAN.AsString:=QAmbilBatchKET_DETAIL.AsString;
  QDetailQTY_COUNTER2.AsString:=QAmbilBatchMETER.AsString;
end;

procedure TCalenderGreyFrm.LookAmbilBatchEnter(Sender: TObject);
begin
QAmbilBatch.Open;
end;

procedure TCalenderGreyFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure TCalenderGreyFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TCalenderGreyFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TCalenderGreyFrm.wwDBLookupComboDlg3CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR2.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TCalenderGreyFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TCalenderGreyFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TCalenderGreyFrm.LookSuplierEnter(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TCalenderGreyFrm.LookSuplierClick(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TCalenderGreyFrm.LookSuplierCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TCalenderGreyFrm.LookWarnaClick(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TCalenderGreyFrm.LookWarnaEnter(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TCalenderGreyFrm.LookWarnaCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TCalenderGreyFrm.LookJenisEnter(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TCalenderGreyFrm.LookJenisClick(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TCalenderGreyFrm.LookJenisCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
