object HasilPreset2Frm: THasilPreset2Frm
  Left = 206
  Top = 173
  Width = 1141
  Height = 503
  Caption = 'Serah Ke Printing'
  Color = clBtnFace
      ...
      object PanelCenter: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'QTY_GULUNG'#9'6'#9'GULUNG'#9'F'#9'QTY'
        ...
        object LookAmbil: TwwDBLookupComboDlg
          ...
          UserButton1Caption = '&Refresh'
          Selected.Strings = (
            'KP'#9'10'#9'KODE PRODUKSI'#9'F'
            'LUSI'#9'10'#9'KONSTRUKSI'#9'F')
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.serah_ke_printing a'
    ...
    Variables.Data = {
      ...
      0D0000003A4B445F5452414E53414B5349050000000400000039303300000000
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      544F52010000000000}
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.serah_ke_printing_det a'
    ...
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      04000000100000000D0000004E4F5F5245475F44455441494C01000000000006
      ...
      524445520100000000000700000050454D4553414E0100000000000600000053
      415455414E0100000000000B0000004B445F50524F44554B5349010000000000
      080000004F50455241544F52010000000000070000004E4F5F52454646010000
      000000050000005348494654010000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
    Session = DMFrm.OS
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * From (select * from ipisma_db5.vserah_preset_printing'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      }
    QueryAllRecords = False
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'from (select * from ipisma_db5.vserah_preset_printing'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(qty_gulung) as gulung, '
      'sum(qty_potong) as potong'
      'from ipisma_db5.serah_ke_printing_det a'
      'where a.no_reg =:no_reg'
      '')
    Variables.Data = {
  ...
  object QAmbil: TOracleDataSet
    SQL.Strings = (
      'select b.* from ipisma_db4.kode_produksi_new b')
    QBEDefinition.QBEFieldDefs = {
      
      000000020000004B47010000000000}
    Session = DMFrm.OS
    Left = 137
    Top = 392
    object QAmbilKP: TStringField
      DisplayLabel = 'KODE PRODUKSI'
      DisplayWidth = 10
      FieldName = 'KP'
      Required = True
    end
    object QAmbilLUSI: TStringField
      DisplayLabel = 'KONSTRUKSI'
      DisplayWidth = 10
      FieldName = 'LUSI'
      Size = 50
    end
    object QAmbilPAKAN: TStringField
      FieldName = 'PAKAN'
      Visible = False
      Size = 50
    end
    object QAmbilSISIR: TFloatField
      FieldName = 'SISIR'
      Visible = False
    end
    object QAmbilPICK: TFloatField
      FieldName = 'PICK'
      Visible = False
    end
    object QAmbilLCUCUK: TFloatField
      FieldName = 'LCUCUK'
      Visible = False
    end
    ...
    object QAmbilTEORITIS: TFloatField
      FieldName = 'TEORITIS'
      Visible = False
    end
    object QAmbilKG: TFloatField
      FieldName = 'KG'
      Visible = False
    end
    object QAmbilSTATUS: TFloatField
      FieldName = 'STATUS'
      Visible = False
    end
