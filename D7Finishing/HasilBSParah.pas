...
type
  THasilBSParahFrm = class(TForm)
    ...
    QBrowseTotalQTY_ORG: TFloatField;
    ...
    QBrowseQTY_LALU: TFloatField;
    QBrowseQTY_ORG: TFloatField;
    ...
    QTotalBS_TENUN: TFloatField;
    QTotalBS_MITRA: TFloatField;
    QBrowseTotalQTY_LALU: TFloatField;
    QRImage1: TQRImage;
    QRLabel96: TQRLabel;
    QRLabel106: TQRLabel;
    QRLabel4: TQRLabel;
...
var
HasilBSParahFrm: THasilBSParahFrm;
...
procedure THasilBSParahFrm.FormClose(Sender: TObject;
...
procedure THasilBSParahFrm.FormResize(Sender: TObject);
begin
...
procedure THasilBSParahFrm.wwDBGrid1Enter(Sender: TObject);
begin
 If QMaster.State<> dsBrowse then QMaster.Post;
 QDetail.Open;
end;

procedure THasilBSParahFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','999');
 QTransaksi.Open;
 HasilBSParahFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure THasilBSParahFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure THasilBSParahFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure THasilBSParahFrm.QMasterBeforePost(DataSet: TDataSet);
begin
  if (QMasterISPOST.AsString='1') and (QMasterNO_NOTA.AsString='') then
  begin
      FNo_Urut.Close;
      FNo_Urut.SetVariable('pkode','999');
...
procedure THasilBSParahFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure THasilBSParahFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure THasilBSParahFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure THasilBSParahFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure THasilBSParahFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure THasilBSParahFrm.ColumnHeaderBand1BeforePrint(
...
procedure THasilBSParahFrm.FNo_UrutBeforeQuery(
...
procedure THasilBSParahFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure THasilBSParahFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure THasilBSParahFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure THasilBSParahFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure THasilBSParahFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure THasilBSParahFrm.vOperandClick(Sender: TObject);
begin
...
procedure THasilBSParahFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure THasilBSParahFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
QBrowse.Open;
  ...
  wwDBGrid1xxxxx.ColumnByName('QTY_LALU').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QBrowseTotalQTY_LALU.AsFloat);
  wwDBGrid1xxxxx.ColumnByName('QTY_ORG').FooterValue:=FormatFloat('0.0,0;(0.0,0);-',QBrowseTotalQTY_ORG.AsFloat);

end;

procedure THasilBSParahFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure THasilBSParahFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure THasilBSParahFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure THasilBSParahFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
  QTotal.Open;
  wwDBGrid1.ColumnByName('QTY_LALU').FooterValue:=FormatFloat('#.#,#',QTotalBS_TENUN.AsFloat);
  wwDBGrid1.ColumnByName('QTY_ORG').FooterValue:=FormatFloat('#.#,#',QTotalBS_MITRA.AsFloat);
end;

procedure THasilBSParahFrm.FormShow(Sender: TObject);
begin
{azmi}
...
procedure THasilBSParahFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure THasilBSParahFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure THasilBSParahFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure THasilBSParahFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure THasilBSParahFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi.Open;
end;

procedure THasilBSParahFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure THasilBSParahFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi.Open;
end;

procedure THasilBSParahFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure THasilBSParahFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure THasilBSParahFrm.LookKonClick(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure THasilBSParahFrm.LookKonEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure THasilBSParahFrm.LookKonCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
...
procedure THasilBSParahFrm.BitBtn4Click(Sender: TObject);
begin
   if QBrowse.Active then
      begin
        DMFrm.QUserTime.Close;
...
procedure THasilBSParahFrm.BitBtn5Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vkd : string;
...
procedure THasilBSParahFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure THasilBSParahFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure THasilBSParahFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
...
procedure THasilBSParahFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure THasilBSParahFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure THasilBSParahFrm.DBText1Click(Sender: TObject);
begin
 InputBox (' Copy Nomer','Klik Kanan --> Copy : ',QMasterNO_NOTA.AsString);
end;

procedure THasilBSParahFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     QRLabel8.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure THasilBSParahFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
 if ((Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName<>'') then
  begin
...
procedure THasilBSParahFrm.QPer_HariAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QPerKonstruksi_M.RecNo)+' dari '+FormatFloat('#,#',QPerKonstruksi_M.RecordCount)+' Records';
end;

procedure THasilBSParahFrm.look_mesinEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure THasilBSParahFrm.Look_CorakEnter(Sender: TObject);
Begin
DMFrm.QCorak.Open;
end;

procedure THasilBSParahFrm.LookMsnTenunEnter(Sender: TObject);
begin
QMesin.Open;
end;

procedure THasilBSParahFrm.LookMsnTenunClick(Sender: TObject);
begin
QMesin.Open;
end;

procedure THasilBSParahFrm.LookMsnTenunCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
    //QMasterCORAK.AsString:=DMFrm.QCorakNAMA_CORAK.AsString;
...
procedure THasilBSParahFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
DMFrm.QLookGrup.Open;
end;

procedure THasilBSParahFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure THasilBSParahFrm.BitBtn7Click(Sender: TObject);
begin
  wwDBGrid1Enter(nil);
...
procedure THasilBSParahFrm.LookAmbilClick(Sender: TObject);
begin
QKdProd.Open;
end;

procedure THasilBSParahFrm.LookAmbilEnter(Sender: TObject);
begin
QKdProd.Open;
end;

procedure THasilBSParahFrm.LookAmbilCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure THasilBSParahFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
Var
  vfilter : String;
begin
...
procedure THasilBSParahFrm.LookKdProdClick(Sender: TObject);
begin
//QKdProd.Open;
end;

procedure THasilBSParahFrm.LookKdProdCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  QDetailKD_PRODUKSI.AsString:=QKdProdKD_PRODUKSI.AsString;
...
procedure THasilBSParahFrm.LookKdProdEnter(Sender: TObject);
begin
QKdProd.Open;
end;
