object SerahHasilCalenderFrm: TSerahHasilCalenderFrm
      ...
      object QuickRep2: TQuickRep
        ...
        object QRBand1: TQRBand
          ...
          object QRLabel12: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'R E K A P  K I R I M  K E  R E I N S P E C T'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
    ...
    object TabSheet4: TTabSheet
      ...
      object wwDBGrid3: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'GULUNG'#9'15'#9'GULUNG'#9'F'#9'JUMLAH'
          'POTONG'#9'15'#9'POTONG'#9'F'#9'JUMLAH')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QMaster: TOracleDataSet
    ...
    Variables.Data = {
      ...
      0D0000003A4B445F5452414E53414B5349050000000400000039303800000000
  ...
  object QDetail: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      0000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      ...
      '')
    Variables.Data = {
      0300000002000000080000003A4D59504152414D010000003600000077686572
      652074676C3D746F5F64617465287379736461746529206F7264657220627920
      4E4F5F4E4F54412C204E4F5F4F5244455200000000000D0000003A4B445F5452
      414E53414B534905000000040000003930380000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      
  ...
  object QBrowseTotal: TOracleDataSet
    ...
    object QBrowseTotalQTY_RE: TFloatField
      FieldName = 'QTY_RE'
    end
    object QBrowseTotalQTY_SELISIH: TFloatField
      FieldName = 'QTY_SELISIH'
    end
  end
  object QTotal: TOracleDataSet
    ...
    object QTotalQTY_RE: TFloatField
      FieldName = 'QTY_RE'
    end
    object QTotalQTY_SELISIH: TFloatField
      FieldName = 'QTY_SELISIH'
    end
  end
  object QAmbil: TOracleDataSet
    ...
    object QAmbilKERETA: TStringField
      FieldName = 'KERETA'
      Visible = False
      Size = 6
    end
    ...
    object QAmbilMUTU: TStringField
      FieldName = 'MUTU'
      Visible = False
      Size = 10
    end
    ...
    object QAmbilTUJUAN: TStringField
      FieldName = 'TUJUAN'
      Visible = False
      Size = 100
    end
    ...
    object QAmbilQTY_KONVERSI: TFloatField
      FieldName = 'QTY_KONVERSI'
      Visible = False
    end
    object QAmbilTGL_INSPECT: TDateTimeField
    ...
    object QAmbilMESIN_DET: TStringField
      FieldName = 'MESIN_DET'
      Visible = False
      Size = 30
    end
    object QAmbilMESIN_TENUN_DET: TStringField
  ...
  object QPerKonstruksi_Tot: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db5.vserah_hasil_all'
      'where tgl>=:pawal and tgl<=:pakhir and kd_transaksi = 908'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object DsPerKode_Prod: TwwDataSource
    DataSet = QPerKode_Prod
    Left = 709
    Top = 104
  end
  object QPerKode_Prod: TOracleDataSet
    SQL.Strings = (
      'select '
      'kd_produksi,'
      'sum(qty_gulung)as gulung,'
      ...
      '')
    Variables.Data = {
      0300000003000000080000003A4D59504152414D010000001500000067726F75
      70206279206B645F70726F64756B73690000000000060000003A504157414C0C
      0000000000000000000000070000003A50414B4849520C000000000000000000
      0000}
    QBEDefinition.QBEFieldDefs = {
      04000000040000000600000047554C554E4701000000000006000000504F544F
      4E47010000000000040000004B4F44490100000000000B0000004B445F50524F
      44554B5349010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 604
    Top = 113
    object QPerKode_ProdKD_PRODUKSI: TStringField
      FieldName = 'KD_PRODUKSI'
    end
    object QPerKode_ProdGULUNG: TFloatField
      FieldName = 'GULUNG'
    end
    object QPerKode_ProdPOTONG: TFloatField
      FieldName = 'POTONG'
    end
    object QPerKode_ProdKODI: TFloatField
      FieldName = 'KODI'
    end
  end
  object QPerKode_Prod_Tot: TOracleDataSet
    SQL.Strings = (
      'select '
      'sum(qty_gulung)as gulung,'
      'sum(qty_potong)as potong,'
    ...
    Left = 516
    Top = 121
    object QPerKode_Prod_TotGULUNG: TFloatField
      FieldName = 'GULUNG'
    end
    object QPerKode_Prod_TotPOTONG: TFloatField
      FieldName = 'POTONG'
    end
    object QPerKode_Prod_TotKODI: TFloatField
      FieldName = 'KODI'
    end
  end
  object QLookKP: TOracleDataSet
    SQL.Strings = (
      ...
      ' where stok <> 0 order by kd_produksi')
  ...
  object QUnpost: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        'update ipisma_db5.serah_hasil_all set ispost='#39'0'#39' where no_nota=:' +
        'no_nota;  '
      'commit;'
      ' end;')
    Session = DMFrm.OS
  ...
  object QAmbilData: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  ipisma_db5.proc_dari_inspecting_serahall3(:qno_reg,:qno_nota,:' +
        'cek);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
