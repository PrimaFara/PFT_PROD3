...
type
  TFinishShearingFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    ...
    QTransaksiAmbil: TOracleDataSet;
    ...
    dsQTransaksiAmbil: TwwDataSource;
...
var
  FinishShearingFrm: TFinishShearingFrm;

implementation

uses DM, Math, FinishOpening, TerimaDariFinishing;

{$R *.dfm}

procedure TFinishShearingFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=caFree;
  FinishShearingFrm:=Nil;
end;

procedure TFinishShearingFrm.FormResize(Sender: TObject);
begin
...
procedure TFinishShearingFrm.wwDBGrid1Enter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TFinishShearingFrm.FormCreate(Sender: TObject);
begin
 QTransaksi.SetVariable('kd_transaksi','892');
 QTransaksi.Open;
 FinishShearingFrm.Caption:=QTransaksiNAMA_TRANSAKSI.AsString;
 QMaster.Open;
 QDetail.Open;
end;

procedure TFinishShearingFrm.LookRekananEnter(Sender: TObject);
begin
 //DMFrm.QRekanan.Open;
end;

procedure TFinishShearingFrm.LookRekananClick(Sender: TObject);
begin
   //DMFrm.QRekanan.Close;
   //DMFrm.QRekanan.Open;
end;

procedure TFinishShearingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TFinishShearingFrm.QDetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TFinishShearingFrm.Edit1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TFinishShearingFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
  QDetail.Close;
  LookMaster.Execute;
  QDetail.Open;
...
procedure TFinishShearingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
QDetailKD_SUB_LOKASI.AsString:='72-10000';
...
procedure TFinishShearingFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TFinishShearingFrm.ColumnHeaderBand1BeforePrint(
...
procedure TFinishShearingFrm.FNo_UrutBeforeQuery(
...
procedure TFinishShearingFrm.QMasterBeforeQuery(Sender: TOracleDataSet);
begin
  QMaster.SetVariable('kd_transaksi',QTransaksiKD_TRANSAKSI.AsString);
end;

procedure TFinishShearingFrm.VTglAwalChange(Sender: TObject);
begin
  vTglAkhir.Date:=trunc(EndOfTheMonth(VTglAwal.Date));
end;

procedure TFinishShearingFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TFinishShearingFrm.cbOtomatisClick(Sender: TObject);
begin
...
procedure TFinishShearingFrm.dbcFieldEnter(Sender: TObject);
var
  i : Word;
begin
...
procedure TFinishShearingFrm.vOperandClick(Sender: TObject);
begin
...
procedure TFinishShearingFrm.cbTanggalClick(Sender: TObject);
begin
...
procedure TFinishShearingFrm.BitBtn3Click(Sender: TObject);
var
  i : word;
  vpertama : boolean;
begin
...
procedure TFinishShearingFrm.BtnExportClick(Sender: TObject);
begin
          if QBrowse.Active then
          begin
...
procedure TFinishShearingFrm.wwDBGrid1xxxxxTitleButtonClick(
...
procedure TFinishShearingFrm.TabSheet1Show(Sender: TObject);
begin
         QMaster.Close;
...
procedure TFinishShearingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TFinishShearingFrm.FormShow(Sender: TObject);
begin
...
procedure TFinishShearingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
{azmi}
...
procedure TFinishShearingFrm.wwDBGrid1xxxxxEnter(Sender: TObject);
begin
  If QMaster.State<> dsBrowse then QMaster.Post;
end;

procedure TFinishShearingFrm.LookKonstruksiCloseUp(Sender: TObject;
...
procedure TFinishShearingFrm.LookCorakCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 If modified then
...
procedure TFinishShearingFrm.LookKonstruksiEnter(Sender: TObject);
begin
DMFrm.QKonstruksi_finish.Open;
end;

procedure TFinishShearingFrm.LookCorakEnter(Sender: TObject);
begin
  DMFrm.QCorak.Open;
end;

procedure TFinishShearingFrm.LookKonstruksiClick(Sender: TObject);
begin
   DMFrm.QKonstruksi_finish.Open;
end;

procedure TFinishShearingFrm.LookCorakClick(Sender: TObject);
begin
   DMFrm.QCorak.Open;
end;

procedure TFinishShearingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QUserTime.Open;
...
procedure TFinishShearingFrm.LookMesinFinishingEnter(Sender: TObject);
begin
...
procedure TFinishShearingFrm.LookMesinFinishingCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
...
procedure TFinishShearingFrm.LookAmbilEnter(Sender: TObject);
begin
QAmbil_New.Open;
end;

procedure TFinishShearingFrm.LookAmbilCloseUp(Sender: TObject;
LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TFinishShearingFrm.BitBtn5Click(Sender: TObject);
var
  vjam : string;
  vjam1,vjam2 : Integer;
begin
...
procedure TFinishShearingFrm.BtnExport2Click(Sender: TObject);
begin
...
procedure TFinishShearingFrm.BitBtn6Click(Sender: TObject);
begin
DMFrm.QUserTime.Close;
 DMFrm.QUserTime.Open;
...
procedure TFinishShearingFrm.VTglAwal2Change(Sender: TObject);
begin
 VTglakhir2.Date:=(VTglAwal2.Date);
end;

procedure TFinishShearingFrm.VTglakhir2Change(Sender: TObject);
begin
...
procedure TFinishShearingFrm.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
QRLabel26.Caption:='(Per : '+vTglAwal2.Text+' s/d '+vTglAkhir2.Text+')';
end;

procedure TFinishShearingFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
    QDetailKD_CORAK.AsString:=DMFrm.QCorakKD_CORAK.AsString;
    QDetailCORAK.AsString:=DMFrm.QCorakNAMA_CORAK.AsString;
...
procedure TFinishShearingFrm.wwDBLookupComboDlg1Click(Sender: TObject);
begin
DMFrm.QCorak.Open;
end;

procedure TFinishShearingFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
DMFrm.QCorak.Open;
end;

procedure TFinishShearingFrm.LookAmbilUserButton2Click(Sender: TObject;
  LookupTable: TDataSet);
var
  vfilter : String;
begin
...
procedure TFinishShearingFrm.Look_KPClick(Sender: TObject);
begin
  DMFrm.QKonstruksi_finish.Open;
  DMFrm.QKonstruksi_Kp.Open;
end;

procedure TFinishShearingFrm.Look_KPEnter(Sender: TObject);
begin
  DMFrm.QKonstruksi_finish.Open;
  DMFrm.QKonstruksi_Kp.Open;
end;

procedure TFinishShearingFrm.Look_KPCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
 if modified then
    QDetailKD_KONSTRUKSI.AsString:=DMFrm.QKonstruksi_finishKD_KONSTRUKSI.AsString;
...
procedure TFinishShearingFrm.wwDBComboBox1CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterGRUP.AsString:=DMFrm.QLookGrupGRUP.AsString;
end;

procedure TFinishShearingFrm.wwDBComboBox1Enter(Sender: TObject);
begin
   DMFrm.QLookGrup.Open;
end;

procedure TFinishShearingFrm.wwDBLookupComboDlg2Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TFinishShearingFrm.wwDBLookupComboDlg2CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TFinishShearingFrm.wwDBLookupComboDlg3CloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
QMasterOPERATOR2.AsString:=DMFrm.QLookOperatorNAMA_KARYAWAN.AsString;
end;

procedure TFinishShearingFrm.wwDBLookupComboDlg3Enter(Sender: TObject);
begin
DMFrm.QLookOperator.Open;
end;

procedure TFinishShearingFrm.LookSuplierClick(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TFinishShearingFrm.LookSuplierCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TFinishShearingFrm.LookSuplierEnter(Sender: TObject);
begin
DMFrm.QSuplier.Open;
end;

procedure TFinishShearingFrm.LookWarnaClick(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TFinishShearingFrm.LookWarnaCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TFinishShearingFrm.LookWarnaEnter(Sender: TObject);
begin
DMFrm.QLookWarna.Open;
end;

procedure TFinishShearingFrm.LookJenisCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  // QMasterKONSTRUKSI.AsString:=DMFrm.QKonstruksiNAMA_KONSTRUKSI.AsString;
...
procedure TFinishShearingFrm.LookJenisClick(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TFinishShearingFrm.LookJenisEnter(Sender: TObject);
begin
DMFrm.QLookJenis.Open;
end;

procedure TFinishShearingFrm.BitBtn4Click(Sender: TObject);
begin
