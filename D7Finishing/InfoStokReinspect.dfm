object InfoStokReinspectFrm: TInfoStokReinspectFrm
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 415
      Height = 33
      Caption = 'Laporan Stok WIP ReInspecting'
      Color = 4605440
  ...
  object PageControl1: TPageControl
        ...
        object TabSheet8: TTabSheet
          ...
          object QuickRep7: TQuickRep
            ...
            object QRBand23: TQRBand
              ...
              object QRLabel181: TQRLabel
                ...
                AutoSize = True
                AutoStretch = False
                Caption = 'STOCK WIP INSPECTING GREIGE'
                Color = clWhite
                Font.Charset = DEFAULT_CHARSET
                Font.Color = clWindowText
                Font.Height = -19
          ...
          object wwDBGrid6: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'MASUK1'#9'10'#9'DARI FINISHING'#9'F'#9'PEMASUKAN'
              'KELUAR1'#9'10'#9'KE JAHIT KEMAS'#9'F'#9'PENGELUARAN'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid8: TwwDBGrid
        ...
        Selected.Strings = (
          'KD_PRODUKSI'#9'10'#9'KD PRODUKSI'#9'F'#9'KONSTRUKSI'
          'KONSTRUKSI'#9'40'#9'NAMA'#9'F'#9'KONSTRUKSI'
          'AWAL_BK'#9'10'#9'BK'#9'F'#9'AWAL'
          'AWAL_BS'#9'10'#9'BS'#9'F'#9'AWAL'
          'DLM_BK'#9'10'#9'DALAM~BK'#9'F'#9'PEMASUKAN'
          'DLM_BS'#9'10'#9'DALAM~BS'#9'F'#9'PEMASUKAN'
          'SSUAI_IN'#9'10'#9'PENYESUAIAN~BK'#9'F'#9'PEMASUKAN'
          'MTR_BK'#9'10'#9'MITRA~BK'#9'F'#9'PEMASUKAN'
          'MTR_BS'#9'10'#9'MITRA~BS'#9'F'#9'PEMASUKAN'
          'LNIN_BK'#9'10'#9'LAIN~BK'#9'F'#9'PEMASUKAN'
          'LNIN_BS'#9'10'#9'LAIN~BS'#9'F'#9'PEMASUKAN'
          'KORIN_BK'#9'10'#9'KOREKSI~BK'#9'F'#9'PEMASUKAN'
          ...
          'KOROUT_BS'#9'10'#9'KOREKSI~BS'#9'F'#9'PENGELUARAN'
          'RETUR_BK'#9'10'#9'RETUR~BK'#9'F'#9'PENGELUARAN'
          'RETUR_BS'#9'10'#9'RETUR~BS'#9'F'#9'PENGELUARAN'
          'OUT_BK'#9'10'#9'KELUAR~BK'#9'F'#9'PENGELUARAN'
          'OUT_BS'#9'10'#9'KELUAR~BS'#9'F'#9'PENGELUARAN'
          'KEMAS_BK'#9'10'#9'KEMAS~BK'#9'F'#9'PENGELUARAN'
          'KEMAS_BS'#9'10'#9'KEMAS~BS'#9'F'#9'PENGELUARAN'
          'AKHIR_BK'#9'10'#9'BK'#9'F'#9'AKHIR'
          'AKHIR_BS'#9'10'#9'BS'#9'F'#9'AKHIR'
          'AKHIR_BK_KD'#9'10'#9'BK'#9'F'#9'AKHIR KODI'
          'AKHIR_BS_KD'#9'10'#9'BS'#9'F'#9'AKHIR KODI')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Pismatex Master'
        IniAttributes.Delimiter = ';;'
  ...
  object QWIP: TOracleDataSet
    SQL.Strings = (
      'select a.* from ipisma_db5.vwip_reinspect_global a'
      ':myparam'
      '')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      5231010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
  ...
  object QProcWIP: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db5.proc_wip_reinspect_global(:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QWIP_Tot: TOracleDataSet
    SQL.Strings = (
      ...
      ' from ipisma_db5.vwip_reinspect_global'
      ':myparam'
      '')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000004000000050000004157414C31010000000000060000004D4153554B
      31010000000000070000004B454C5541523101000000000006000000414B4849
      5231010000000000}
    QueryAllRecords = False
    CountAllRecords = True
  ...
  object QWIPn_Tot: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(ssuai_in) as ssuai_in,'
      'sum(mtr_bk) as mtr_bk,'
      'sum(mtr_bs) as mtr_bs,'
      'sum(lnin_bk) as lnin_bk,'
      'sum(lnin_bs) as lnin_bs,'
      'sum(korin_bk) as korin_bk,'
      'sum(korin_bs) as korin_bs,'
      'sum(ssuai_out) as ssuai_out,'
      'sum(jahit_bk) as jahit_bk,'
      'sum(jahit_bs) as jahit_bs,'
      'sum(korout_bk) as korout_bk,'
      'sum(korout_bs) as korout_bs,'
      'sum(lnout_bk) as lnout_bk,'
      'sum(lnout_bs) as lnout_bs,'
      'sum(retur_bk) as retur_bk,'
      'sum(retur_bs) as retur_bs,'
      'sum(out_bk) as out_bk,'
      'sum(out_bs) as out_bs,'
      'sum(kemas_bk) as kemas_bk,'
      'sum(kemas_bs) as kemas_bs,'
      'sum(akhir_bk) as akhir_bk,'
      'sum(akhir_bs) as akhir_bs,'
      ''
      'sum(akhir_bk_kd) as akhir_bk_kd,'
      'sum(akhir_bs_kd) as akhir_bs_kd'
      'from ipisma_db5.vwip_reinspect_new'
      ':myparam'
      '')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      040000001C000000070000004157414C5F424B01000000000007000000415741
      ...
      
      000000000B000000414B4849525F42535F4B44010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    AfterScroll = QHasilAfterScroll
    ...
    object QWIPn_TotLNIN_BK: TFloatField
      FieldName = 'LNIN_BK'
    end
    object QWIPn_TotLNIN_BS: TFloatField
      FieldName = 'LNIN_BS'
    end
    ...
    object QWIPn_TotJAHIT_BK: TFloatField
      FieldName = 'JAHIT_BK'
    end
    object QWIPn_TotJAHIT_BS: TFloatField
      FieldName = 'JAHIT_BS'
    end
    ...
    object QWIPn_TotLNOUT_BK: TFloatField
      FieldName = 'LNOUT_BK'
    end
    object QWIPn_TotLNOUT_BS: TFloatField
      FieldName = 'LNOUT_BS'
    end
    object QWIPn_TotRETUR_BK: TFloatField
      FieldName = 'RETUR_BK'
    end
    object QWIPn_TotRETUR_BS: TFloatField
      FieldName = 'RETUR_BS'
    end
    object QWIPn_TotOUT_BK: TFloatField
      FieldName = 'OUT_BK'
    end
    object QWIPn_TotOUT_BS: TFloatField
      FieldName = 'OUT_BS'
    end
    ...
    object QWIPn_TotSSUAI_IN: TFloatField
      FieldName = 'SSUAI_IN'
    end
    object QWIPn_TotSSUAI_OUT: TFloatField
      FieldName = 'SSUAI_OUT'
    end
    object QWIPn_TotKEMAS_BK: TFloatField
      FieldName = 'KEMAS_BK'
    end
    object QWIPn_TotKEMAS_BS: TFloatField
      FieldName = 'KEMAS_BS'
    end
    object QWIPn_TotAKHIR_BK_KD: TFloatField
      FieldName = 'AKHIR_BK_KD'
    end
    object QWIPn_TotAKHIR_BS_KD: TFloatField
      FieldName = 'AKHIR_BS_KD'
    end
  end
  object QWIPn: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vwip_reinspect_new '
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      040000001E0000000A0000004B4F4E535452554B53490100000000000B000000
      ...
      
      0000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    ...
    object QWIPnLNIN_BK: TFloatField
      FieldName = 'LNIN_BK'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnLNIN_BS: TFloatField
      FieldName = 'LNIN_BS'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    ...
    object QWIPnJAHIT_BK: TFloatField
      FieldName = 'JAHIT_BK'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnJAHIT_BS: TFloatField
      FieldName = 'JAHIT_BS'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    ...
    object QWIPnLNOUT_BK: TFloatField
      FieldName = 'LNOUT_BK'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnLNOUT_BS: TFloatField
      FieldName = 'LNOUT_BS'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnRETUR_BK: TFloatField
      FieldName = 'RETUR_BK'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnRETUR_BS: TFloatField
      FieldName = 'RETUR_BS'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnOUT_BK: TFloatField
      FieldName = 'OUT_BK'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnOUT_BS: TFloatField
      FieldName = 'OUT_BS'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    ...
    object QWIPnSSUAI_IN: TFloatField
      FieldName = 'SSUAI_IN'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnSSUAI_OUT: TFloatField
      FieldName = 'SSUAI_OUT'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnKEMAS_BK: TFloatField
      FieldName = 'KEMAS_BK'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnKEMAS_BS: TFloatField
      FieldName = 'KEMAS_BS'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnAKHIR_BK_KD: TFloatField
      FieldName = 'AKHIR_BK_KD'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QWIPnAKHIR_BS_KD: TFloatField
      FieldName = 'AKHIR_BS_KD'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
  end
