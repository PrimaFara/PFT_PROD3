object SerahKeJetDyeingFinFrm: TSerahKeJetDyeingFinFrm
  Left = 256
  Top = 110
  Width = 1071
  Height = 629
    ...
    object TabSheet1: TTabSheet
      ...
      object QuickRep1: TQuickRep
        ...
        object QRBand6: TQRBand
          ...
          object QRLabel13: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'PENYERAHAN KE JETDYEING'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -16
      ...
      object PanelCenter: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Height = 213
          ControlType.Strings = (
            'KD_KONSTRUKSI;CustomEdit;wwDBLookupComboDlg1;F'
          ...
          Selected.Strings = (
            'KD_KONSTRUKSI'#9'6'#9'KODE'#9'T'
            'KONSTRUKSI'#9'40'#9'KONSTRUKSI'#9'T'
            'NO_ORDER'#9'15'#9'NO ORDER'#9'F'
            'QTY_POTONG'#9'7'#9'Qty'#9'F'#9'JUMLAH'
        ...
        object wwDBLookupComboDlg1: TwwDBLookupComboDlg
          ...
          Selected.Strings = (
            ...
            'HASIL_PROSES'#9'10'#9'HASIL_PROSES'#9'F')
          DataField = 'KD_KONSTRUKSI'
          DataSource = dsQDetail
          LookupTable = QKons_finish
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.serah_terima_jetdyeing a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_SERAH_JETDYEING'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      0400000017000000060000004E4F5F5245470100000000000300000054474C01
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.serah_terima_jetdyeing_det a'
    ...
    SequenceField.Sequence = 'ipisma_db5.REG_SERAH_JETDYEING_DET'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.vserah_JETDYEING'
      'WHERE KD_TRANSAKSI = '#39'910'#39
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00004E4F5F52454646010000000000060000004B455245544101000000000006
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'om ipisma_db5.vserah_jetdyeing'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select count(qty_gulung) as gulung, sum(qty_potong) as potong fr' +
        'om ipisma_db5.serah_terima_jetdyeing_det a'
      'where a.no_reg =:no_reg'
      '')
    Variables.Data = {
  ...
  object QPer_Hari: TOracleDataSet
    SQL.Strings = (
        ...
        ' from ipisma_db5.vserah_jetdyeing_hari'
  ...
  object QKons_finish: TOracleDataSet
    SQL.Strings = (
      'select *from ipisma_db5.vlookkons_jetdyeing'
      'order by konstruksi')
    QBEDefinition.QBEFieldDefs = {
      04000000040000000D0000004B445F4B4F4E535452554B53490100000000000C
      000000484153494C5F50524F5345530100000000000A0000004B4F4E53545255
      4B5349010000000000080000004E4F5F4F52444552010000000000}
    Session = DMFrm.OS
    Left = 280
    Top = 392
    object QKons_finishKD_KONSTRUKSI: TStringField
      DisplayLabel = 'KODE'
      DisplayWidth = 6
      FieldName = 'KD_KONSTRUKSI'
      Size = 6
    end
    object QKons_finishKONSTRUKSI: TStringField
      DisplayWidth = 40
      FieldName = 'KONSTRUKSI'
      Size = 50
    end
    object QKons_finishNO_ORDER: TStringField
      DisplayWidth = 20
      FieldName = 'NO_ORDER'
      Size = 30
    end
    object QKons_finishHASIL_PROSES: TStringField
      DisplayWidth = 10
