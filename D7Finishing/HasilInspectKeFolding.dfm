object HasilInspectKeFoldingFrm: THasilInspectKeFoldingFrm
  Left = 246
  Top = 133
  Width = 1004
  Height = 582
  Caption = 'Hasil Inspect Kirim Ke Folding'
  Color = clBtnFace
      ...
      object Panel3: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'FLS'#9'4'#9'FLS'#9'F'#9'DEFECT B-GRADE'
            'FLP'#9'4'#9'FLP'#9'F'#9'DEFECT B-GRADE'
            'LPT'#9'4'#9'LPT'#9'F'#9'DEFECT B-GRADE'
            'LRG'#9'4'#9'LRG'#9'F'#9'DEFECT B-GRADE'
            'WL'#9'4'#9'WL'#9'F'#9'DEFECT B-GRADE'
            'CK'#9'4'#9'CK'#9'F'#9'DEFECT B-GRADE'
            ...
            'KNT'#9'4'#9'KNT'#9'F'#9'DEFECT B-GRADE'
            'PP'#9'4'#9'PP'#9'F'#9'DEFECT B-GRADE'
            'BTS'#9'4'#9'BTS'#9'F'#9'DEFECT B-GRADE'
            'BTB'#9'4'#9'BTB'#9'F'#9'DEFECT B-GRADE'
            'WP'#9'4'#9'WP'#9'F'#9'DEFECT B-GRADE'
            'SC'#9'4'#9'SC'#9'F'#9'DEFECT B-GRADE'
            'PDK'#9'4'#9'PDK'#9'F'#9'DEFECT B-GRADE'
            'BO'#9'4'#9'BO'#9'F'#9'DEFECT B-GRADE'
            'SLL'#9'4'#9'SLL'#9'F'#9'DEFECT B-GRADE'
            'SBK'#9'4'#9'SBK'#9'F'#9'PARAH'
            'ANR'#9'4'#9'ANR'#9'F'#9'PARAH'
            'UTS'#9'4'#9'UTS'#9'F'#9'PARAH'
            'KNB'#9'4'#9'KNB'#9'F'#9'PARAH'
            'PJG'#9'4'#9'PJG'#9'F'#9'DATA'
            'LBR'#9'4'#9'LBR'#9'F'#9'DATA'
  ...
  object QDetail: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000380000000600000053415455414E0100000000000300000051545901
    ...
    object QDetailKNT: TIntegerField
      FieldName = 'KNT'
    end
    ...
    object QDetailPJG: TIntegerField
      FieldName = 'PJG'
    end
    object QDetailLBR: TIntegerField
      FieldName = 'LBR'
    end
    object QDetailCUP: TIntegerField
      FieldName = 'CUP'
    end
    object QDetailPR: TIntegerField
      FieldName = 'PR'
    end
