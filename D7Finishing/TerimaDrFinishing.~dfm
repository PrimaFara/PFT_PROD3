object TerimaDrFinishingFrm: TTerimaDrFinishingFrm
  Left = 262
  Top = 142
  AutoScroll = False
  Caption = 'Terima Dari Finishing'
  ClientHeight = 742
  ClientWidth = 976
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
      ...
      object PanelCenter: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'QTY_GULUNG'#9'7'#9'GULUNG'#9'F'#9'QTY'
            'QTY_POTONG'#9'7'#9'POTONG'#9'F'#9'QTY'
            'QTY_COUNTER'#9'7'#9'COUNTER'#9'F'
    ...
    object RekapPerKons: TTabSheet
      Caption = '&Rekap Per Kons'
      ImageIndex = 2
      ...
      object WebBrowser2: TWebBrowser
        ...
        TabOrder = 2
        ControlData = {
          4C0000000C640000C44200000000000000000000000000000000000000000000
      ...
      object wwDBGrid3: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY_GULUNG'#9'10'#9'QTY GULUNG'#9'F'#9'QTY'
          'QTY_POTONG'#9'10'#9'QTY POTONG'#9'F'#9'QTY')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'Finishing'
        IniAttributes.Delimiter = ';;'
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.TERIMA_DARI_FINISHING a'
    ...
    Variables.Data = {
      ...
      0D0000003A4B445F5452414E53414B5349050000000000000000000000070000
      003A4E4F5F524547030000000000000000000000}
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'IPISMA_DB5.REG_DARI_FINISHING'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db5.TERIMA_DARI_finishing_det a'
    ...
    SequenceField.Sequence = 'IPISMA_DB5.REG_DARI_FINISHING_DET'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      ...
      00000B0000004D4553494E5F54454E554E010000000000050000004A454E4953
      010000000000080000004E4F5F4D4553494E0100000000000B0000004B445F50
      524F44554B5349010000000000050000004E4F5F504F01000000000009000000
      4E4F5F44455341494E010000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
    Session = DMFrm.OS
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db5.VTERIMA_DARI_FINISHING'
      ':myparam'
      '')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      5F4F52444552010000000000080000004E4F5F42554B54490100000000000B00
      00004B445F50524F44554B5349010000000000080000004E4F5F524553455001
      0000000000}
    QueryAllRecords = False
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        ' ipisma_db5.VTERIMA_DARI_finishing'
      ':myparam'
      '')
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty_gulung) as gulung, sum(qty_potong) as potong from' +
        ' ipisma_db5.TERIMA_DARI_FINISHING_det a'
      'where a.no_reg = :no_reg')
  ...
  object QAmbilData: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db5.proc_dari_finishing(:qno_reg,:qno_nota);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QPerKp: TOracleDataSet
    SQL.Strings = (
      ...
      'b.konstruksi,'
      ''
      'sum(NVL(b.qty_gulung, 0)) as qty_gulung,'
      'sum(NVL(b.qty_potong, 0)) as qty_potong'
      ''
      
        'from ipisma_db5.terima_dari_finishing a, ipisma_db5.terima_dari_' +
        'finishing_det b'
      
        'where a.tgl>=:pawal and a.tgl<=:pakhir and a.no_reg=b.no_reg and' +
        ' a.ispost = 1 and a.kd_transaksi = :kd_transaksi'
      ''
      ':myparam')
    Variables.Data = {
      ...
      0000000D0000003A4B445F5452414E53414B5349050000000400000039303900
      00000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      00000000000A0000005154595F504F544F4E47010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    Session = DMFrm.OS
    Left = 580
    ...
    object QPerKpQTY_GULUNG: TFloatField
      FieldName = 'QTY_GULUNG'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
    object QPerKpQTY_POTONG: TFloatField
      FieldName = 'QTY_POTONG'
      DisplayFormat = '0.0,0;(0.0,0);-'
    end
  end
  ...
  object QPerKonstruksiKemas_Tot: TOracleDataSet
    ...
    Variables.Data = {
      ...
      4E53414B534905000000040000003930390000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000040000000A0000004B4F4E535452554B53490100000000000B000000
      4B445F50524F44554B53490100000000000A0000005154595F47554C554E4701
      00000000000A0000005154595F504F544F4E47010000000000}
    ...
    Left = 684
    Top = 201
    object QPerKonstruksiKemas_TotQTY_GULUNG: TFloatField
      FieldName = 'QTY_GULUNG'
    end
    object QPerKonstruksiKemas_TotQTY_POTONG: TFloatField
      FieldName = 'QTY_POTONG'
    end
  end
